...
compo_form_t *func_set_sub_time_form_create(void)
{
    ...
    compo_textbox_set_font((compo_textbox_t *)compo_four, UI_BUF_0FONT_FONT_NUM_16_BIN);
    ...
    compo_textbox_set_font((compo_textbox_t *)compo_five, UI_BUF_0FONT_FONT_NUM_16_BIN);
    ...
    compo_textbox_set_font((compo_textbox_t *)compo_six, UI_BUF_0FONT_FONT_NUM_16_BIN);
