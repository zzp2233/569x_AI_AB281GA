...
*@version       v1.0
*/
#ifndef _UTE_PROJECT_CONFIG_AB281AG_H_
#define _UTE_PROJECT_CONFIG_AB281AG_H_

#define DEFAULT_BLE_DEV_NAME "F3 Stream"
#define UTE_SW_VERSION "AB281AGV000156"

// /*! 指定资源路径,如果不定义则使用对应项目号的路径,wang.luo 2025-01-07 */
#define UTE_UI_CONFIG_PATCH "AB281AE"

/*****************************************/
//资源路径跟底版本一致，只是添加一个I335005文件添加定制logo
...
#define UTE_BINDING_QRENCODE_LINK "https://app.uteasy.com/gloryfit/download/index.html"
#endif
/*****************************************/
...
#define UTE_MODULE_WATCHS_SORT_ADDRESS_ARRAYS { UI_BUF_DIALPLATE_D20142001_BIN, \
                                                UI_BUF_DIALPLATE_D20143001_BIN, \
                                                UI_BUF_DIALPLATE_D20144001_BIN, \
...
#define GUI_SCREEN_SIZE_240X284RGB_I335005_SUPPORT      1 //客户定制logo
