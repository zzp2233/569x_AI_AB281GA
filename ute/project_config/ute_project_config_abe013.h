...
#define UTE_CUI_SCREEN_TBL_SORT_ARRAY_DEFAULT {FUNC_CLOCK, FUNC_CHATBOT,FUNC_ECIG_VPAE_SUB, FUNC_ALARM_CLOCK, FUNC_CALCULATOR,  FUNC_BT, FUNC_WEATHER,FUNC_COMPO_SELECT}
