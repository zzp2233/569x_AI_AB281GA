...
compo_form_t *func_heartrate_form_create(void)
{
    ...
    compo_form_add_image(frm, UI_BUF_HEART_RATE_HR_BG_BIN, 160, 300);

	compo_form_add_image(frm, UI_BUF_HEART_RATE_UP_BIN, 100, 250);
    compo_form_add_image(frm, UI_BUF_HEART_RATE_DOWN_BIN, 300, 250);

	//创建文本
	s16 txt_x = 20;
	s16 txt_y = 230;
	s16 txt_x_offset = 100;
