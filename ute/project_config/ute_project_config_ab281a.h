...
#define UTE_SW_VERSION "AB281AV000016"
...
#define UTE_CUI_SCREEN_TBL_SORT_ARRAY_DEFAULT {FUNC_CLOCK, FUNC_ECIG_SET_POWER, FUNC_HEARTRATE, FUNC_SLEEP, FUNC_WEATHER, FUNC_BT, FUNC_COMPO_SELECT}
