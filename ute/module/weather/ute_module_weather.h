...
typedef struct
{
    ...
    uint8_t currHour;
    int8_t hourTemperature[24];
    uint8_t hourHumidity[24];
    uint8_t hourUltraviolet[24];
    uint16_t hourWeather[24];
    uint8_t dayHumidity[7];
    uint8_t nightHumidity[7];
    uint8_t dayUltraviolet[7];
    uint8_t nightUltraviolet[7];
#endif
