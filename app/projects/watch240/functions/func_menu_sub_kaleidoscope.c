...
#endif // UTE_MODULE_SCREENS_BLOOD_OXYGEN_SUPPORT
// #if UTE_MODULE_SCREENS_BLOOD_OXYGEN_SUPPORT
    // {.func_sta=FUNC_BLOOD_PRESSURE,             .res_addr=UI_BUF_I335001_2_HONEYCOMB_BLOOD_PRESSURE_BIN,        },   //血压
// #endif // UTE_MODULE_SCREENS_BLOOD_OXYGEN_SUPPORT
#if UTE_MODULE_SCREENS_SLEEP_SUPPORT
...
compo_form_t *func_menu_sub_kale_form_create(void)
{
    ...
    int j, k;
    for (j=0, k=0; j<MENU_KALE_CNT; j++,k++)
    {
...
//        uteApplicationCommonGetPersonalInfo(&personal);
        ...
        tbl_menu_kaleidoscope[k].func_sta = coo_menu_list[j].func_sta;
        tbl_menu_kaleidoscope[k].res_addr = coo_menu_list[j].res_addr;
    }
    menuCnt = k;
    //新建菜单
    ...
    compo_kaleidoscope_icon_add(kale, tbl_menu_kaleidoscope, menuCnt);
