...
unsigned short VC30Fx_WEAR_PARAM_BIO_DELTA = 0;
...
static const vc30fx_mode_ops mode_ops[] =
{
    ...
    {WORK_MODE_HRSPO2, drv_spo2_mode_init, drv_ppg_mode_handler},
...
static void drv_infomation_param_init(vcare_ppg_device_t *pdev)
{
    ...
    if( drv_info_handle->work_mode==WORK_MODE_SPO2 || drv_info_handle->work_mode==WORK_MODE_HRSPO2 )
    {
    ...
    if (wear_info_handle->bio_wear_result == VC30Fx_BIO_STA_NONE)
    {
        ...
        uint16_t min_bio = DRV_HEART_VCXX_CFG_READ_ERR_WEAR_BIO_DEFAULT * DRV_HEART_VCXX_CFG_READ_ERR_WEAR_BIO_DEFAULT_MIN;
        uint16_t max_bio = DRV_HEART_VCXX_CFG_READ_ERR_WEAR_BIO_DEFAULT * DRV_HEART_VCXX_CFG_READ_ERR_WEAR_BIO_DEFAULT_MAX;

        if (snData.bioDiff >= min_bio && snData.bioDiff <= max_bio)
        {
            VC30Fx_WEAR_PARAM_BIO_DELTA = snData.bioDiff;
        }
        else
        {
            VC30Fx_WEAR_PARAM_BIO_DELTA = DRV_HEART_VCXX_CFG_READ_ERR_WEAR_BIO_DEFAULT;
        }

        VC30Fx_WEAR_PARAM_BIO_DELTA = VC30Fx_WEAR_PARAM_BIO_DELTA * 0.45f;
