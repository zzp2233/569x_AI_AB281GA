...
static const timer_txt_item_t tbl_timer_txt_item[] =
{
    {"1",       COMPO_ID_BTN_1MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
    {"2",       COMPO_ID_BTN_2MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
    {"3",       COMPO_ID_BTN_3MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*2+CONTROL_LENGTH,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
    {"5",       COMPO_ID_BTN_5MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*2+CONTROL_LENGTH,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
    {"10",      COMPO_ID_BTN_10MIN, GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*3+CONTROL_LENGTH*2,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
    {"30",      COMPO_ID_BTN_30MIN, GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*3+CONTROL_LENGTH*2,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
};
...
static compo_form_t *func_timer_form_create_by_type(u8 page_type)
{
    ...
    switch (page_type)
    {
        ...
        case TIMER_PAGE_COUNTDOWN:
            ...
            btn = compo_button_create_by_image(frm, UI_BUF_I341001_20_ALARM_CLOCK_CENCEL_BIN);  //close
            compo_setid(btn, COMPO_ID_BTN_NO);
