...
compo_form_t *func_breathe_sub_mode_form_create(void)
{
    ...
    ///设置标题栏
    compo_form_set_mode(frm, COMPO_FORM_MODE_SHOW_TITLE | COMPO_FORM_MODE_SHOW_TIME);
    compo_form_set_title(frm, i18n[STR_SPEED]);
...
static void func_breathe_sub_mode_process(void)
{
    ...
    || GUI_SCREEN_SIZE_360X360RGB_I332001_SUPPORT || GUI_SCREEN_SIZE_320X380RGB_I343001_SUPPORT || GUI_SCREEN_SIZE_368X448RGB_I345001_SUPPORT)
