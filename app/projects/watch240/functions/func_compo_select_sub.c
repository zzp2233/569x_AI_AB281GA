...
const compo_listbox_item_t tbl_list_data[] =
{
    ...
    {STR_SETTING_CALENDAR,                 .item_mode = COMPO_LISTBOX_ITEM_MODE_SWITCH, .vidx = SYS_CTL_FUNC_CALENDAR_ON},     //日历
#endif
...
#if 0//UTE_MODULE_SCREENS_ACTIVITY_SUPPORT
...
static void func_compo_select_sub_init(void)
{
    ...
    compo_listbox_set_focus_byidx(listbox, menu_idx);
    compo_listbox_set_sta_icon(listbox,UI_BUF_I340001_FIRSTORDER_DELETE_BIN, UI_BUF_I340001_FIRSTORDER_ADD_BIN);
    compo_listbox_update(listbox);
