...
#define UTE_SW_VERSION "AB281AV000026"
...
#define UTE_CUI_SCREEN_TBL_SORT_ARRAY_DEFAULT {FUNC_CLOCK, FUNC_ACTIVITY, FUNC_BLOOD_OXYGEN, FUNC_HEARTRATE, FUNC_SLEEP, FUNC_WEATHER, FUNC_BT, FUNC_CALL}
