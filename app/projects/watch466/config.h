...
#define GUI_AUTO_POWER_EN               1                       //是否使能刷图动态调节时钟，打开后系统时钟默认设置为48M，刷图时调节为192M
...
#define FLASH_CODE_SIZE                 672K                    //程序使用空间大小
#define FLASH_UI_BASE                   0xAB000                 //UI资源起始地址
#define FLASH_UI_SIZE                   0x350000                //UI资源大小
...
#define BT_RF_EXT_CTL_EN                1   //是否打开rf动态功耗调节
