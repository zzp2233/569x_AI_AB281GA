...
static const compo_listbox_item_t tbl_setting_list[] =
{
    ...
    {STR_SETTING_LANGUAGE,                    UI_BUF_SETTING_SOUND_AND_VIBRATION_BIN,        .func_sta = FUNC_SET_SUB_SAV},      //声音与振动
    {STR_SETTING_LANGUAGE,               UI_BUF_SETTING_LANGUAGE_BIN,                   .func_sta = FUNC_SET_SUB_LANGUAGE}, //语言设置
    {STR_SETTING_CALENDAR,                   UI_BUF_SETTING_TIME_BIN,                       .func_sta = FUNC_SET_SUB_TIME},     //时间设置
    ...
    {STR_SETTING_RESTART,                     UI_BUF_SETTING_ABOUT_BIN,                      .func_sta = FUNC_SET_SUB_4G},       //4G
