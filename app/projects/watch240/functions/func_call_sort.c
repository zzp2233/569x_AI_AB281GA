...
#define CARD1_ICON0_DATA          0,       8+44/2-109/2, 8+44/2-102/2,      44,     44,     UI_BUF_ICON_ADDRESS_BOOK_BIN,         0
...
//图标                            id       x             y                  w       h       res                           保留位
#define CARD2_ICON0_DATA          0,       8+44/2-109/2, 8+44/2-102/2,      44,     44,     UI_BUF_ICON_CALL_BIN,         0
...
//图标                            id       x             y                  w       h       res                               保留位
#define CARD3_ICON0_DATA          0,       8+44/2-109/2, 8+44/2-102/2,      44,     44,     UI_BUF_ICON_CALL_NUM_BIN,         0

//文本                            id      x           y             w       h       str     res                       center  wordwrap   r      g      b     对应STR_XXX
#define CARD3_TEXT0_DATA          0,      8-109/2,    63-102/2,     86,     23,     NULL,   UI_BUF_0FONT_FONT_BIN,    false,  false,     255,   255,   255,  STR_CALL_DIAL
