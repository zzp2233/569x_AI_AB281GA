...
static const f_call_sort_t f_call_sort[]=
{
    {.card_x = 108, .card_y = 108,  .card_pic_res = UI_BUF_I340001_CALL_NO_CONTACTS_BIN,       .card_txt_str = STR_CALL_LINK,   .sta = FUNC_CALL_SUB_LINKMAN},
    {.card_x = 252, .card_y = 108,  .card_pic_res = UI_BUF_I340001_CALL_NO_LOG_BIN,            .card_txt_str = STR_CALL_RECENT, .sta = FUNC_CALL_SUB_RECORD},
    {.card_x = 180, .card_y = 252,  .card_pic_res = UI_BUF_I340001_CALL_CALL_LIST_DIALPAD_BIN, .card_txt_str = STR_CALL_DIAL,   .sta = FUNC_CALL_SUB_DIAL},
};
compo_form_t *func_call_sort_form_create(void)
{
    compo_form_t *frm = compo_form_create(true);
