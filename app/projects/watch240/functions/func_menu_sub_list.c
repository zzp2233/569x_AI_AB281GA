...
static compo_listbox_item_t tbl_menu_list[] =
{
    ...
    {.func_sta=FUNC_SPORT_HISTORY,              .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_SPORTS_RECORD_BIN,     .str_idx=STR_EXERCISE_RECODE},                //运动记录
#endif
#if UTE_MODULE_SCREENS_BLOOD_OXYGEN_SUPPORT
    ...
    {.func_sta = FUNC_MEASURE,                  .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_KEY_MEASURE_BIN,         .str_idx=STR_MEASURE},       //一键测量
#endif
#if UTE_MODULE_SCREENS_SLEEP_SUPPORT
    ...
    {.func_sta = FUNC_REMIND_PRAYER,            .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_PRAY_BIN,           .str_idx=STR_PRAYER_REMIND},         //祈祷
#endif
#if UTE_MODULE_SCREENS_MESSAGE_SUPPORT
    ...
    {.func_sta = FUNC_WORLD_CLOCK,              .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_WORLD_TIME_BIN,        .str_idx=STR_WORLD_CLOCK},          //世界时钟
#endif
#if UTE_MODULE_SCREENS_GAME_SUPPORT
    ...
    { .func_sta = FUNC_STOPWATCH,            .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_STOPWATCH_BIN,       .str_idx=STR_STOP_WATCH},  //秒表
#endif
#if UTE_MODULE_SCREENS_TIMER_SUPPORT && (!UTE_MODULE_SCREENS_TOOLBOX_SUPPORT)
    { .func_sta = FUNC_TIMER,                 .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_TIMER_BIN,          .str_idx= STR_TIMER},     //计时器
#endif
#if UTE_MODULE_SCREENS_FIND_PHNOE_SUPPORT && (!UTE_MODULE_SCREENS_TOOLBOX_SUPPORT)
    { .func_sta = FUNC_FINDPHONE,            .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_FINDPHONE_BIN,       .str_idx=STR_FIND_PHONE},  //找手机
#endif
#if UTE_MODULE_SCREENS_FLASHLIGHT_SUPPORT && (!UTE_MODULE_SCREENS_TOOLBOX_SUPPORT)
    { .func_sta = FUNC_FLASHLIGHT,            .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_FLASHLIGHT_BIN,     .str_idx= STR_FLASHLIGHT}, //手电筒
#endif
#if UTE_MODULE_SCREENS_CAMERA_SUPPORT && (!UTE_MODULE_SCREENS_TOOLBOX_SUPPORT)
    { .func_sta = FUNC_CAMERA,                .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_PHOTO_BIN,          .str_idx=STR_CAMERA},     //遥控拍照
#endif
#if UTE_MODULE_SCREENS_CALCULATOR_SUPPORT && (!UTE_MODULE_SCREENS_TOOLBOX_SUPPORT)
    { .func_sta = FUNC_CALCULATOR,            .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_CALCULATOR_BIN,     .str_idx= STR_CALCULATOR}, //计算器
#endif
#if UTE_MODULE_SCREENS_CALENDAER_SUPPORT && (!UTE_MODULE_SCREENS_TOOLBOX_SUPPORT)
    { .func_sta = FUNC_CALENDAER,             .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_PHOTO_BIN,          .str_idx= STR_CALENDAR}, //日历
#endif
};
...
#endif
#if UTE_MODULE_SPORTS_HSTORY_RECORD_SUPPORT
    {.func_sta=FUNC_SPORT_HISTORY,              .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_SPORTS_RECORD_BIN,     .str_idx=STR_SPORTS},                //运动
#endif
#if UTE_MODULE_SCREENS_BLOOD_OXYGEN_SUPPORT
    {.func_sta=FUNC_BLOOD_OXYGEN,               .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_SPO2_BIN,              .str_idx=STR_BLOOD_OXYGEN},          //血氧
#endif
...
// #endif // UTE_MODULE_SCREENS_BLOOD_OXYGEN_SUPPORT
    ...
    {.func_sta=FUNC_SUB_SOS,                    .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_SOS_BIN,               .str_idx=STR_SOS},                  //SOS
#endif
#if UTE_MODULE_SCREENS_TOOLBOX_SUPPORT
    {.func_sta=FUNC_TOOLBOX,                    .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_TOOLBOX_BIN,           .str_idx=STR_TOOL_BOX},             //工具箱
#endif
...
#endif
#if UTE_MODULE_SCREENS_WORLD_CLOCK_SUPPORT
    {.func_sta = FUNC_WORLD_CLOCK,              .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_WORLD_TIME_BIN,        .str_idx=STR_CUSTOM_TIME},          //游戏
#endif
#if UTE_MODULE_SCREENS_GAME_SUPPORT
    {.func_sta = FUNC_GAME,                     .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_GAME_BIN,              .str_idx=STR_GAME},          //游戏
#endif
#if APP_CUSTOM_REMIND_SETTING_SUPPORT
    {.func_sta = FUNC_REMIND_PRAYER,            .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_PRAY_BIN,              .str_idx=STR_GAME},         //游戏
#endif
};
...
#endif // UTE_MODULE_SCREENS_ALARM_SUPPORT
#if UTE_MODULE_SCREENS_EMOTION_SUPPORT
    {.func_sta=FUNC_MOOD,                     .res_addr=UI_BUF_I343001_2_HONEYCOMB_MOOD_BIN,                  .str_idx=STR_EMOTION},              //情绪
#endif // UTE_MODULE_SCREENS_EMOTION_SUPPORT
#if UTE_MODULE_SCREENS_BREATHE_SUPPORT
...
compo_form_t *func_menu_sub_list_form_create(void)
{
    ...
    int j, k;
    for (j=0, k=0; j<MENU_LIST_CNT; j++,k++)
    {
...
//        uteApplicationCommonGetPersonalInfo(&personal);
        ...
        tbl_menu_list[k].func_sta = coo_menu_list[j].func_sta;
        tbl_menu_list[k].res_addr = coo_menu_list[j].res_addr;
        tbl_menu_list[k].str_idx  = coo_menu_list[j].str_id;
    }
    menuCnt = k;
    compo_listbox_set(listbox, tbl_menu_list, menuCnt);
    compo_setid(listbox, COMPO_ID_LISTBOX);
    if (menu_idx < 2)
    {
        compo_listbox_set_focus(listbox, 186);
    }
    else
    {
        compo_listbox_set_focus_byidx(listbox, menu_idx);
    }
    compo_listbox_set_item_text(listbox, 128, (listbox->line_height - widget_text_get_height() + 2) >> 1, 220, listbox->line_height, false);
    compo_listbox_update(listbox);
...
#elif GUI_SCREEN_SIZE_368X448RGB_I345001_SUPPORT
    compo_listbox_move_init_modify(listbox, 186, compo_listbox_gety_byidx(listbox, menuCnt - 2));
#else
