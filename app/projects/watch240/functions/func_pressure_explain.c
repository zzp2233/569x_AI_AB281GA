...
#define EXPLAIN_TXT "压力值,及心率变异性的压力指标,是通过测量心率信号中的非线性和非周期性变化,\
来反应自主神经系统对心脏压力调节的有效性.这一指标可以帮助我们了解人体的压力状态,从而为压力管理提供依据."
...
compo_form_t *func_pressure_explain_form_create(void)
{
    ...
    compo_textbox_set(textbox,"压力");

    textbox = compo_textbox_create(frm, sizeof(EXPLAIN_TXT));
    compo_textbox_set_font(textbox, UI_BUF_0FONT_FONT_BIN);
    ...
    compo_textbox_set(textbox,EXPLAIN_TXT);
