...
#define UTE_SW_VERSION "ABE012V000005"
...
#define UTE_CUI_SCREEN_TBL_SORT_ARRAY_DEFAULT {FUNC_CLOCK, FUNC_ECIG_SET_POWER,FUNC_ECIG_VPAE_SUB, FUNC_ALARM_CLOCK, FUNC_CALCULATOR,  FUNC_BT, FUNC_MAP,FUNC_COMPO_SELECT}
