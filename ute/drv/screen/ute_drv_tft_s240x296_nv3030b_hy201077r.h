#ifndef _UTE_DRV_TFT_S240X296_NV3030B_HY201077R_H_
#define _UTE_DRV_TFT_S240X296_NV3030B_HY201077R_H_

#include "ute_project_config.h"
#include "ute_module_platform.h"
#include "ute_drv_screen_common.h"

#if UTE_DRV_TFT_S240X296_NV3030B_HY201077R_QSPI_SUPPORT

__STATIC_INLINE void drvScreenTft240X296Nv3030BHy201077rPowerOn(void)
{
...
__STATIC_INLINE void drvScreenTft240X296Nv3030BHy201077rPowerOff(void)
{
...
__STATIC_INLINE void drvScreenTft240X296Nv3030BHy201077rSetWindow(uint16_t xStart, uint16_t yStart, uint16_t xEnd, uint16_t yEnd)
{
    yStart += 12;
    yEnd += 12;
...
__STATIC_INLINE void drvScreenTft240X296Nv3030BHy201077rInit(void)
{
    UTE_MODULE_LOG(UTE_LOG_DRV_SCREEN_LVL, "%s", __func__);
...
const ute_drv_screen_common_config_t uteDrvScreenTft240X296Nv3030BHy201077rConfig =
{
    .name = "Tft240X296Nv3030BHy201077rQspi",
    .init = drvScreenTft240X296Nv3030BHy201077rInit,
    .powerOn = drvScreenTft240X296Nv3030BHy201077rPowerOn,
    .powerOff = drvScreenTft240X296Nv3030BHy201077rPowerOff,
    .setWindow = drvScreenTft240X296Nv3030BHy201077rSetWindow,
    .setBackLight = NULL,
};

#endif
#endif /* _UTE_DRV_TFT_S240X296_I18_ST7789P3_XHL183BA2401_QSPI_H_ */
