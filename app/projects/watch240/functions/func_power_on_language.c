...
#endif
#if SCREEN_TITLE_MULTIPLE_FARSI_LANGUAGE_SUPPORT //波斯语（伊朗）
    {STR_LANGUAGE_FA,    .vidx = PERSIAN_LANGUAGE_ID},
#endif
#if SCREEN_TITLE_MULTIPLE_INDONESUAN_LANGUAGE_SUPPORT //波斯语（伊朗）
...
compo_form_t *func_power_on_language_form_create(void)
{
    ...
    compo_listbox_set_sta_icon(listbox, UI_BUF_I343001_COMM_GOU_BIN, /*UI_BUF_COMPO_SELECT_ADD_BIN*/0);
    compo_listbox_set_bithook(listbox, func_sel_language_bit);
...
compo_form_t *func_power_on_language_form_create(void)
{
    ...
    compo_listbox_set(listbox, tbl_power_on_language_list, LANGUAGE_LIST_CNT);
    compo_listbox_set_bgimg(listbox, UI_BUF_I341001_1_START_LANGUAGE_BG_BIN);


    compo_listbox_set_sta_icon(listbox, UI_BUF_I341001_1_START_OK_BIN, 0);
    compo_listbox_set_bithook(listbox, func_sel_language_bit);
...
static void func_power_on_language_enter(void)
{
    ...
    compo_listbox_move_init_modify(listbox, 100, compo_listbox_gety_byidx(listbox, LANGUAGE_LIST_CNT - 2));
#elif GUI_SCREEN_SIZE_368X448RGB_I345001_SUPPORT
    compo_listbox_move_init_modify(listbox, 147, compo_listbox_gety_byidx(listbox, LANGUAGE_LIST_CNT - 2));
#elif GUI_SCREEN_SIZE_360X360RGB_I340001_SUPPORT
    compo_listbox_move_init_modify(listbox, 80, compo_listbox_gety_byidx(listbox, LANGUAGE_LIST_CNT - 2)+40);
#elif GUI_SCREEN_SIZE_320X380RGB_I343001_SUPPORT
    compo_listbox_move_init_modify(listbox, 80, compo_listbox_gety_byidx(listbox, LANGUAGE_LIST_CNT - 2)+40);
