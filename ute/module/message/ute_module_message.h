...
enum
{
    ...
    MSG_TYPE_MODULE_SPORT_GPS_LOCATION_STATE,
    MSG_TYPE_MODULE_QUICK_REPLY_READ_DATA,
    TO_APP_TASK_MSG_UPDATE_CONNECTION_PARAM_TIMEOUT_TIMER,
    MSG_TYPE_PROTOCOL_HANDLER,
};
