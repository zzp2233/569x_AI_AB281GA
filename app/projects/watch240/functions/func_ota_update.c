...
compo_form_t *func_ota_update_form_create(void)
{
    ...
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,GUI_SCREEN_CENTER_Y+58 + 20,230,80);
    compo_textbox_set(textbox,txt_buf);
    compo_setid(textbox,PROGRESS_BAR_ID);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_UPGRADING]));
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,GUI_SCREEN_CENTER_Y+144,320,50);
    compo_textbox_set(textbox,i18n[STR_UPGRADING]);
...
compo_form_t *func_ota_update_form_create(void)
{
    ...
    compo_picturebox_t * picbox = compo_picturebox_create(frm, UI_BUF_I343001_UPGRADE_UPGRADE_BIN);
    compo_picturebox_set_pos(picbox, GUI_SCREEN_CENTER_X, 46+158/2);
    ...
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,237+50/2,230,50);
    compo_textbox_set(textbox,txt_buf);
    compo_setid(textbox,PROGRESS_BAR_ID);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_UPGRADING]));
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,302+50/2,300,50);
    compo_textbox_set(textbox,i18n[STR_UPGRADING]);
