...
static void func_alarm_clock_sub_get_timer(bool mode,bool hour_flag,u8 timer,s8 *timer_data)
{
    s8 num=-2;
...
compo_form_t *func_alarm_clock_sub_set_form_create(void)
{
    ...
    {
        func_alarm_clock_sub_get_timer(0,0,hour,hour_data);///获取时间
        func_alarm_clock_sub_get_timer(0,1,min,min_data);
        for(int idx=COMPO_ID_TXT_HOUR_1; idx<=COMPO_ID_TXT_MIN_5; idx++) ///创建滑动文本
        {
            memset(txt_buf,0,sizeof(txt_buf));
            compo_textbox_t *txt = compo_textbox_create_for_page(frm,page,2);
...
{
    f_alarm_clock_sub_set_t *f_disturd_set = (f_alarm_clock_sub_set_t*) func_cb.f_cb;
...
/*函数功能：滑动处理*/
static void func_set_alarm_sub_move(void)
{
    f_alarm_clock_sub_set_t *f_disturd_set = (f_alarm_clock_sub_set_t*) func_cb.f_cb;
        ...
        if(f_disturd_set->touch_flag == true)//触摸状态
        {
            ...
            if(f_disturd_set->set_num_flag == SET_HOUR_MODE)//小时
            {
                for(int idx=COMPO_ID_TXT_HOUR_1; idx<=COMPO_ID_TXT_HOUR_5; idx++) ///创建滑动文本
                {
                    ...
                    if(f_disturd_set->time_scale) //12小时制
                    {
                        ...
                        func_alarm_clock_sub_get_timer(1,0,f_disturd_set->hour,f_disturd_set->disturd_hour);
                    ...
                    else  //24小时制
                    {
                        ...
                        func_alarm_clock_sub_get_timer(0,0,f_disturd_set->hour,f_disturd_set->disturd_hour);
            ...
            else if(f_disturd_set->set_num_flag == SET_MIN_MODE)   //分钟
            {
                for(int idx=COMPO_ID_TXT_MIN_1; idx<=COMPO_ID_TXT_MIN_5; idx++) ///创建滑动文本
                {
                    ...
                    func_alarm_clock_sub_get_timer(1,1,f_disturd_set->min,f_disturd_set->disturd_min);
...
compo_form_t *func_alarm_clock_sub_set_form_create(void)
{
    ...
    compo_picturebox_t * picbox = compo_picturebox_create(frm, UI_BUF_I341001_20_ALARM_CLOCK_LINE_BIN);
    compo_picturebox_set_pos(picbox, GUI_SCREEN_CENTER_X, 160);

    picbox = compo_picturebox_create(frm, UI_BUF_I341001_20_ALARM_CLOCK_LINE_BIN);
    compo_picturebox_set_pos(picbox, GUI_SCREEN_CENTER_X, 160 + TXT_SPACING);
    ...
    if(uteModuleSystemtime12HOn())///12小时制
    {
        ...
        compo_textbox_t *txt_pm = compo_textbox_create_for_page(frm,page,strlen(i18n[STR_PM]));///12小时制文本 下午
        compo_textbox_set_location(txt_pm,50+34,0,68,34);
        compo_textbox_set(txt_pm,i18n[STR_PM]);
        compo_setid(txt_pm,COMPO_ID_TXT_PM_BG);
    ...
    compo_button_t * btn_ok = compo_button_create_by_image(frm,UI_BUF_I341001_20_ALARM_CLOCK_CONFIRM_BIN);///确定按钮
    ...
    if(f_disturd_set->touch_flag == true)
    {
        ...
        if(f_disturd_set->touch_flag == true)//触摸状态
        {
            ...
            else if(f_disturd_set->set_num_flag == SET_AM_PS)//上下午
            {
                ...
                {
                    compo_textbox_t *txt = compo_getobj_byid(idx);
                    compo_textbox_set_pos(txt,50+34,TXT_Y[i+(1-f_disturd_set->am_pm_flag)]+f_disturd_set->move_am_pm_dy);
                }
            }
        }
        else   //松手状态
        {
            ...
            {
                printf("f_disturd_set->am_pm_flag = %d,f_disturd_set->move_am_pm_dy = %d\n",\
                       f_disturd_set->am_pm_flag,f_disturd_set->move_am_pm_dy);
                if(f_disturd_set->am_pm_flag == true)
                {
                    if(f_disturd_set->move_am_pm_dy == TXT_SPACING)
                    {
...
compo_form_t *func_alarm_clock_sub_set_form_create(void)
{
    ...
    {
        compo_button_t * btn_am = compo_button_create_page_by_image(frm,page,0);///12小时制按钮 上午 下午
        compo_button_set_location(btn_am,29+60/2,248/2,78,248);
        compo_setid(btn_am,COMPO_ID_BTN_PM_AM);
        ...
        compo_textbox_t *txt_pm = compo_textbox_create_for_page(frm,page,strlen(i18n[STR_PM]));///12小时制文本 下午
        compo_textbox_set_location(txt_pm,29+60/2,0,68,34);
        compo_textbox_set(txt_pm,i18n[STR_PM]);
        compo_setid(txt_pm,COMPO_ID_TXT_PM_BG);

        compo_textbox_set_pos(txt_am,29+60/2,(hour && hour<=12) ? TXT_Y[2]+10 : TXT_Y[3]+10);
        compo_textbox_set_pos(txt_pm,29+60/2,(hour && hour<=12) ? TXT_Y[1]+10 : TXT_Y[2]+10);
        compo_textbox_set_forecolor(txt_am,(hour && hour<=12) ? COLOR_WHITE : COLOR_GRAY);
        compo_textbox_set_forecolor(txt_pm,!(hour && hour<=12) ? COLOR_WHITE : COLOR_GRAY);
    ...
    if(f_disturd_set->touch_flag == true)
    {
        ...
        if(f_disturd_set->touch_flag == true)//触摸状态
        {
            ...
            else if(f_disturd_set->set_num_flag == SET_AM_PS)//上下午
            {
                ...
                {
                    compo_textbox_t *txt = compo_getobj_byid(idx);
                    compo_textbox_set_pos(txt,29+60/2,TXT_Y[i+(1-f_disturd_set->am_pm_flag)]+f_disturd_set->move_am_pm_dy);
                }
            }
        }
        else   //松手状态
        {
            ...
            else if(f_disturd_set->set_num_flag == SET_AM_PS)//上下午
            {
                ...
                compo_textbox_set_pos(txt_am,29+60/2,f_disturd_set->am_pm_flag ? TXT_Y[2]+10 : TXT_Y[3]+10);
                compo_textbox_set_pos(txt_pm,29+60/2,f_disturd_set->am_pm_flag ? TXT_Y[1]+10 : TXT_Y[2]+10);
                compo_textbox_set_forecolor(txt_am,f_disturd_set->am_pm_flag ? COLOR_WHITE : COLOR_GRAY);
                compo_textbox_set_forecolor(txt_pm,!f_disturd_set->am_pm_flag ? COLOR_WHITE : COLOR_GRAY);
            }
        }
...
compo_form_t *func_alarm_clock_sub_set_form_create(void)
{
    ...
    {
        compo_button_t * btn_am = compo_button_create_page_by_image(frm,page,0);///12小时制按钮 上午 下午
        compo_button_set_location(btn_am,TXT_AP_PM_X,CENTER_TXT_Y,70,CENTER_TXT_Y*2);
        compo_setid(btn_am,COMPO_ID_BTN_PM_AM);

        compo_textbox_t *txt_am = compo_textbox_create_for_page(frm,page,strlen(i18n[STR_AM]));///12小时制文本 上午
        compo_textbox_set_location(txt_am,TXT_AP_PM_X,0,60,30);
        compo_textbox_set(txt_am,i18n[STR_AM]);
        compo_setid(txt_am,COMPO_ID_TXT_AM_BG);

        compo_textbox_t *txt_pm = compo_textbox_create_for_page(frm,page,strlen(i18n[STR_PM]));///12小时制文本 下午
        compo_textbox_set_location(txt_pm,TXT_AP_PM_X,0,60,35);
        compo_textbox_set(txt_pm,i18n[STR_PM]);
        compo_setid(txt_pm,COMPO_ID_TXT_PM_BG);
    ...
    compo_button_t * btn_hour = compo_button_create_page_by_image(frm,page,0);///小时滑动按钮 UI_BUF_I330001_PUBLIC_KUANG_BLUE_BIN
    compo_button_set_location(btn_hour,uteModuleSystemtime12HOn() ? TXT_12_HOUR_X : TXT_24_HOUR_X,CENTER_TXT_Y,70,CENTER_TXT_Y*2);
    compo_setid(btn_hour,COMPO_ID_BTN_HOUR_BG);

    compo_button_t * btn_min = compo_button_create_page_by_image(frm,page,0);///分钟滑动按钮 UI_BUF_I330001_PUBLIC_KUANG_BLUE_BIN
    compo_button_set_location(btn_min,uteModuleSystemtime12HOn() ? TXT_12_MIN_X : TXT_24_MIN_X,CENTER_TXT_Y,70,CENTER_TXT_Y*2);
    compo_setid(btn_min,COMPO_ID_BTN_MIN_BG);

    compo_button_t * btn_ok = compo_button_create_by_image(frm,UI_BUF_I338001_20_ALARM_CLOCK_COMFIRM_BIN);///确定按钮
    ...
    if(f_disturd_set->touch_flag == true)
    {
        ...
        if(f_disturd_set->touch_flag == true)//触摸状态
        {
            ...
            else if(f_disturd_set->set_num_flag == SET_AM_PS)//上下午
            {
                ...
                {
                    compo_textbox_t *txt = compo_getobj_byid(idx);
                    compo_textbox_set_pos(txt,TXT_AP_PM_X,TXT_Y[i+(1-f_disturd_set->am_pm_flag)]+f_disturd_set->move_am_pm_dy);
                }
            }
        }
        else   //松手状态
        {
            ...
            else if(f_disturd_set->set_num_flag == SET_AM_PS)//上下午
            {
                ...
                compo_textbox_set_pos(txt_am,TXT_AP_PM_X,f_disturd_set->am_pm_flag ? TXT_Y[2] : TXT_Y[3]);
                compo_textbox_set_pos(txt_pm,TXT_AP_PM_X,f_disturd_set->am_pm_flag ? TXT_Y[1] : TXT_Y[2]);
                compo_textbox_set_forecolor(txt_am,f_disturd_set->am_pm_flag ? COLOR_WHITE : COLOR_GRAY);
                compo_textbox_set_forecolor(txt_pm,!f_disturd_set->am_pm_flag ? COLOR_WHITE : COLOR_GRAY);
            }
        }
...
static const aclock_set_pic_bg_t tbl_aclock_set_pic_bg =
{
    ...
    .bg_hour = {
        ...
        .x  = 42+122/2, //91+58/2  54,120,66
        .y  = 84+158/2,
        .res_24_bright  = UI_BUF_I340001_PUBLIC_KUANG_YELLOW_BIG_BIN,
        .res_24_destory = UI_BUF_I340001_PUBLIC_KUANG_GREY_BIG_BIN,
        .res_12_bright  = UI_BUF_I340001_PUBLIC_KUANG_YELLOW_SMALL_BIN,
        .res_12_destory = UI_BUF_I340001_PUBLIC_KUANG_GREY_SMALL_BIN,
    },
    ...
    .bg_colon = {
        ...
        .x  = 164+32/2,  //160+6/2  119 163, 44
        .y  = 84+158/2,//125
        .res    = UI_BUF_I340001_PUBLIC_KUANG_COLON_BIN,
    },
    ...
    .btn_ok = {
        ...
        .w  = 0,
        .h  = 0,
        .res1 = UI_BUF_I340001_PUBLIC_RECTANGLE02_BIN,
        .res2 = UI_BUF_I340001_PUBLIC_RECTANGLE00_BIN,
        .str_id = STR_OK,
        .font_w = 180,
        .font_h = 30,
    },
...
//    else        //edit
//    {
//        btn = compo_button_create_by_image(frm, UI_BUF_I340001_PUBLIC_CLOSE00_BIN);
//        compo_setid(btn, COMPO_ID_BTN_REPETAT_NO);
//        compo_button_set_pos(btn, GUI_SCREEN_WIDTH/4, GUI_SCREEN_HEIGHT - gui_image_get_size(UI_BUF_I340001_PUBLIC_CLOSE00_BIN).hei / 2 - 10);
//
//        btn = compo_button_create_by_image(frm, UI_BUF_I340001_PUBLIC_OK01_BIN);
//        compo_setid(btn, COMPO_ID_BTN_REPETAT_YES);
//        compo_button_set_pos(btn, GUI_SCREEN_WIDTH*3/4, GUI_SCREEN_HEIGHT - gui_image_get_size(UI_BUF_I340001_PUBLIC_OK01_BIN).hei / 2 - 10);
//    }
    ...
    //建立确定按钮图像 - 按下图片
//    compo_picturebox_t *pic_click = compo_picturebox_create(frm, tbl_aclock_set_pic_bg.btn_ok.res2);
//    compo_picturebox_set_pos(pic_click, tbl_aclock_set_pic_bg.btn_ok.x, GUI_SCREEN_HEIGHT - gui_image_get_size(UI_BUF_I340001_PUBLIC_RECTANGLE02_BIN).hei / 2 - 20);
//    compo_picturebox_set_visible(pic_click, false);
//    if (ALARM_IS_FREE(sys_cb.alarm_edit_idx))   //add
//    {
//        compo_setid(pic_click, tbl_aclock_set_pic_bg.btn_ok.id1_click);
...
//        printf("clock=%d\n",am_pm_conv);
        ...
        compo_button_t *btn = compo_button_create_by_image(frm, UI_BUF_I340001_PUBLIC_SHANGWU01_BIN);
        compo_button_set_pos(btn,GUI_SCREEN_CENTER_X/3,GUI_SCREEN_CENTER_Y-43);
        if(am_pm_conv == 1)
        {
        ...
        btn = compo_button_create_by_image(frm, UI_BUF_I340001_PUBLIC_SHANGWU01_BIN);
        compo_button_set_pos(btn,GUI_SCREEN_CENTER_X/3,GUI_SCREEN_CENTER_Y+3);
        if(am_pm_conv == 0)
        {
            compo_button_set_bgimg(btn, UI_BUF_I340001_PUBLIC_SHANGWU01_BIN);
        ...
        compo_textbox_t *txt_am_pm = compo_textbox_create(frm,strlen(i18n[STR_AM]));//上午
        compo_textbox_set_location(txt_am_pm,GUI_SCREEN_CENTER_X/3,GUI_SCREEN_CENTER_Y-43,gui_image_get_size(UI_BUF_I340001_PUBLIC_SHANGWU01_BIN).wid,gui_image_get_size(UI_BUF_I340001_PUBLIC_SHANGWU01_BIN).hei);
        compo_textbox_set(txt_am_pm, i18n[STR_AM]);
        if(am_pm_conv == 0)
        {
            compo_textbox_set_forecolor(txt_am_pm, COLOR_GRAY);
        ...
        txt_am_pm = compo_textbox_create(frm,strlen(i18n[STR_PM]));//下午
        compo_textbox_set_location(txt_am_pm,GUI_SCREEN_CENTER_X/3,GUI_SCREEN_CENTER_Y+3,gui_image_get_size(UI_BUF_I340001_PUBLIC_SHANGWU01_BIN).wid,gui_image_get_size(UI_BUF_I340001_PUBLIC_SHANGWU01_BIN).hei);
        compo_textbox_set(txt_am_pm, i18n[STR_PM]);
        if(am_pm_conv == 1)
        {
            compo_textbox_set_forecolor(txt_am_pm, COLOR_GRAY);
...
//            if(btn_am == NULL)return;
            f_alarm_set->time_am_pm = 0;
            compo_button_set_bgimg(btn_am, UI_BUF_I340001_PUBLIC_SHANGWU00_BIN);
...
//            if(btn_am == NULL)return;
            f_alarm_set->time_am_pm = 1;
            compo_button_set_bgimg(btn_pm, UI_BUF_I340001_PUBLIC_SHANGWU00_BIN);
...
static void func_alarm_clock_sub_set_process(void)
{
    ...
    || GUI_SCREEN_SIZE_368X448RGB_I341001_SUPPORT || GUI_SCREEN_SIZE_320X380RGB_I343001_SUPPORT || GUI_SCREEN_SIZE_368X448RGB_I345001_SUPPORT
    func_set_alarm_sub_move();
#endif
    func_process();
}
...
static void func_alarm_clock_sub_set_message(size_msg_t msg)
{
    ...
    switch (msg)
    {
      ...
      || GUI_SCREEN_SIZE_368X448RGB_I341001_SUPPORT || GUI_SCREEN_SIZE_320X380RGB_I343001_SUPPORT || GUI_SCREEN_SIZE_368X448RGB_I345001_SUPPORT
            func_alarm_clock_sub_set_timer_mode();
#endif
            break;
     ...
     || GUI_SCREEN_SIZE_360X360RGB_I338001_SUPPORT || GUI_SCREEN_SIZE_360X360RGB_I340001_SUPPORT || GUI_SCREEN_SIZE_240X240RGB_I342001_SUPPORT \
     || GUI_SCREEN_SIZE_368X448RGB_I341001_SUPPORT || GUI_SCREEN_SIZE_320X380RGB_I343001_SUPPORT || GUI_SCREEN_SIZE_368X448RGB_I345001_SUPPORT)
...
static void func_alarm_clock_sub_set_exit(void)
{
    if(!uteModuleSystemtimeGetAlarmCycle(sys_cb.alarm_edit_idx))
    {
        uteModuleSystemtimeDeleteAlarm(sys_cb.alarm_edit_idx);
    }
