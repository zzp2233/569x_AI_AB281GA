...
const f_cover_remind_item_t tbl_cover_remind_item[] =
{
    ...
    [REMIND_COVER_ALARM]            = {UI_BUF_I330001_THEME_1_ALARM_BIN,             STR_ALARM_CLOCK,        GUI_SCREEN_HEIGHT/5+30, GUI_SCREEN_HEIGHT/5,  GUI_SCREEN_CENTER_Y},
    [REMIND_COVER_HEALTH_SEDENTARY] = {UI_BUF_I330001_REPEAT_LONG_SIT_BIN,         STR_SEDENTARY_REMIND,   GUI_SCREEN_CENTER_Y,    GUI_SCREEN_HEIGHT*4/5,  0},
//    [REMIND_COVER_HEALTH_DRINK]     = {UI_BUF_POP_UP_WATER_CLOCK_BIN,             STR_DRINK_REMIND,       102,            190},
    [REMIND_COVER_FIND_WATCH]       = {UI_BUF_I330001_FINGWATCH_WATCH_BIN,             STR_FIND_WATCH,         GUI_SCREEN_CENTER_Y,    GUI_SCREEN_HEIGHT*4/5,  0},
    [REMIND_COVER_GOAL]             = {UI_BUF_I330001_REPEAT_GOAL_BIN,            STR_GOAL_ACHIEVE,       GUI_SCREEN_CENTER_Y,    GUI_SCREEN_HEIGHT*4/5,  0},
...
const f_cover_brief_msg_item_t tbl_cover_brief_msg_item[] =
{
    ...
    [MSG_WhatsApp]          = {UI_BUF_I330001_NOTIFICATION_ICON_MSG_MSG_WHATSAPP_BIN,           GUI_SCREEN_HEIGHT/5+10,     GUI_SCREEN_HEIGHT/2 - 20,    GUI_SCREEN_HEIGHT/2-20,  GUI_SCREEN_HEIGHT/2-50},       //MSG_WhatsApp
