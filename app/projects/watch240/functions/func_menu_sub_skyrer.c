...
static compo_rings_item_t tbl_menu_skyrer[] =
{
    ...
    {.func_sta=FUNC_BLOOD_PRESSURE,           .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_BLOOD_PRESSURE_BIN,        },   //血压
#endif
#if UTE_MODULE_SCREENS_SLEEP_SUPPORT
...
compo_form_t *func_menu_sub_skyrer_form_create(void)
{
    ...
    if(!personal.isMan)
    {
        ...
        tbl_menu_skyrer[MENU_SKYRER_CNT-1].res_addr = UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_PERIOD_BIN;
    }
    else
    {
        tbl_menu_skyrer[MENU_SKYRER_CNT-1].func_sta = 0;//FUNC_CALCULATOR;
        tbl_menu_skyrer[MENU_SKYRER_CNT-1].res_addr = 0;//UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_CALCULATOR_BIN;
    }
#if APP_CUSTOM_REMIND_SETTING_SUPPORT
    for (int i=0; i<MENU_SKYRER_CNT; i++)
    {
