...
config(LISTVAL, "TWS声道GPIOx", "GPIOx有接地为左声道", TWS_SEL_LEFT_GPIO_SEL, BIT, 5, 0, 20, ("None", 0), ("PA3", 4), ("PA4", 5), ("PA5", 6), ("PA6", 7), ("PA7", 8), ("PB0", 9), ("PB1", 10), ("PB2", 11), ("PB3", 12), ("PB4", 13), ("PB5/WKO", 14), ("PE0", 17), ("PE5", 22), ("PE6", 23), ("PE7", 24), ("PF0", 25), ("PF1", 26), ("PF2", 27), ("PF3", 28), BT_TWS_EN);
...
#endif
config(BUF, "友杰授权密钥", "友杰语音程序运行需要判断的合法授权密钥", yj_soft_key, 20);
config(KEEPEND)
