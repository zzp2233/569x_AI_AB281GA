...
{
#if SCREEN_TITLE_MULTIPLE_CHINESE_LANGUAGE_SUPPORT
    {STR_LANGUAGE_CN,  UI_BUF_I342001_1_START_LANGUAGE_00_BIN,  .vidx = CHINESE_LANGUAGE_ID},
#endif
#if SCREEN_TITLE_MULTIPLE_ENGLISH_LANGUAGE_SUPPORT
    {STR_LANGUAGE_ENG, UI_BUF_I342001_1_START_LANGUAGE_00_BIN, .vidx = ENGLISH_LANGUAGE_ID},
#endif
#if SCREEN_TITLE_MULTIPLE_FRENCH_LANGUAGE_SUPPORT
    {STR_LANGUAGE_FN,  UI_BUF_I342001_1_START_LANGUAGE_00_BIN, .vidx = FRENCH_LANGUAGE_ID},
#endif
#if SCREEN_TITLE_MULTIPLE_RUSSIAN_LANGUAGE_SUPPORT
    {STR_LANGUAGE_RU,  UI_BUF_I342001_1_START_LANGUAGE_00_BIN, .vidx = RUSSIAN_LANGUAGE_ID},
#endif
#if SCREEN_TITLE_MULTIPLE_JAPANESE_LANGUAGE_SUPPORT
    {STR_LANGUAGE_JP,  UI_BUF_I342001_1_START_LANGUAGE_00_BIN, .vidx = JAPANESE_LANGUAGE_ID},
#endif
#if SCREEN_TITLE_MULTIPLE_ITALIAN_LANGUAGE_SUPPORT
    {STR_ITALY, UI_BUF_I342001_1_START_LANGUAGE_00_BIN,  .vidx = ITALIAN_LANGUAGE_ID},//意大利
#endif
#if SCREEN_TITLE_MULTIPLE_GERMAN_LANGUAGE_SUPPORT
    {STR_GERMAN, UI_BUF_I342001_1_START_LANGUAGE_00_BIN,  .vidx = GERMAN_LANGUAGE_ID},//德文
#endif
#if SCREEN_TITLE_MULTIPLE_ARABIC_LANGUAGE_SUPPORT
    {STR_ARABIC,  UI_BUF_I342001_1_START_LANGUAGE_00_BIN, .vidx = ARABIC_LANGUAGE_ID},//阿拉伯文
#endif
#if SCREEN_TITLE_MULTIPLE_TRADITIONAL_CHINESE_LANGUAGE_SUPPORT
    {STR_TRADITIONAL_CHINESE, UI_BUF_I342001_1_START_LANGUAGE_00_BIN, .vidx = TRADITIONAL_CHINESE_ID},
#endif
#if SCREEN_TITLE_MULTIPLE_THAI_LANGUAGE_SUPPORT
    {STR_THAI, UI_BUF_I342001_1_START_LANGUAGE_00_BIN,   .vidx = THAI_LANGUAGE_ID},
#endif
#if SCREEN_TITLE_MULTIPLE_SPANISH_LANGUAGE_SUPPORT
    {STR_SPANISH,  UI_BUF_I342001_1_START_LANGUAGE_00_BIN,  .vidx = SPANISH_LANGUAGE_ID},
#endif
#if SCREEN_TITLE_MULTIPLE_TURKISH_LANGUAGE_SUPPORT
    {STR_TURKEY,   UI_BUF_I342001_1_START_LANGUAGE_00_BIN, .vidx = TURKISH_LANGUAGE_ID},
#endif
#if SCREEN_TITLE_MULTIPLE_PORTUGUESE_LANGUAGE_SUPPORT
    {STR_PORTUGUESE,  UI_BUF_I342001_1_START_LANGUAGE_00_BIN,  .vidx = PORTUGUESE_LANGUAGE_ID},
#endif
};
#else
static const compo_listbox_item_t tbl_power_on_language_list[] =
