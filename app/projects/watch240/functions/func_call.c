...
static const compo_listbox_item_t tbl_call_list[] =
{
    {STR_CALL_LINK,        UI_BUF_I341001_11_CALL_ICON_CONTACT_BIN,          .func_sta = FUNC_ADDRESS_BOOK},  //联系人
    {STR_CALL_RECENT,      UI_BUF_I341001_11_CALL_ICON_CALL_BIN,             .func_sta = FUNC_CALL_SUB_RECORD},    //通话记录
...
compo_form_t *func_call_form_create(void)
{
    ...
    compo_listbox_set_focus(listbox, 152);
    compo_listbox_update(listbox);
