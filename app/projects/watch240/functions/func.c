...
extern void func_ecig_setpower(void);
...
//    {FUNC_TIME_SUB_CUSTOM,              func_time_sub_custom_form_create},
    ...
    {FUNC_CHATBOT_REMIND,                func_chatbot_remind_form_create},
...
//    {FUNC_TETRIS_START,                 func_tetris_start_form_create},
    ...
    {FUNC_ECIG_SETPOWER,                    func_ecig_setpower_form_create},
};
...
//    {FUNC_SET_SUB_SOS,                  func_set_sub_sos},
    ...
    {FUNC_ECIG_SETPOWER,                func_ecig_setpower},
};
...
void func_message(size_msg_t msg)
{
    switch (msg)
    {
        ...
        case MSG_CTP_SHORT_RIGHT:
            ...
            else if (func_cb.sta != FUNC_ECIG_SETPOWER)
            {
...
//
        ...
        case EVT_VAPE_POWERUP:
            printf("111uteModuleSmokeData.current_power=%d，ecig_get_power()=%d\r\n",uteModuleSmokeData.current_power,ecig_get_power());
            uteModuleSmokeData.current_power += 2;
            uteModuleSmokeData.current_index += 2;
            uteModuleSmokeDataSaveConfig();
            printf("2222uteModuleSmokeData.current_power=%d，ecig_get_power()=%d\r\n",uteModuleSmokeData.current_power,ecig_get_power());
            break;

        case EVT_VAPE_POWERDOWN:
            printf("333uteModuleSmokeData.current_power=%d，ecig_get_power()=%d\r\n",uteModuleSmokeData.current_power,ecig_get_power());
            uteModuleSmokeData.current_power -= 2;
            uteModuleSmokeData.current_index -= 2;
            printf("444uteModuleSmokeData.current_power=%d，ecig_get_power()=%d\r\n",uteModuleSmokeData.current_power,ecig_get_power());
            uteModuleSmokeDataSaveConfig();
            break;
