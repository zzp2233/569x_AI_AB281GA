    ...
    if(tick_check_expire(ticks, 10))
    {
        ...
        switch (f_sport_switching->anim_sta)
        {
            ...
            case SPORT_ANIM_STA_NEXT:   //缩小
                ...
                {
                    // 检查是否已经跑完所有图片
                    if (f_sport_switching->anim_num >= ANIM_MAX_CNT - 1) // 假设ANIM_MAX_CNT是3，索引从0开始
                    {
                        f_sport_switching->anim_sta = SPORT_ANIM_STA_END;
                    }
                    else
                    {
                        f_sport_switching->anim_num++; // 切换到下一张图片
...
static const u32 anim_addr_tbl[] =      //替换图片即可
{
    UI_BUF_I338001_3_EXERCISE_4_COUNTDOWN_02_BIN,
    UI_BUF_I338001_3_EXERCISE_4_COUNTDOWN_01_BIN,
    UI_BUF_I338001_3_EXERCISE_4_COUNTDOWN_00_BIN,
};
...
static const u32 anim_addr_tbl[] =      //替换图片即可
{
    UI_BUF_I335001_3_EXERCISE_4_COUNTDOWN_NUM_90X115_X74_Y84_00_BIN,
    UI_BUF_I335001_3_EXERCISE_4_COUNTDOWN_NUM_90X115_X74_Y84_01_BIN,
    UI_BUF_I335001_3_EXERCISE_4_COUNTDOWN_NUM_90X115_X74_Y84_02_BIN,
};
...
static const u32 anim_addr_tbl[] =      //替换图片即可
{
    UI_BUF_I341001_3_EXERCISE_4_COUNTDOWN_03_BIN,
    UI_BUF_I341001_3_EXERCISE_4_COUNTDOWN_02_BIN,
    UI_BUF_I341001_3_EXERCISE_4_COUNTDOWN_01_BIN,
};
...
compo_form_t *func_sport_switching_form_create(void)
{
    ...
    //创建图片
    compo_picturebox_t *pic;
    pic = compo_picturebox_create(frm, anim_addr_tbl[0]);
...
static void func_sport_animation(void)
{
    ...
    if(tick_check_expire(ticks, 50))
    {
        ...
        if(index == 0)
        {
            rate = (rate > 95) ? 100 : (rate + 5);
            compo_picturebox_set_size(pic,PIC_W * rate / 100,PIC_W * rate / 100);
        ...
        if(count >= 20)
        {
            ...
            count = 0;
            compo_picturebox_set(pic,anim_addr_tbl[index]);
        }
    }
}
...
static const u32 anim_addr_tbl[] =      //替换图片即可
{
    UI_BUF_I343001_3_EXERCISE_4_COUNTDOWN_03_BIN,
    UI_BUF_I343001_3_EXERCISE_4_COUNTDOWN_02_BIN,
    UI_BUF_I343001_3_EXERCISE_4_COUNTDOWN_01_BIN,
};
...
static const u32 anim_addr_tbl[] =      //替换图片即可
{
    UI_BUF_I340001_SPORT_COUNTDOWN_03_BIN,
    UI_BUF_I340001_SPORT_COUNTDOWN_02_BIN,
    UI_BUF_I340001_SPORT_COUNTDOWN_01_BIN,
};
...
static const u32 anim_addr_tbl[] =      //替换图片即可
{
    UI_BUF_I342001_3_EXERCISE_4_COUNTDOWN_00_BIN,
    UI_BUF_I342001_3_EXERCISE_4_COUNTDOWN_01_BIN,
    UI_BUF_I342001_3_EXERCISE_4_COUNTDOWN_02_BIN,
};
...
{
    task_stack_remove(FUNC_SPORT_SWITCH);
