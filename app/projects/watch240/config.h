...
#define MAX_FUNC_MINI_SORT_CNT          15   //最大支持小组件任务个数
...
#define CTP_SUPPORT_COVER               UTE_MODULE_COVER_DISPLAY_OFF_SUPPORT                           //是否支持盖手息屏功能，需要确认屏幕是否支持
 ...
 * Module    : GUI相关配置
 *****************************************************************************/
#define COMPO_BUF_SIZE                  (2048 + 1024 + 300 + 2048)                  //组件BUF大小(2个BUF)
...
#define BT_HFP_INBAND_RING_EN           (1&!UTE_MODULE_BT_RINGTONE_USE_LOCAL_RESOURCE)   //是否支持手机来电铃声（部分android不支持，默认用本地RING提示音）
...
#define USER_MULTI_KEY_TIME             3           //按键多击响应时间（单位100ms）
...
#define CHARGE_VBAT_REFILL              (UTE_DRV_BATTERY_MAX_VOLTAGE - 50) //充满后停止充电，电池掉到指定电压后续充
...
/*****************************************************************************
 * Module    : Plugin function add          ///>feat: ShadowX; 20250705 - 20XXXXXX
 *****************************************************************************/
#define EN_SELF_LIB_PLATFORM            0       ///>feat: 使能 用户私有库; ShadowX; 20250705; for self
#define EN_CUM_MENU_RING1               0       ///>feat: 使能 用户环形菜单1; ShadowX; 20250705; for ute
#define EN_CUM_MENU_RING2               0       ///>feat: 使能 用户环形菜单2; ShadowX; 20250705; for ute
#define EN_CUM_WOMEN_HEALTH_APP         0       ///>feat: 使能 用户健康界面; ShadowX; 20250705; for ute
#define EN_CUM_APPLE_DIAL               0       ///>feat: 使能 用户苹果表盘界面; ShadowX; 20250708; for sds
#define EN_CUM_SWITCH_LR_MODE_CHOOSE    1       ///>feat: 使能 用户选择左右切换; ShadowX; 20250708; for ute
#define EN_CUM_SWITCH_LR_TRANSLATION    1       ///>feat: 使能 用户左右平移切换; ShadowX; 20250715; for ute
#define EN_CUM_SWITCH_LR_UNIL_SCALE     1       ///>feat: 使能 用户左右单边缩放; ShadowX; 20250715; for ute
