...
#define CALL_TYPE_ICON_AREA                 (gui_image_get_size(UI_BUF_I335001_CALL_00_ICON_BG_224X68_X8_Y48_Y126_Y202_BIN))                  //通话记录类型图标显示区域, 如果图片输入0表示图标所占区域为0
...
static u32 call_record_set_icon_callback(u32 index)
{
    ...
    {
        case CALL_MISSED:                   //未接电话时要显示的图标
            return  UI_BUF_I335001_CALL_03_ICON_18X18_X88_Y99_Y175_Y249_Y326_00_BIN;//UI_BUF_I330001_THEME_1_CALL_BIN;

        case CALL_RECEIVED:                 //接听电话时要显示的图标
            return  UI_BUF_I335001_CALL_03_ICON_18X18_X88_Y99_Y175_Y249_Y326_01_BIN;

        case CALL_DIALED:                   //拨出电话时要显示的图标
            return  UI_BUF_I335001_CALL_03_ICON_18X18_X88_Y99_Y175_Y249_Y326_02_BIN;
...
//    printf("name:%s\n",get_address_name(address_book_tb2[0].numberAscii));
    ...
    //创建无消息界面
    compo_picturebox_t* pic = compo_picturebox_create(frm, UI_BUF_I335001_CALL_03_ICON_72X86_X80_Y84_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y);
    compo_picturebox_set_visible(pic, false);
    compo_setid(pic, COMPO_ID_COVER_PIC);
...
#define CALL_TYPE_ICON_AREA                 (gui_image_get_size(UI_BUF_I341001_11_CALL_ICON_MIN_00_BIN))                  //通话记录类型图标显示区域, 如果图片输入0表示图标所占区域为0
...
static u32 call_record_set_icon_callback(u32 index)
{
    ...
    {
        case CALL_MISSED:                   //未接电话时要显示的图标
            return  UI_BUF_I341001_11_CALL_ICON_MIN_02_BIN;

        case CALL_RECEIVED:                 //接听电话时要显示的图标
            return  UI_BUF_I341001_11_CALL_ICON_MIN_00_BIN;

        case CALL_DIALED:                   //拨出电话时要显示的图标
            return  UI_BUF_I341001_11_CALL_ICON_MIN_01_BIN;
...
//    printf("name:%s\n",get_address_name(address_book_tb2[0].numberAscii));
    ...
    //创建无消息界面
    compo_picturebox_t* pic = compo_picturebox_create(frm, UI_BUF_I341001_11_CALL_NO_CALL_LOG_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y-25);
    compo_picturebox_set_visible(pic, false);
    compo_setid(pic, COMPO_ID_COVER_PIC);
...
//    printf("name:%s\n",sys_cb.pbap_result_Name);
    ...
    compo_listbox_set_item_text(listbox, 0, listbox->line_height/2-36, 300, 48, false);
    compo_listbox_set_item_text2(listbox, 34, listbox->line_height/2+12, 240, 48, false);
    compo_listbox_set_item_icon_pos(listbox, gui_image_get_size(UI_BUF_I341001_11_CALL_ICON_MIN_00_BIN).wid/2, 16+listbox->line_height/2+gui_image_get_size(UI_BUF_I341001_11_CALL_ICON_MIN_00_BIN).hei/2);
    ...
    //新建按钮
    compo_button_t *btn;
    btn = compo_button_create_page_by_image(frm,listbox->page, UI_BUF_I341001_14_INFORMATION_DELETE_BIN);
    compo_setid(btn, COMPO_ID_BTN_DELAY);
    compo_button_set_pos(btn, GUI_SCREEN_CENTER_X,last_y-3);
    compo_button_set_visible(btn,record_cnt);
...
static void func_call_sub_record_icon_click(void)
{
    ...
    compo_listbox_t *listbox = f_call->listbox;
    compo_button_t *btn = compo_getobj_byid(COMPO_ID_BTN_DELAY);
    compo_picturebox_t *picbox = compo_getobj_byid(COMPO_ID_COVER_PIC);
    compo_textbox_t *txt = compo_getobj_byid(COMPO_ID_COVER_TXT);
...
static u32 call_record_set_icon_callback(u32 index)
{
    ...
    {
        case CALL_MISSED:                   //未接电话时要显示的图标
            return  UI_BUF_I343001_11_CALL_ICON_MIN_02_BIN;//UI_BUF_I330001_THEME_1_CALL_BIN;

        case CALL_RECEIVED:                 //接听电话时要显示的图标
            return  UI_BUF_I343001_11_CALL_ICON_MIN_00_BIN;

        case CALL_DIALED:                   //拨出电话时要显示的图标
            return  UI_BUF_I343001_11_CALL_ICON_MIN_01_BIN;
...
//    printf("name:%s\n",get_address_name(address_book_tb2[0].numberAscii));
    ...
    //创建无消息界面
    compo_picturebox_t* pic = compo_picturebox_create(frm, UI_BUF_I343001_11_CALL_NO_CALL_LOG_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y-25);
    compo_picturebox_set_visible(pic, false);
    compo_setid(pic, COMPO_ID_COVER_PIC);
...
//    printf("name:%s\n",sys_cb.pbap_result_Name);
    ...
    compo_listbox_set_alike_icon(listbox, UI_BUF_I343001_11_CALL_CONTACTS_BIN);
    compo_listbox_set_text_modify_by_idx_callback2(listbox, call_record_update_callback);
    ...
    //新建按钮
    compo_button_t *btn;
    btn = compo_button_create_page_by_image(frm,listbox->page, UI_BUF_I343001_11_CALL_DETELE_BIN);
    compo_setid(btn, COMPO_ID_BTN_DELAY);
    compo_button_set_pos(btn, GUI_SCREEN_CENTER_X,last_y-3);
    compo_button_set_visible(btn,record_cnt);
...
#define CALL_TYPE_ICON_AREA                 (gui_image_get_size(UI_BUF_I338001_11_CALL_ICON_MIN_02_BIN))                  //通话记录类型图标显示区域, 如果图片输入0表示图标所占区域为0
...
static u32 call_record_set_icon_callback(u32 index)
{
    ...
    {
        case CALL_MISSED:                   //未接电话时要显示的图标
            return  UI_BUF_I338001_11_CALL_ICON_MIN_02_BIN;

        case CALL_RECEIVED:                 //接听电话时要显示的图标
            return  UI_BUF_I338001_11_CALL_ICON_MIN_00_BIN;

        case CALL_DIALED:                   //拨出电话时要显示的图标
            return  UI_BUF_I338001_11_CALL_ICON_MIN_01_BIN;
...
//    //创建无消息界面
    compo_picturebox_t* pic = compo_picturebox_create(frm, UI_BUF_I338001_11_CALL_NO_CALL_LOG_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y-16);
    compo_picturebox_set_visible(pic, false);
    compo_setid(pic, COMPO_ID_COVER_PIC);
...
#define CALL_TYPE_ICON_AREA                 (gui_image_get_size(UI_BUF_I340001_CALL_CALL_LOG_INCOMING_CALL_BIN))                  //通话记录类型图标显示区域, 如果图片输入0表示图标所占区域为0
...
static u32 call_record_set_icon_callback(u32 index)
{
    ...
    {
        case CALL_MISSED:                   //未接电话时要显示的图标
            return  UI_BUF_I340001_CALL_CALL_LOG_INCOMING_CALL_BIN;

        case CALL_RECEIVED:                 //接听电话时要显示的图标
            return  UI_BUF_I340001_CALL_CALL_LOG_INCOMING_CALL_BIN;

        case CALL_DIALED:                   //拨出电话时要显示的图标
            return  UI_BUF_I340001_CALL_CALL_LOG_DEENERGIZE_BIN;
...
//    //创建无消息界面
    compo_picturebox_t* pic = compo_picturebox_create(frm, UI_BUF_I340001_CALL_NO_LOG_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y-16);
    compo_picturebox_set_visible(pic, false);
    compo_setid(pic, COMPO_ID_COVER_PIC);
...
#define CALL_TYPE_ICON_AREA                 (gui_image_get_size(UI_BUF_I342001_11_CALL_ICON_MIN_02_BIN))                  //通话记录类型图标显示区域, 如果图片输入0表示图标所占区域为0
...
static u32 call_record_set_icon_callback(u32 index)
{
    ...
    {
        case CALL_MISSED:                   //未接电话时要显示的图标
            return  UI_BUF_I342001_11_CALL_ICON_MIN_02_BIN;

        case CALL_RECEIVED:                 //接听电话时要显示的图标
            return  UI_BUF_I342001_11_CALL_ICON_MIN_00_BIN;

        case CALL_DIALED:                   //拨出电话时要显示的图标
            return  UI_BUF_I342001_11_CALL_ICON_MIN_01_BIN;
...
//    //创建无消息界面
    compo_picturebox_t* pic = compo_picturebox_create(frm, UI_BUF_I342001_11_CALL_NO_CALL_LOG_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y-16);
    compo_picturebox_set_visible(pic, false);
    compo_setid(pic, COMPO_ID_COVER_PIC);
...
//    printf("name:%s\n",sys_cb.pbap_result_Name);
    ...
    //新建列表
    compo_listbox_t *listbox = compo_listbox_create(frm, COMPO_LISTBOX_STYLE_TITLE_TWO_TEXT_CIRCLE);
    compo_setid(listbox, COMPO_ID_LISTBOX);
    //更新最近通话
    func_call_sub_record_update();
    if (record_cnt)
...
//                compo_listbox_set_icon_area(f_call->listbox, CALL_TYPE_ICON_AREA);
                compo_listbox_move_init_modify(f_call->listbox, 127-50, compo_listbox_gety_byidx(f_call->listbox, (record_cnt - 2 > 0) ? record_cnt - 2 : 1));
                compo_listbox_update_with_text_scroll_rst(f_call->listbox);
//                compo_listbox_set_bgimg(f_call->listbox, UI_BUF_I330001_FIRSTORDER_CARD_BIN);
                ...
                compo_listbox_set(f_call->listbox, tbl_record_list, (record_cnt < 2) ? 2 : record_cnt);
//                compo_listbox_set_icon_area(f_call->listbox, CALL_TYPE_ICON_AREA);
                compo_listbox_move_init_modify(f_call->listbox, 155, compo_listbox_gety_byidx(f_call->listbox, (record_cnt - 2 > 0) ? record_cnt - 2 : 1));
                compo_listbox_update_with_text_scroll_rst(f_call->listbox);
//                compo_listbox_set_bgimg(f_call->listbox, UI_BUF_I330001_FIRSTORDER_CARD_BIN);
                compo_listbox_set_focus_byidx(f_call->listbox, 1);
#endif
...
#else
    compo_listbox_move_init_modify(f_call->listbox, 155, compo_listbox_gety_byidx(f_call->listbox, (record_cnt - 2 > 0) ? record_cnt - 2 : 1)+40+((record_cnt > 2)?20:0));
