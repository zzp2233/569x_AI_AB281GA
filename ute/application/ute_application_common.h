...
/*!写入客户定制参数 wuhuowang, 2022-11-18  */
#define UTE_MODULE_FILESYSTEM_SYSTEMPARM_CUSTOMINFO  "systemparam/custominfo"
/*!在线表盘最后写入位置,wang.luo 2025-09-01 */
#define UTE_MODULE_FILESYSTEM_WATCHONLINE_LAST_INDEX  "systemparam/writeIndex"
/*! 写入一级界显示开关、顺序,wang.luo 2024-11-16 */
#define UTE_MODULE_FILESYSTEM_SYSTEMPARM_MINI_CARD_TBL_SORT "systemparam/miniCardTblSort"
...
typedef struct
{
    bool isBTDisconnectNotify;//蓝牙断开提醒开关
    bool isSOSDialEnable;//紧急呼叫开关
    uint8_t isAutoStartSport;//自动运动识别开关
    uint8_t femaleSet;//女性健康开关
} ute_custom_setting_info_t;
...
typedef struct
{
    ...
    uint8_t bleDisconnectCnt;
#endif
    bool isAppClosed; /*! APP连接断开,wang.luo 2022-11-11 */
    ute_custom_setting_info_t customSetting;
