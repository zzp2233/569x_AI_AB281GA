...
#define HOST_NAME "124.222.224.186"
...
static void nopoll_client_entry(void *p)
{
...
int nopoll_client_test(void)
{
    sys_thread_new("test", nopoll_client_entry, NULL, DEFAULT_THREAD_STACKSIZE, DEFAULT_THREAD_PRIO);
    return 0;
}
