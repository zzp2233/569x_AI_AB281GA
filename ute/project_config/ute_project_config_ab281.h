...
#define UTE_SW_VERSION "AB281V000008"

#define UTE_DRV_DSPI_FOR_SCREEN_SUPPORT 0
#define UTE_DRV_QSPI_FOR_SCREEN_SUPPORT 0
...
#define DEFAULT_SCREEN_BACKLIGHT_PERCENT    (BACK_LIGHT_PERCENT_INCREASE_OR_INCREASE*4)
...
#define UTE_MODULE_SCREENS_POWERON_SUPPORT            0 //开机logo界面
