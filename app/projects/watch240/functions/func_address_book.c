...
//    printf("name=%s",get_address_name(address_book_tbl[0].numberAscii));
    ...
    //创建无消息界面
    compo_picturebox_t* pic = compo_picturebox_create(frm, UI_BUF_I335001_CALL_01_ICON_72X80_X84_Y79_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y);
    compo_picturebox_set_visible(pic, false);
    compo_setid(pic, COMPO_ID_COVER_PIC);
...
static u8 func_address_book_update(void)
{
    ...
    if (address_book_cnt != uteModuleCallGetAddressBookSize())
    {
        address_book_cnt = uteModuleCallGetAddressBookSize();
        printf("address_book_cnt:%d\n", address_book_cnt);
        if(address_book_cnt > UTE_MODULE_CALL_ADDRESSBOOK_MAX_COUNT)
        {
            address_book_cnt = UTE_MODULE_CALL_ADDRESSBOOK_MAX_COUNT;
        }
//        if (func_cb.sta == FUNC_ADDRESS_BOOK) {
        if (address_book_tbl != NULL)
        {
...
//    printf("name=%s",get_address_name(address_book_tbl[0].numberAscii));
    ...
    //创建无消息界面
    compo_picturebox_t* pic = compo_picturebox_create(frm, UI_BUF_I341001_11_CALL_NO_CONTACTS_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, 127+135/2);
    compo_picturebox_set_visible(pic, false);
    compo_setid(pic, COMPO_ID_COVER_PIC);
    ...
    //compo_listbox_set_text_modify_by_idx_callback2(listbox, address_book_update_callback2);   //双行显示名字加和系人
    compo_listbox_set_text_modify_by_idx_callback(listbox, address_book_update_callback);       //一行显示名字或联系人
...
//    printf("name=%s",get_address_name(address_book_tbl[0].numberAscii));
    ...
    //创建无消息界面
    compo_picturebox_t* pic = compo_picturebox_create(frm, UI_BUF_I343001_11_CALL_NO_CONTACT_PERSON_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, 110+107/2);
    compo_picturebox_set_visible(pic, false);
    compo_setid(pic, COMPO_ID_COVER_PIC);
...
//    printf("name=%s",get_address_name(address_book_tbl[0].numberAscii));
    ...
    //创建无消息界面
    compo_picturebox_t* pic = compo_picturebox_create(frm, UI_BUF_I338001_11_CALL_NO_CONTACT_PERSON_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y-16);
    compo_picturebox_set_visible(pic, false);
    compo_setid(pic, COMPO_ID_COVER_PIC);
    ...
    compo_listbox_set_alike_icon(listbox, UI_BUF_I338001_11_CALL_CONTACTS_BIN);
    compo_listbox_set_text_modify_by_idx_callback2(listbox, address_book_update_callback);
...
//    printf("name=%s",get_address_name(address_book_tbl[0].numberAscii));
    ...
    //创建无消息界面
    compo_picturebox_t* pic = compo_picturebox_create(frm, UI_BUF_I340001_CALL_NO_CONTACTS_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y-16);
    compo_picturebox_set_visible(pic, false);
    compo_setid(pic, COMPO_ID_COVER_PIC);
    ...
    compo_listbox_set_alike_icon(listbox, UI_BUF_I340001_CALL_CALL_LOG_CONTACTS_G_BIN);
    compo_listbox_set_text_modify_by_idx_callback2(listbox, address_book_update_callback);
...
//    printf("name=%s",get_address_name(address_book_tbl[0].numberAscii));
    ...
    //创建无消息界面
    compo_picturebox_t* pic = compo_picturebox_create(frm, UI_BUF_I342001_11_CALL_NO_CONTACT_PERSON_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y-16);
    compo_picturebox_set_visible(pic, false);
    compo_setid(pic, COMPO_ID_COVER_PIC);
    ...
    if (tick_check_expire(f_book->tick, 1000))
    {
        ...
        if (sta)
        {
            ...
            if (address_book_cnt)
            {
                compo_listbox_set_visible(f_book->listbox, true);
                compo_listbox_set(f_book->listbox, tbl_call_list, (address_book_cnt < 2) ? 2 : address_book_cnt);
                compo_listbox_set_alike_icon(f_book->listbox, UI_BUF_I343001_11_CALL_CONTACTS_BIN);
                compo_listbox_move_init_modify(f_book->listbox, 127-30, compo_listbox_gety_byidx(f_book->listbox, (address_book_cnt - 2 > 0) ? address_book_cnt - 2 : 1));
                compo_listbox_update_with_text_scroll_rst(f_book->listbox);
                compo_listbox_set_bgimg(f_book->listbox, UI_BUF_I343001_11_CALL_NOTICE_BG_BIN);
                compo_listbox_set_focus_byidx(f_book->listbox, 1);
                compo_listbox_update(f_book->listbox);
            }
            else
    ...
    if (tick_check_expire(f_book->tick, 1000))
    {
        ...
        if (sta)
        {
            ...
            if (address_book_cnt)
            {
                compo_listbox_set_visible(f_book->listbox, true);
                compo_listbox_set(f_book->listbox, tbl_call_list, (address_book_cnt < 2) ? 2 : address_book_cnt);
                compo_listbox_set_alike_icon(f_book->listbox, UI_BUF_I340001_CALL_CALL_LOG_CONTACTS_G_BIN);
                compo_listbox_move_init_modify(f_book->listbox, 127-30, compo_listbox_gety_byidx(f_book->listbox, (address_book_cnt - 2 > 0) ? address_book_cnt - 2 : 1));
                compo_listbox_update_with_text_scroll_rst(f_book->listbox);
                compo_listbox_set_bgimg(f_book->listbox, UI_BUF_I340001_FIRSTORDER_CARD_BIN);
                compo_listbox_set_focus_byidx(f_book->listbox, 1);
                compo_listbox_update(f_book->listbox);
            }
            else
    ...
    if (tick_check_expire(f_book->tick, 1000))
    {
        ...
        if (sta)
        {
            ...
            if (address_book_cnt)
            {
                compo_listbox_set_visible(f_book->listbox, true);
                compo_listbox_set(f_book->listbox, tbl_call_list, (address_book_cnt < 2) ? 2 : address_book_cnt);
                compo_listbox_set_alike_icon(f_book->listbox, UI_BUF_I342001_11_CALL_CONTACTS_BIN);
                compo_listbox_move_init_modify(f_book->listbox, 127-50, compo_listbox_gety_byidx(f_book->listbox, (address_book_cnt - 2 > 0) ? address_book_cnt - 2 : 1));
                compo_listbox_update_with_text_scroll_rst(f_book->listbox);
//                compo_listbox_set_bgimg(f_book->listbox, UI_BUF_I342001_11_CALL_BG_BIN);
                compo_listbox_set_focus_byidx(f_book->listbox, 1);
                compo_listbox_update(f_book->listbox);
            }
            else
...
#elif GUI_SCREEN_SIZE_368X448RGB_I345001_SUPPORT || GUI_SCREEN_SIZE_320X380RGB_I343001_SUPPORT
    f_address_book_list_t *f_book = (f_address_book_list_t *)func_cb.f_cb;
    compo_listbox_t *listbox = f_book->listbox;
...
static void func_address_book_enter(void)
{
    ...
    listbox->mcb = func_zalloc(sizeof(compo_listbox_move_cb_t));        //建立移动控制块，退出时需要释放
    compo_listbox_move_init_modify(f_book->listbox, 127-50, compo_listbox_gety_byidx(f_book->listbox, (address_book_cnt - 2 > 0) ? address_book_cnt - 2 : 1)+40);
    func_cb.enter_tick = tick_get();
#endif // GUI_SCREEN_SIZE_240X284RGB_I330001_SUPPORT
}
