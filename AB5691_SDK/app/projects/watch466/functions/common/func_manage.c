...
const static func_item_info_t func_item_tbl[] =
{
    ...
    {FUNC_BREATHE,                  UI_BUF_I330001_THEME_1_BREATHE_BIN,                    STR_BREATHE},               //呼吸
    ...
    {FUNC_SCAN,                     UI_BUF_I330001_THEME_1_QR_BIN,                       STR_SCAN},                  //扫一扫
    ...
    {FUNC_SPORT,                    UI_BUF_I330001_THEME_1_ACTIVITY_BIN,                      STR_SPORTS},                //运动
    ...
    {FUNC_VOLUME,                   UI_BUF_I330001_THEME_1_SOUND_BIN,                     STR_VOLUME},                //音量
