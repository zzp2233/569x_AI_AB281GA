...
static const compo_listbox_item_t tbl_style_list[] =
{
    {STR_STYLE_LIST_1,          UI_BUF_I335001_STYLE_LIST_03_BIN,           .menu_style = MENU_STYLE_LIST},             //列表
    {STR_GONG_GE,               UI_BUF_I335001_STYLE_LIST_02_BIN,           .menu_style = MENU_STYLE_SUDOKU},           //宫格
    {STR_STYLE_HONEYCOMB,       UI_BUF_I335001_STYLE_LIST_00_BIN,           .menu_style = MENU_STYLE_HONEYCOMB},        //蜂窝
    {STR_SPHERE,                UI_BUF_I335001_STYLE_LIST_07_BIN,           .menu_style = MENU_STYLE_FOOTBALL},         //球体
    {STR_CHECKERBOARD,          UI_BUF_I335001_STYLE_LIST_06_BIN,           .menu_style = MENU_STYLE_GRID},             //棋盘
    {STR_HALO,                  UI_BUF_I335001_STYLE_LIST_01_BIN,           .menu_style = MENU_STYLE_KALE},             //光环
    {STR_STYLE_SKYRER,          UI_BUF_I335001_STYLE_LIST_08_BIN,           .menu_style = MENU_STYLE_SKYRER},           //天圆地方
#if (UTE_GUI_MENU_STYLE_CUM_GRID_DISENABLE==0)
    {STR_STYLE_GRID_1,          UI_BUF_I335001_STYLE_LIST_09_BIN,           .menu_style = MENU_STYLE_CUM_GRID},         //网格
#endif
#if (UTE_GUI_MENU_STYLE_WATERFALL_DISENABLE==0)
    {STR_STYLE_WATERFALL,       UI_BUF_I335001_STYLE_LIST_05_BIN,           .menu_style = MENU_STYLE_WATERFALL},        //瀑布
#endif
};
...
#define SET_LIST_CNT                       ((int)(sizeof(tbl_style_list) / sizeof(tbl_style_list[0])))
#define STYLE_ICON_X                        gui_image_get_size(UI_BUF_I341001_28_SET_THEME_00_BIN).wid/2
...
static const compo_listbox_item_t tbl_style_list[] =
{
    {STR_STYLE_HONEYCOMB,       UI_BUF_I341001_28_SET_THEME_00_BIN,             .menu_style = MENU_STYLE_HONEYCOMB},  //蜂窝
    {STR_STYLE_LIST_1,          UI_BUF_I341001_28_SET_THEME_03_BIN,             .menu_style = MENU_STYLE_LIST},   //列表
    {STR_GONG_GE,               UI_BUF_I341001_28_SET_THEME_02_BIN,             .menu_style = MENU_STYLE_SUDOKU},   //九宫格
    //{STR_SPHERE,                UI_BUF_I341001_28_SET_THEME_07_BIN,                           .menu_style = MENU_STYLE_FOOTBALL}, //球体
    //{STR_CHECKERBOARD,          UI_BUF_I341001_28_SET_THEME_06_BIN,                           .menu_style = MENU_STYLE_GRID},  //棋盘
    {STR_HALO,                  UI_BUF_I341001_28_SET_THEME_01_BIN,             .menu_style = MENU_STYLE_KALE}, //光环
    {STR_EXTRACTOR,             UI_BUF_I341001_28_SET_THEME_10_BIN,             .menu_style = MENU_STYLE_CUM_RING2},//环形2拨轮
    {STR_STAR_TRAILS,           UI_BUF_I341001_28_SET_THEME_11_BIN,             .menu_style = MENU_STYLE_CUM_RING1},//环形1星轨
    //{STR_STYLE_SKYRER,          UI_BUF_I341001_28_SET_THEME_08_BIN,                           .menu_style = MENU_STYLE_SKYRER},   //天圆地方
    //{STR_STYLE_GRID_1,          UI_BUF_I341001_28_SET_THEME_09_BIN,                           .menu_style = MENU_STYLE_CUM_GRID}, //网格
    {STR_STYLE_WATERFALL,       UI_BUF_I341001_28_SET_THEME_05_BIN,             .menu_style = MENU_STYLE_WATERFALL},  //瀑布
};
...
compo_form_t *func_style_form_create(void)
{
    ...
    compo_listbox_set_bithook(listbox, func_sel_style_bit);
    compo_listbox_set_item_icon_pos(listbox, STYLE_ICON_X, listbox->line_center_y);
    compo_setid(listbox, COMPO_ID_LISTBOX);
    ...
    compo_shape_t *shape;
    for (uint8_t i = 1; i < SET_LIST_CNT; i++)
    {
...
static const compo_listbox_item_t tbl_style_list[] =
{
    {STR_STYLE_LIST_1,          UI_BUF_I343001_28_SET_THEME_02_BIN,           .menu_style = MENU_STYLE_LIST},             //列表
    {STR_GONG_GE,               UI_BUF_I343001_28_SET_THEME_01_BIN,           .menu_style = MENU_STYLE_CUM_SUDOKU},       //宫格
    {STR_STYLE_HONEYCOMB,       UI_BUF_I343001_28_SET_THEME_00_BIN,           .menu_style = MENU_STYLE_HONEYCOMB},        //蜂窝
//    {STR_SPHERE,                UI_BUF_I343001_28_SET_THEME_07_BIN,           .menu_style = MENU_STYLE_FOOTBALL},         //球体
//    {STR_CHECKERBOARD,          UI_BUF_I343001_28_SET_THEME_06_BIN,           .menu_style = MENU_STYLE_GRID},             //棋盘
//    {STR_HALO,                  UI_BUF_I343001_28_SET_THEME_01_BIN,           .menu_style = MENU_STYLE_KALE},             //光环
//    {STR_STYLE_SKYRER,          UI_BUF_I343001_28_SET_THEME_08_BIN,           .menu_style = MENU_STYLE_SKYRER},           //天圆地方
//    {STR_STYLE_GRID_1,          UI_BUF_I343001_28_SET_THEME_09_BIN,           .menu_style = MENU_STYLE_CUM_GRID},         //网格
//    {STR_STYLE_WATERFALL,       UI_BUF_I343001_28_SET_THEME_05_BIN,           .menu_style = MENU_STYLE_WATERFALL},        //瀑布
};
...
compo_form_t *func_style_form_create(void)
{
    ...
    compo_listbox_set_sta_icon(listbox, UI_BUF_I343001_28_SET_CHECKED_BIN, UI_BUF_I343001_28_SET_UNCHECKED_BIN);
    compo_listbox_set_bithook(listbox, func_sel_style_bit);
    compo_setid(listbox, COMPO_ID_LISTBOX);
...
static const compo_listbox_item_t tbl_style_list[] =
{
    {STR_STYLE_LIST_1,          UI_BUF_I340001_SETTINGS_THEME_03_BIN,           .menu_style = MENU_STYLE_LIST},             //列表
    {STR_GONG_GE,               UI_BUF_I340001_SETTINGS_THEME_02_BIN,           .menu_style = MENU_STYLE_CUM_SUDOKU},       //宫格
    {STR_STYLE_HONEYCOMB,       UI_BUF_I340001_SETTINGS_THEME_00_BIN,           .menu_style = MENU_STYLE_HONEYCOMB},        //蜂窝
    {STR_SPHERE,                UI_BUF_I340001_SETTINGS_THEME_07_BIN,           .menu_style = MENU_STYLE_FOOTBALL},         //球体
    {STR_CHECKERBOARD,          UI_BUF_I340001_SETTINGS_THEME_06_BIN,           .menu_style = MENU_STYLE_GRID},             //棋盘
    {STR_HALO,                  UI_BUF_I340001_SETTINGS_THEME_01_BIN,           .menu_style = MENU_STYLE_KALE},             //光环
    {STR_STYLE_SKYRER,          UI_BUF_I340001_SETTINGS_THEME_08_BIN,           .menu_style = MENU_STYLE_SKYRER},           //天圆地方
    {STR_STYLE_GRID_1,          UI_BUF_I340001_SETTINGS_THEME_09_BIN,           .menu_style = MENU_STYLE_CUM_GRID},         //网格
    // {STR_SIX_PALACE_GRID,       UI_BUF_I340001_SETTINGS_THEME_04_BIN,           .menu_style = MENU_STYLE_CUM_FOURGRID},     //六宫格
    {STR_STYLE_WATERFALL,       UI_BUF_I340001_SETTINGS_THEME_05_BIN,           .menu_style = MENU_STYLE_WATERFALL},        //瀑布
//    {STR_STYLE_SUDOKU_1,        UI_BUF_STYLE_01_BIN,           .menu_style = MENU_STYLE_SUDOKU},           //九宫格
//    //{STR_STYLE_SUDOKU_2,        UI_BUF_STYLE_02_BIN,           .menu_style = MENU_STYLE_SUDOKU_HRZ},       //九宫格(横向)
//    {STR_STYLE_DISK,            UI_BUF_STYLE_13_BIN,           .menu_style = MENU_STYLE_DISK},             //圆盘
//    {STR_STYLE_GRID_1,          UI_BUF_STYLE_02_BIN,           .menu_style = MENU_STYLE_GRID},             //网格
...
static const compo_listbox_item_t tbl_style_list[] =
{
    {STR_STYLE_LIST_1,          UI_BUF_I342001_28_SET_THEME_03_BIN,           .menu_style = MENU_STYLE_LIST},             //列表
    {STR_GONG_GE,               UI_BUF_I342001_28_SET_THEME_02_BIN,           .menu_style = MENU_STYLE_SUDOKU},           //宫格
    {STR_STYLE_HONEYCOMB,       UI_BUF_I342001_28_SET_THEME_00_BIN,           .menu_style = MENU_STYLE_HONEYCOMB},        //蜂窝
    {STR_SPHERE,                UI_BUF_I342001_28_SET_THEME_07_BIN,           .menu_style = MENU_STYLE_FOOTBALL},         //球体
    {STR_CHECKERBOARD,          UI_BUF_I342001_28_SET_THEME_07_BIN,           .menu_style = MENU_STYLE_GRID},             //棋盘
    {STR_HALO,                  UI_BUF_I342001_28_SET_THEME_01_BIN,           .menu_style = MENU_STYLE_KALE},             //光环
    {STR_STYLE_SKYRER,          UI_BUF_I342001_28_SET_THEME_08_BIN,           .menu_style = MENU_STYLE_SKYRER},           //天圆地方
    {STR_STYLE_GRID_1,          UI_BUF_I342001_28_SET_THEME_09_BIN,           .menu_style = MENU_STYLE_CUM_GRID},         //网格
    {STR_STYLE_WATERFALL,       UI_BUF_I342001_28_SET_THEME_05_BIN,           .menu_style = MENU_STYLE_WATERFALL},        //瀑布
};
...
compo_form_t *func_style_form_create(void)
{
    ...
    compo_listbox_set_sta_icon(listbox, UI_BUF_I342001_28_SET_CHECKED_BIN, UI_BUF_I342001_28_SET_UNCHECKED_BIN);
    compo_listbox_set_bithook(listbox, func_sel_style_bit);
    compo_setid(listbox, COMPO_ID_LISTBOX);
...
#elif GUI_SCREEN_SIZE_360X360RGB_I338001_SUPPORT
    compo_listbox_move_init_modify(listbox, 80, compo_listbox_gety_byidx(listbox, SET_LIST_CNT - 2));
#elif GUI_SCREEN_SIZE_360X360RGB_I340001_SUPPORT
    compo_listbox_move_init_modify(listbox, 80, compo_listbox_gety_byidx(listbox, SET_LIST_CNT - 2)+40);
#elif GUI_SCREEN_SIZE_240X240RGB_I342001_SUPPORT
    compo_listbox_move_init_modify(listbox, 80, compo_listbox_gety_byidx(listbox, SET_LIST_CNT - 2)+40);
