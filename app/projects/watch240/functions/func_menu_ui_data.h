...
#define MENU_APP_MAX_CNT  22
#else
#define MENU_APP_MAX_CNT  UTE_MENU_APP_MAX_CNT
#endif

extern const f_menu_ui_data f_menu_ui_data_all[];
...
#else
#define MENU_STYLE_LIST_APP_MAX_NUM MENU_APP_MAX_CNT
#endif
...
#else
#define MENU_STYLE_CUM_SUDOKU_APP_MAX_NUM MENU_APP_MAX_CNT
#endif
...
#else
#define MENU_STYLE_HONEYCOMB_APP_MAX_NUM MENU_APP_MAX_CNT
#endif
...
#else
#define MENU_STYLE_SKYRER_APP_MAX_NUM MENU_APP_MAX_CNT
#endif
...
#else
#define MENU_STYLE_CUM_GRID_APP_MAX_NUM MENU_APP_MAX_CNT
#endif
...
#else
#define MENU_STYLE_WATERFALL_APP_MAX_NUM MENU_APP_MAX_CNT
#endif
#ifdef UTE_MENU_STYLE_CUM_RING1_APP_MAX_NUM /*! 环形菜单风格1 显示应用最多数量  */
#define MENU_MENU_STYLE_CUM_RING1_APP_MAX_NUM UTE_MENU_STYLE_CUM_RING1_APP_MAX_NUM
#else
#define MENU_MENU_STYLE_CUM_RING1_APP_MAX_NUM MENU_APP_MAX_CNT
#endif
#ifdef UTE_MENU_STYLE_CUM_RING2_APP_MAX_NUM /*! 环形菜单风格2 显示应用最多数量  */
#define MENU_MENU_STYLE_CUM_RING2_APP_MAX_NUM UTE_MENU_STYLE_CUM_RING2_APP_MAX_NUM
#else
#define MENU_MENU_STYLE_CUM_RING2_APP_MAX_NUM MENU_APP_MAX_CNT
#endif
