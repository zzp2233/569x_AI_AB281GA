...
#endif // UTE_MODULE_SCREENS_SETTING_SUPPORT
#if (UTE_MODULE_SCREENS_STOPWATCH_SUPPORT && !GUI_REDUCE_FUNCTION_IN_SOME_MENU)
...
//#endif // UTE_MODULE_SCREENS_TIMER_SUPPORT
#if (UTE_MODULE_SCREENS_FIND_PHNOE_SUPPORT && !GUI_REDUCE_FUNCTION_IN_SOME_MENU)
...
//#endif
#if (UTE_MODULE_SCREENS_CAMERA_SUPPORT && !GUI_REDUCE_FUNCTION_IN_SOME_MENU)
