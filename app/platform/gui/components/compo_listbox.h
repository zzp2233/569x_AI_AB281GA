...
enum COMPO_LISTBOX_STYLE
{
    ...
    COMPO_LISTBOX_STYLE_SPORT_LIST_BY_CHUANYIN,  //传音定制运动界面
    COMPO_LISTBOX_STYLE_SPORT_HISTORY_LIST,  //运动历史界面
};
...
typedef struct compo_listbox_t_
{
    ...
    widget_rect_t *shape_bgimg[LISTBOX_ITEM_CNT];
    ...
    widget_text_t *item_text3[LISTBOX_ITEM_CNT];
    widget_text_t *item_text4[LISTBOX_ITEM_CNT];
