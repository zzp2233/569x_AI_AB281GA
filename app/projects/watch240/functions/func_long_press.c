...
//图标对应矩形X轴前部坐标
#define IMG_BTN_FIRST_X GUI_SCREEN_CENTER_X - (GUI_SCREEN_WIDTH-GUI_SCREEN_WIDTH/6)/2 + gui_image_get_size(UI_BUF_I341001_SLIDEPOWEROFF_ICON_RESTART_BIN).wid/2+3
#define IMG_BTN_LAST_X  GUI_SCREEN_CENTER_X + (GUI_SCREEN_WIDTH-GUI_SCREEN_WIDTH/6)/2 - gui_image_get_size(UI_BUF_I341001_SLIDEPOWEROFF_ICON_RESTART_BIN).wid/2-3
