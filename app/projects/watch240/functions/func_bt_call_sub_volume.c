...
compo_form_t *func_call_volume_form_create(void)
{
    ...
    if(sys_cb.vol<=8)
    {
        compo_picturebox_t *volume_pic = compo_picturebox_create(frm, UI_BUF_I340001_CALL_CALLING_VOLUME_PROGRESS_00_BIN);
        compo_setid(volume_pic, COMPO_ID_PIC_VOLUME);
        compo_picturebox_set_pos(volume_pic, GUI_SCREEN_CENTER_X, 88+144);
        compo_picturebox_cut(volume_pic,sys_cb.vol,9);
    ...
    {
        compo_picturebox_t *volume_pic = compo_picturebox_create(frm, UI_BUF_I340001_CALL_CALLING_VOLUME_PROGRESS_01_BIN);
        compo_setid(volume_pic, COMPO_ID_PIC_VOLUME);
        compo_picturebox_set_pos(volume_pic, GUI_SCREEN_CENTER_X, 88+144);
        compo_picturebox_cut(volume_pic,sys_cb.vol-9,8);
    }
...
static void func_call_volume_disp_Refresh(void)
{
    ...
    if(sys_cb.vol<=8)
    {
        compo_picturebox_set(volume_pic, UI_BUF_I340001_CALL_CALLING_VOLUME_PROGRESS_00_BIN);
        compo_picturebox_set_pos(volume_pic, GUI_SCREEN_CENTER_X, 88+144);
        compo_picturebox_cut(volume_pic,sys_cb.vol,9);
    ...
    {
        compo_picturebox_set(volume_pic, UI_BUF_I340001_CALL_CALLING_VOLUME_PROGRESS_01_BIN);
        compo_picturebox_set_pos(volume_pic, GUI_SCREEN_CENTER_X, 88+144);
        compo_picturebox_cut(volume_pic,sys_cb.vol-9,8);
    }
}
