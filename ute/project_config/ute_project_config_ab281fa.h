...
#endif
#define UTE_MODULE_MODEL_NUMBER_SUPPORT 1 // 设备型号
#if UTE_MODULE_MODEL_NUMBER_SUPPORT
#define UTE_MODULE_MODEL_NUMBER "WA0034" // 设备型号
#endif

/*! 编码器gpio zn.zeng, 2021-12-06  */
#ifndef UTE_DRV_QDEC_Y_PHA_GPIO_PIN
...
#define UTE_MODULE_WATCHS_SORT_ADDRESS_ARRAYS { UI_BUF_DIALPLATE_D19878001_BIN,\
                                                UI_BUF_DIALPLATE_D19879001_BIN,\
                                                UI_BUF_DIALPLATE_D19880001_BIN,\
...
#define GUI_SCREEN_SIZE_360X360RGB_I340002_SUPPORT      1  //同乐达T70-A客户定制开机logo
