...
compo_form_t *func_activity_form_create(void)
{
    ...
    compo_textbox_t *textbox;
    area_t txt_leng;
#define TXT_SPACING  118

    pic = compo_picturebox_create(frm,UI_BUF_I343001_5_ACTIVITY_KCAL_BIN);
    compo_picturebox_set_pos(pic,112/2+39,188/2+86);
    compo_picturebox_cut(pic,pic_dis,11);
    compo_setid(pic,KCAL_ARC_ID);

    pic = compo_picturebox_create(frm,UI_BUF_I343001_5_ACTIVITY_DIS_BIN);
    compo_picturebox_set_pos(pic,112/2+168,188/2+86);
    compo_picturebox_cut(pic,pic_dis,11);
    compo_setid(pic,KM_ARC_ID);

    pic = compo_picturebox_create(frm,UI_BUF_I343001_5_ACTIVITY_STEPS_BIN);
    compo_picturebox_set_pos(pic,214/2+52,117/2+239);
    compo_picturebox_cut(pic,pic_dis,11);
    compo_setid(pic,STEP_ARC_ID);
///////////////////////////////////////////////////////////////////////////////////
    pic = compo_picturebox_create(frm, UI_BUF_I343001_5_ACTIVITY_ICON_KCAL_BIN);
    compo_picturebox_set_pos(pic, 37/2+30, 43/2+423);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_CALORIE]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,98,406,230,50);
    compo_textbox_set_forecolor(textbox, make_color(0xa3,0xa3,0xa3));
    compo_textbox_set(textbox, i18n[STR_CALORIE]);
    ...
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_pos(textbox,98, 440);
    compo_textbox_set(textbox, txt_buf);
    compo_setid(textbox,KCAL_TXT_VALUE_ID);
    ...
    textbox = compo_textbox_create(frm, strlen(i18n[STR_KCAL]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,98+8+txt_leng.wid,440,320-98+8+txt_leng.wid,50);
    compo_textbox_set(textbox, i18n[STR_KCAL]);
///////////////////////////////////////////////////////////////////////////////////
    pic = compo_picturebox_create(frm, UI_BUF_I343001_5_ACTIVITY_ICON_DIS_BIN);
    compo_picturebox_set_pos(pic, 37/2+30, 43/2+423+TXT_SPACING);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_DISTANCE]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,98,406+TXT_SPACING,230,50);
    compo_textbox_set_forecolor(textbox, make_color(0xa3,0xa3,0xa3));
    compo_textbox_set(textbox, i18n[STR_DISTANCE]);
    ...
    compo_textbox_set_font(textbox, UI_BUF_0FONT_FONT_NUM_38_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_pos(textbox,98, 440+TXT_SPACING);
    compo_textbox_set(textbox, txt_buf);
    compo_setid(textbox,KM_TXT_VALUE_ID);
    ...
    textbox = compo_textbox_create(frm, strlen(uteModuleSystemtimeGetDistanceMiType() ? i18n[STR_MILE] : i18n[STR_KILOMETRE]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,98+8+txt_leng.wid,440+TXT_SPACING,350-98+8+txt_leng.wid,50);
    compo_textbox_set(textbox, uteModuleSystemtimeGetDistanceMiType() ? i18n[STR_MILE] : i18n[STR_KILOMETRE]);
    compo_setid(textbox,KM_TXT_UNIT_ID);

///////////////////////////////////////////////////////////////////////////////////
    pic = compo_picturebox_create(frm, UI_BUF_I343001_5_ACTIVITY_ICON_STEP_BIN);
    compo_picturebox_set_pos(pic, 37/2+30, 43/2+423+TXT_SPACING*2);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_SET_STEP_COUNT]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,98,406+TXT_SPACING*2,230,50);
    compo_textbox_set_forecolor(textbox, make_color(0xa3,0xa3,0xa3));
    compo_textbox_set(textbox, i18n[STR_SET_STEP_COUNT]);
    ...
    compo_textbox_set_font(textbox, UI_BUF_0FONT_FONT_NUM_38_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_pos(textbox,98, 440+TXT_SPACING*2);
    compo_textbox_set(textbox, txt_buf);
    compo_setid(textbox,STEP_TXT_VALUE_ID);
    ...
    textbox = compo_textbox_create(frm, strlen(i18n[STR_STEP]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,98+8+txt_leng.wid,440+TXT_SPACING*2,350-98+8+txt_leng.wid,50);
    compo_textbox_set(textbox, i18n[STR_STEP]);
///////////////////////////////////////////////////////////////////////////////
    pic = compo_picturebox_create(frm, UI_BUF_I343001_5_ACTIVITY_DATE_BG_BIN);
    compo_picturebox_set_pos(pic, 298/2+11, 294/2+739);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_STEP_DETAILS]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,29,753,300,50);
    compo_textbox_set_forecolor(textbox, make_color(0x12,0xa9,0x94));
    compo_textbox_set(textbox, i18n[STR_STEP_DETAILS]);
    ...
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_38_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,10,807,GUI_SCREEN_CENTER_X-13,50);
    compo_textbox_set_right_align(textbox, true);
    compo_textbox_set(textbox, txt_buf);
...
//    target_step = 0;
    ...
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,807,GUI_SCREEN_CENTER_X-13,50);
    compo_textbox_set_forecolor(textbox, make_color(153,153,153));
    compo_textbox_set(textbox, txt_buf);
    ...
    uteModuleSportLoadTodayEveryHourStepHistoryData(step_date);
    compo_chartbox_t*chart = compo_chartbox_create(frm, CHART_TYPE_BAR_ARC, 24);///图表内的柱形图
    compo_chartbox_set_location(chart, GUI_SCREEN_CENTER_X+3,877+116/2,260,116);
    compo_chartbox_set_pixel(chart, 1);
    ...
    for (int i=0; i<24; i++)
    {
        ...
        chart_info.height = step_date[i]*(116*1000/target_step)/1000;///心率数据转换为柱形条显示数据
//        chart_info.height = 8000*(116*1000/target_step)/1000;///心率数据转换为柱形条显示数据
        compo_chartbox_set_value(chart, i, chart_info, make_color(0,236,203));
    }
...
//     target_week_step =18000;
    ...
    textbox = compo_textbox_create(frm, strlen(i18n[STR_WEEK_STEP]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,24,1061,300,widget_text_get_max_height());
    compo_textbox_set_forecolor(textbox, make_color(0x12,0xa9,0x94));
    compo_textbox_set(textbox, i18n[STR_WEEK_STEP]);
    ...
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_38_BIN);
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,1118+42/2,230,widget_text_get_max_height());
    compo_textbox_set(textbox, txt_buf);

    pic = compo_picturebox_create(frm,uteModuleSystemtimeReadLanguage() == CHINESE_LANGUAGE_ID ? UI_BUF_I343001_5_ACTIVITY_WEEK_DATE_BG_ZH_BIN : UI_BUF_I343001_5_ACTIVITY_WEEK_DATE_BG_EN_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, 1183+152/2);

    chart = compo_chartbox_create(frm, CHART_TYPE_BAR_ARC, 7);///图表内的柱形图
    compo_chartbox_set_location(chart, GUI_SCREEN_CENTER_X,1173+152/2,295,116);
    compo_chartbox_set_pixel(chart, 1);
    ...
    for (int i=0; i<7; i++)
    {
        //week_step_date[i] =6000;
        chart_info.x = i*chart_info.width + i*27;
        chart_info.height = week_step_date[i]*(140*1000/target_week_step)/1000;///心率数据转换为柱形条显示数据
//        chart_info.height =18000*(116*1000/target_week_step)/1000;///心率数据转换为柱形条显示数据
        compo_chartbox_set_value(chart, i, chart_info, make_color(0,236,203));
    }
...
///新建窗体和背景
    ...
    uint16_t currDayExerciseSec = uteModuleSportGetCurrDayExerciseData();
    if(totalStepCnt > uteModuleSportGetStepsTargetCnt())
    {
        totalStepCnt_handle = uteModuleSportGetStepsTargetCnt();
    }
    ...
    compo_textbox_t *textbox;
    area_t txt_leng;
#define TXT_SPACING  113

    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_ELLIPSE_22_BIN);
    compo_picturebox_set_pos(pic, 21 + 326 / 2, 326 / 2 + 84);

    //第一页
    int pic_dis = (targetNotifyData.todayKcalTarget!=0 )? \
                  (uteModuleSportGetCurrDayKcalData() * 1000 /targetNotifyData.todayKcalTarget) : 0;
    if(pic_dis>1000)pic_dis=1000;

    // compo_arc_t *arc = compo_arc_create(frm);
    // compo_arc_set_alpha(arc,150,0);
    // compo_arc_set_location(arc,21 + 326 / 2,326/2+84,146,146);
    // compo_arc_set_width(arc,34);
    // compo_arc_set_rotation(arc,1800);
    // compo_arc_set_angles(arc,0,2700);
    // compo_arc_set_color(arc,make_color(0xff,0x48,0x6b),0);
    // compo_arc_set_value(arc,1000);
    // compo_arc_set_edge_circle(arc,true,true);
    ...
    compo_arc_set_angles(arc,0,2700);
    compo_arc_set_color(arc,make_color(0xff,0x48,0x6b),0);
    compo_arc_set_value(arc,pic_dis);
    compo_arc_set_visible(arc,pic_dis ? true : false);
    compo_arc_set_edge_circle(arc,true,true);
    compo_setid(arc,KCAL_ARC_ID);

    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_ICON_KCAL_BIN);
    compo_picturebox_set_location(pic, GUI_SCREEN_CENTER_X, 326/2 + 146 /2 + 84 - 44 / 2 + 2,30,30);

    pic_dis = (targetNotifyData.exerciseTimeTargetSetMin!=0 )? \
              (currDayExerciseSec / 60 * 1000 /targetNotifyData.exerciseTimeTargetSetMin) : 0;
    if(pic_dis>1000)pic_dis=1000;

    // arc = compo_arc_create(frm);
    // compo_arc_set_alpha(arc,150,0);
    // compo_arc_set_location(arc,21 + 326 / 2,326/2+84,326,326);
    // compo_arc_set_width(arc,34);
    // compo_arc_set_rotation(arc,1800);
    // compo_arc_set_angles(arc,0,2700);
    // compo_arc_set_color(arc,make_color(0x48,0x72,0xff),0);
    // compo_arc_set_value(arc,1000);
    // compo_arc_set_edge_circle(arc,true,true);
    ...
    compo_arc_set_visible(arc,pic_dis ? true : false);
    compo_arc_set_edge_circle(arc,true,true);
    compo_setid(arc,ACT_TIME_ARC);

    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_ICON_DURATION_BIN);
    compo_picturebox_set_location(pic, GUI_SCREEN_CENTER_X, 326 + 84 - 44 / 2 + 2,30,30);

    pic_dis = (uteModuleSportGetStepsTargetCnt()!=0 )? \
              (totalStepCnt * 1000 /uteModuleSportGetStepsTargetCnt()) : 0;
    if(pic_dis>1000)pic_dis=1000;

    // arc = compo_arc_create(frm);
    // compo_arc_set_alpha(arc,150,0);
    // compo_arc_set_location(arc,21 + 326 / 2,326/2+84,236,236);
    // compo_arc_set_width(arc,34);
    // compo_arc_set_rotation(arc,1800);
    // compo_arc_set_angles(arc,0,2700);
    // compo_arc_set_color(arc,make_color(0x00,0xfd,0x9e),0);
    // compo_arc_set_value(arc,1000);
    // compo_arc_set_edge_circle(arc,true,true);
    ...
    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_ICON_STEP_BIN);
    compo_picturebox_set_location(pic, GUI_SCREEN_CENTER_X,326/2 + 236 / 2 + 84 - 44 / 2 + 2,30,30);
    ...
    compo_textbox_set_font(textbox, UI_BUF_0FONT_FONT_NUM_38_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_pos(textbox,206, 282);
    compo_textbox_set(textbox, txt_buf);
    compo_textbox_set_forecolor(textbox,make_color(0xff,0x48,0x6b));
    compo_setid(textbox,KCAL_TXT_VALUE_ID);
    ...
    compo_textbox_set_font(textbox, UI_BUF_0FONT_FONT_NUM_38_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_pos(textbox,206, 327);
    compo_textbox_set(textbox, txt_buf);
    compo_textbox_set_forecolor(textbox,make_color(0x00,0xfd,0x9e));
    compo_setid(textbox,STEP_TXT_VALUE_ID);

    memset(txt_buf,0,sizeof(txt_buf));
    snprintf(txt_buf,sizeof(txt_buf),"%d",currDayExerciseSec / 60);
    textbox = compo_textbox_create(frm, 10);
    compo_textbox_set_font(textbox, UI_BUF_0FONT_FONT_NUM_38_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_pos(textbox,206, 374);
    compo_textbox_set(textbox, txt_buf);
    compo_textbox_set_forecolor(textbox,make_color(0x48,0x72,0xff));
    compo_setid(textbox,TIME_TXT_VALUE_ID);
    //第二页
///////////////////////////////////////////////////////////////////////////////////
    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_KCAL_BIN);
    compo_picturebox_set_pos(pic, 30 + 48 / 2, 25 + 48/2+GUI_SCREEN_HEIGHT);

    textbox = compo_textbox_create(frm, 10);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,94,2 + GUI_SCREEN_HEIGHT,300,50);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_forecolor(textbox, make_color(0xff,0x48,0x6b));
    compo_textbox_set(textbox, i18n[STR_CALORIE]);
    ...
    compo_textbox_set_pos(textbox,94,40 + GUI_SCREEN_HEIGHT);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set(textbox, txt_buf);
    compo_setid(textbox,KCAL_TXT_VALUE_ID1);

    txt_leng = widget_text_get_area(textbox->txt);
    textbox = compo_textbox_create(frm, strlen(i18n[STR_KCAL]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,104+8+txt_leng.wid,46+GUI_SCREEN_HEIGHT,230-173+8+txt_leng.wid,50);
    compo_textbox_set(textbox, i18n[STR_KCAL]);
///////////////////////////////////////////////////////////////////////////////////
    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_STEPS_BIN);
    compo_picturebox_set_pos(pic, 30 + 48 / 2, 25 + 48/2+GUI_SCREEN_HEIGHT+TXT_SPACING);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_STEPS]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,94,2 + GUI_SCREEN_HEIGHT + TXT_SPACING,300,50);
    compo_textbox_set_forecolor(textbox, make_color(0x00,0xfd,0x9e));
    ...
    compo_textbox_set_font(textbox, UI_BUF_0FONT_FONT_NUM_48_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_pos(textbox,94,40 + GUI_SCREEN_HEIGHT + TXT_SPACING);
    compo_textbox_set(textbox, txt_buf);
    compo_setid(textbox,STEP_TXT_VALUE_ID1);

    txt_leng = widget_text_get_area(textbox->txt);
    textbox = compo_textbox_create(frm, strlen(i18n[STR_STEP]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,104+8+txt_leng.wid,46+448 + TXT_SPACING,230-173+8+txt_leng.wid,50);
    compo_textbox_set(textbox, i18n[STR_STEP]);
    ///////////////////////////////////////////////////////////////////////////////////
    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_DIS_BIN);
    compo_picturebox_set_pos(pic, 30 + 48 / 2, 25 + 48/2+GUI_SCREEN_HEIGHT+TXT_SPACING*2);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_ACTIVITY_DURATION]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,94,2 + GUI_SCREEN_HEIGHT + TXT_SPACING*2,300,50);
    compo_textbox_set_forecolor(textbox, make_color(0x48,0x72,0xff));
    compo_textbox_set(textbox, i18n[STR_ACTIVITY_DURATION]);

    /*活动时长*/
    memset(txt_buf,0,sizeof(txt_buf));
    snprintf((char *)txt_buf, sizeof(txt_buf),"%d",currDayExerciseSec / 60);
    textbox = compo_textbox_create(frm, 10);
    compo_textbox_set_font(textbox, UI_BUF_0FONT_FONT_NUM_48_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_pos(textbox,94,40 + GUI_SCREEN_HEIGHT + TXT_SPACING*2);
    compo_textbox_set(textbox, txt_buf);
    compo_setid(textbox,TIME_TXT_VALUE_ID1);

    txt_leng = widget_text_get_area(textbox->txt);
    textbox = compo_textbox_create(frm, strlen(i18n[STR_MINUTE]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,104+8+txt_leng.wid,46+448 + TXT_SPACING * 2,230-173+8+txt_leng.wid,50);
    compo_textbox_set(textbox, i18n[STR_MINUTE]);
...
#define STEP_Y 356
    textbox = compo_textbox_create(frm, strlen(i18n[STR_STEPS]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,30,345 + GUI_SCREEN_HEIGHT,300,50);
    compo_textbox_set_forecolor(textbox, make_color(0x00,0xfd,0x9e));
    compo_textbox_set(textbox, i18n[STR_STEPS]);
    ...
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_48_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,30,397 + GUI_SCREEN_HEIGHT,250,50);
    compo_textbox_set(textbox, txt_buf);
    compo_setid(textbox,STEP_TXT_VALUE_ID2);
    txt_leng = widget_text_get_area(textbox->txt);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_STEP]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,40+8+txt_leng.wid,403 + GUI_SCREEN_HEIGHT,230,50);
    compo_textbox_set_alpha(textbox, 125);
    compo_textbox_set(textbox, i18n[STR_STEP]);
    ...
    if(target_step == 0)target_step = 8000;
    uint32_t step_date[24];
    uint32_t setp_y = uteModuleSportLoadTodayEveryHourStepHistoryData(step_date);
    memset(txt_buf,0,sizeof(txt_buf));
    snprintf((char *)txt_buf, sizeof(txt_buf),"%ld",setp_y);///目标数据
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_24_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_right_align(textbox,true);
    compo_textbox_set_location(textbox,305 - 100 / 2,436 + GUI_SCREEN_HEIGHT,100,50);
    compo_textbox_set_alpha(textbox, 125);
    compo_textbox_set(textbox, txt_buf);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_GOAL]) + 2);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_right_align(textbox,true);
    compo_textbox_set_location(textbox,125 - 150 / 2,181 + GUI_SCREEN_HEIGHT * 2,150,50);
    compo_textbox_set_alpha(textbox, 125);
    memset(txt_buf,0,sizeof(txt_buf));
    snprintf((char *)txt_buf, sizeof(txt_buf),"%s:",i18n[STR_GOAL]);///目标数据
    compo_textbox_set(textbox, txt_buf);

    memset(txt_buf,0,sizeof(txt_buf));
    snprintf((char *)txt_buf, sizeof(txt_buf),"%ld",target_step);///目标数据
    textbox = compo_textbox_create(frm, 10);
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_32_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,203,184 + GUI_SCREEN_HEIGHT * 2,250,50);
    compo_textbox_set_alpha(textbox, 125);
    compo_textbox_set(textbox, txt_buf);

    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_BG_DATE_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, 451 + GUI_SCREEN_HEIGHT + 168 / 2);

    compo_chartbox_t*chart = compo_chartbox_create(frm, CHART_TYPE_BAR_ARC_U, 24);///图表内的柱形图
    compo_chartbox_set_location(chart, GUI_SCREEN_CENTER_X + 10,446 + GUI_SCREEN_HEIGHT + 168 / 2,336,113);
    compo_chartbox_set_pixel(chart, 1);
#if STEP_DEBUG
    for(u8 i = 0; i < 24; i ++)
    {
        step_date[i] = get_random(8001);
    }
    step_date[23] = 8000;
    step_date[1] =0;
#endif
    ...
    for (int i=0; i<24; i++)
    {
        ...
        chart_info.height = step_date[i]*(140*1000/setp_y)/1000;///心率数据转换为柱形条显示数据
        compo_chartbox_set_value(chart, i, chart_info, make_color(0x00,0xfd,0x9e));
    }
    /***************************热量*******************/
    textbox = compo_textbox_create(frm, strlen(i18n[STR_CALORIE]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,30,345 + GUI_SCREEN_HEIGHT + STEP_Y,300,50);
    compo_textbox_set_forecolor(textbox, make_color(0xff,0x48,0x6b));
    compo_textbox_set(textbox, i18n[STR_CALORIE]);

    memset(txt_buf,0,sizeof(txt_buf));
    snprintf((char *)txt_buf, sizeof(txt_buf),"%d",uteModuleSportGetCurrDayKcalData());///步数数据
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_48_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,30,397 + GUI_SCREEN_HEIGHT + STEP_Y,250,50);
    compo_textbox_set(textbox, txt_buf);
    compo_setid(textbox,KCAL_TXT_VALUE_ID2);
    txt_leng = widget_text_get_area(textbox->txt);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_KCAL]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,40+8+txt_leng.wid,403 + GUI_SCREEN_HEIGHT + STEP_Y,230,50);
    compo_textbox_set_alpha(textbox, 125);
    compo_textbox_set(textbox, i18n[STR_KCAL]);


    uint32_t target_kcal = targetNotifyData.todayKcalTarget;
    if(target_kcal == 0)target_kcal = 600;
    uint16_t kcal_date[24];
    uint16_t kcal_y = uteModuleSportLoadTodayEveryHourKcalHistoryData(kcal_date);

    memset(txt_buf,0,sizeof(txt_buf));
    snprintf((char *)txt_buf, sizeof(txt_buf),"%d",kcal_y);///目标数据
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_24_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_right_align(textbox,true);
    compo_textbox_set_location(textbox,305 - 100 / 2,436 + GUI_SCREEN_HEIGHT + STEP_Y,100,50);
    compo_textbox_set_alpha(textbox, 125);
    compo_textbox_set(textbox, txt_buf);
    ...
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_right_align(textbox,true);
    compo_textbox_set_location(textbox,125 - 150 / 2,181 + GUI_SCREEN_HEIGHT * 2 + STEP_Y,150,50);
    compo_textbox_set_alpha(textbox, 125);
    memset(txt_buf,0,sizeof(txt_buf));
    snprintf((char *)txt_buf, sizeof(txt_buf),"%s:",i18n[STR_GOAL]);///目标数据
    compo_textbox_set(textbox, txt_buf);
    ...
    memset(txt_buf,0,sizeof(txt_buf));
    snprintf((char *)txt_buf, sizeof(txt_buf),"%ld",target_kcal);///目标数据
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_32_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,203,184 + GUI_SCREEN_HEIGHT * 2 + STEP_Y,100,50);
    compo_textbox_set_alpha(textbox, 125);
    compo_textbox_set(textbox, txt_buf);

    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_BG_DATE_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, 451 + GUI_SCREEN_HEIGHT + 168 / 2 + STEP_Y);

    chart = compo_chartbox_create(frm, CHART_TYPE_BAR_ARC_U, 24);///图表内的柱形图
    compo_chartbox_set_location(chart, GUI_SCREEN_CENTER_X + 10,446 + GUI_SCREEN_HEIGHT + 168 / 2 + STEP_Y,336,113);
    compo_chartbox_set_pixel(chart, 1);

#if STEP_DEBUG
    for(u8 i = 0; i < 24; i ++)
    {
        kcal_date[i] = get_random(6001);
    }
    kcal_date[23] = 600;
    kcal_date[1] =0;
#endif
    ...
    {
        chart_info.x = i*chart_info.width + i*7 + 4;
        chart_info.height = kcal_date[i]*(140*1000/kcal_y)/1000;///心率数据转换为柱形条显示数据
        compo_chartbox_set_value(chart, i, chart_info, make_color(0xff,0x48,0x6b));
    }

    /**********************活动时长****************/
    textbox = compo_textbox_create(frm, strlen(i18n[STR_ACTIVITY_DURATION]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,30,345 + GUI_SCREEN_HEIGHT + STEP_Y*2,300,50);
    compo_textbox_set_forecolor(textbox, make_color(0x48,0x72,0xff));
    compo_textbox_set(textbox, i18n[STR_ACTIVITY_DURATION]);

    memset(txt_buf,0,sizeof(txt_buf));
    snprintf((char *)txt_buf, sizeof(txt_buf),"%d",currDayExerciseSec / 60);///步数数据
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_48_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,30,397 + GUI_SCREEN_HEIGHT + STEP_Y*2,100,50);
    compo_textbox_set(textbox, txt_buf);
    compo_setid(textbox,TIME_TXT_VALUE_ID2);
    txt_leng = widget_text_get_area(textbox->txt);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_MINUTE]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,40+8+txt_leng.wid,403 + GUI_SCREEN_HEIGHT + STEP_Y * 2,230,50);
    compo_textbox_set_alpha(textbox, 125);
    compo_textbox_set(textbox, i18n[STR_MINUTE]);

    uint8_t act_time[24];
    uint8_t time_y = uteModuleSportLoadTodayEveryHourExerciseTimeHistoryData(act_time);
    uint32_t tag_time = targetNotifyData.exerciseTimeTargetSetMin;
    if(tag_time == 0)tag_time = 30;

    memset(txt_buf,0,sizeof(txt_buf));
    snprintf((char *)txt_buf, sizeof(txt_buf),"%d",time_y);///目标数据
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_24_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_right_align(textbox,true);
    compo_textbox_set_location(textbox,305 - 100 / 2,436 + GUI_SCREEN_HEIGHT + STEP_Y*2,100,50);
    compo_textbox_set_alpha(textbox, 125);
    compo_textbox_set(textbox, txt_buf);
    ...
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_right_align(textbox,true);
    compo_textbox_set_location(textbox,125 - 150 / 2,181 + GUI_SCREEN_HEIGHT * 2 + STEP_Y*2,150,50);
    compo_textbox_set_alpha(textbox, 125);
    memset(txt_buf,0,sizeof(txt_buf));
    snprintf((char *)txt_buf, sizeof(txt_buf),"%s:",i18n[STR_GOAL]);///目标数据
    compo_textbox_set(textbox, txt_buf);
    ...
    memset(txt_buf,0,sizeof(txt_buf));
    snprintf((char *)txt_buf, sizeof(txt_buf),"%ld",tag_time);///目标数据
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_32_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,203,184 + GUI_SCREEN_HEIGHT * 2 + STEP_Y*2,100,50);
    compo_textbox_set_alpha(textbox, 125);
    compo_textbox_set(textbox, txt_buf);

    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_BG_DATE_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, 451 + GUI_SCREEN_HEIGHT + 168 / 2 + STEP_Y*2);

    chart = compo_chartbox_create(frm, CHART_TYPE_BAR_ARC_U, 24);///图表内的柱形图
    compo_chartbox_set_location(chart, GUI_SCREEN_CENTER_X + 10,446 + GUI_SCREEN_HEIGHT + 168 / 2 + STEP_Y*2,336,113);
    compo_chartbox_set_pixel(chart, 1);

#if STEP_DEBUG
    for(u8 i = 0; i < 24; i ++)
    {
        act_time[i] = get_random(31);
    }
    act_time[23] = 30;
    act_time[1] =0;
#endif
    ...
    {
        chart_info.x = i*chart_info.width + i*7 + 4;
        chart_info.height = act_time[i]*(140*1000/time_y)/1000;///心率数据转换为柱形条显示数据
        compo_chartbox_set_value(chart, i, chart_info, make_color(0x48,0x72,0xff));
    }
...
static void func_activity_disp_handle(void)
{
    ...
    {
        f_activity->tick = tick_get();
        compo_arc_t *arc_kcal = compo_getobj_byid(KCAL_ARC_ID);//卡路里
        compo_arc_t *arc_time   = compo_getobj_byid(ACT_TIME_ARC);
        compo_arc_t *arc_step = compo_getobj_byid(STEP_ARC_ID);//步数
        compo_textbox_t *textbox_kcal = compo_getobj_byid(KCAL_TXT_VALUE_ID);
        compo_textbox_t *textbox_time = compo_getobj_byid(TIME_TXT_VALUE_ID);
        compo_textbox_t *textbox_step = compo_getobj_byid(STEP_TXT_VALUE_ID);

        compo_textbox_t *textbox_kcal1 = compo_getobj_byid(KCAL_TXT_VALUE_ID1);
        compo_textbox_t *textbox_time1 = compo_getobj_byid(TIME_TXT_VALUE_ID1);
        compo_textbox_t *textbox_step1 = compo_getobj_byid(STEP_TXT_VALUE_ID1);

        compo_textbox_t *textbox_kcal2 = compo_getobj_byid(KCAL_TXT_VALUE_ID2);
        compo_textbox_t *textbox_time2 = compo_getobj_byid(TIME_TXT_VALUE_ID2);
        compo_textbox_t *textbox_step2 = compo_getobj_byid(STEP_TXT_VALUE_ID2);
        ...
        uint32_t totalStepCnt = 0;
        uint32_t totalStepCnt_handle = 0;
        int totalKcal = uteModuleSportGetCurrDayKcalData();
        uteModuleSportGetCurrDayStepCnt(&totalStepCnt,NULL,NULL);
        if(totalStepCnt > uteModuleSportGetStepsTargetCnt())
        {
            totalStepCnt_handle = uteModuleSportGetStepsTargetCnt();
        ...
        int pic_dis = (uteModuleSportGetStepsTargetCnt()!=0 )? \
                      (totalStepCnt * 1000 /uteModuleSportGetStepsTargetCnt()) : 0;
        if(pic_dis>1000)pic_dis=1000;
        compo_arc_set_visible(arc_step,pic_dis ? true : false);
        compo_arc_set_value(arc_step,pic_dis);

        pic_dis = (targetNotifyData.todayKcalTarget!=0 )? \
                  (totalKcal * 1000 /targetNotifyData.todayKcalTarget) : 0;
        if(pic_dis>1000)pic_dis=1000;
        compo_arc_set_value(arc_kcal,pic_dis);
        compo_arc_set_visible(arc_kcal,pic_dis ? true : false);

        pic_dis = (targetNotifyData.exerciseTimeTargetSetMin!=0 )? \
                  (currDayExerciseSec / 60 * 1000 /targetNotifyData.exerciseTimeTargetSetMin) : 0;
        if(pic_dis>1000)pic_dis=1000;
        compo_arc_set_value(arc_time,pic_dis);
        compo_arc_set_visible(arc_time,pic_dis ? true : false);
        ...
        memset(txt_buf,0,sizeof(txt_buf));
        snprintf(txt_buf,sizeof(txt_buf),"%d",currDayExerciseSec / 60);
        compo_textbox_set(textbox_time, txt_buf);

        memset(txt_buf,0,sizeof(txt_buf));
        snprintf(txt_buf, sizeof(txt_buf),"%d",totalKcal);///千卡数据
        compo_textbox_set(textbox_kcal, txt_buf);

        memset(txt_buf,'\0',sizeof(txt_buf));
        snprintf((char *)txt_buf, sizeof(txt_buf),"%ld",totalStepCnt);
        compo_textbox_set(textbox_step1, txt_buf);

        memset(txt_buf,0,sizeof(txt_buf));
        snprintf(txt_buf,sizeof(txt_buf),"%d",currDayExerciseSec / 60);
        compo_textbox_set(textbox_time1, txt_buf);

        memset(txt_buf,0,sizeof(txt_buf));
        snprintf((char *)txt_buf, sizeof(txt_buf),"%d",totalKcal);///千卡数据
        compo_textbox_set(textbox_kcal1, txt_buf);

        memset(txt_buf,0,sizeof(txt_buf));
        snprintf((char *)txt_buf, sizeof(txt_buf),"%ld",totalStepCnt);
        compo_textbox_set(textbox_step2, txt_buf);

        memset(txt_buf,0,sizeof(txt_buf));
        snprintf(txt_buf,sizeof(txt_buf),"%d",currDayExerciseSec / 60);
        compo_textbox_set(textbox_time2, txt_buf);

        memset(txt_buf,0,sizeof(txt_buf));
        snprintf((char *)txt_buf, sizeof(txt_buf),"%d",totalKcal);///千卡数据
        compo_textbox_set(textbox_kcal2, txt_buf);
    }

    s32 dx, dy;
    s16 value = abs_s(f_activity->ptm->move_offset) * 1000 / abs_s(f_activity->ptm->down_spring_offset);
    compo_scroll_t* scroll = compo_getobj_byid(COMPO_ID_SCROLLBAR);
    compo_scroll_set_pos(scroll, 356, 78 - f_activity->ptm->move_offset);
    compo_scroll_set_value(scroll, value);

    if (f_activity->touch_flag)
    {
        f_activity->tick1 = tick_get();
        widget_set_visible(scroll->scroll_bg, true);
        widget_set_visible(scroll->scroll_fg, true);
        f_activity->touch_flag = false;
    }
    f_activity->touch_flag = ctp_get_dxy(&dx, &dy);
    if(tick_check_expire(f_activity->tick1, 3000))
    {
...
#define TXT_SPACING  118
    ...
    pic = compo_picturebox_create(frm,UI_BUF_I341001_5_ACTIVITY_KCAL_BIN);
    compo_picturebox_set_pos(pic,128/2+49,216/2+100);
    compo_picturebox_cut(pic,pic_dis,11);
    compo_setid(pic,KCAL_ARC_ID);

    pic = compo_picturebox_create(frm,UI_BUF_I341001_5_ACTIVITY_DIS_BIN);
    compo_picturebox_set_pos(pic,128/2+197,216/2+100);
    compo_picturebox_cut(pic,pic_dis,11);
    compo_setid(pic,KM_ARC_ID);

    pic = compo_picturebox_create(frm,UI_BUF_I341001_5_ACTIVITY_STEPS_BIN);
    compo_picturebox_set_pos(pic,246/2+63,132/2+276);
    compo_picturebox_cut(pic,pic_dis,11);
    compo_setid(pic,STEP_ARC_ID);
///////////////////////////////////////////////////////////////////////////////////
    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_ICON_KCAL_BIN);
    compo_picturebox_set_pos(pic, 46/2+34, 54/2+486);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_CALORIE]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,115,466,230,50);
    compo_textbox_set_forecolor(textbox, make_color(0xa3,0xa3,0xa3));
    compo_textbox_set(textbox, i18n[STR_CALORIE]);
    ...
    compo_textbox_set_font(textbox, UI_BUF_0FONT_FONT_NUM_38_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_pos(textbox,115, 506);
    compo_textbox_set(textbox, txt_buf);
    compo_setid(textbox,KCAL_TXT_VALUE_ID);
    ...
    textbox = compo_textbox_create(frm, strlen(i18n[STR_KCAL]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,115+8+txt_leng.wid,510,350-115+8+txt_leng.wid,50);
    compo_textbox_set(textbox, i18n[STR_KCAL]);
///////////////////////////////////////////////////////////////////////////////////
    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_ICON_DIS_BIN);
    compo_picturebox_set_pos(pic, 46/2+34, 54/2+486+TXT_SPACING);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_DISTANCE]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,115,466+TXT_SPACING,230,50);
    compo_textbox_set_forecolor(textbox, make_color(0xa3,0xa3,0xa3));
    compo_textbox_set(textbox, i18n[STR_DISTANCE]);
    ...
    compo_textbox_set_font(textbox, UI_BUF_0FONT_FONT_NUM_38_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_pos(textbox,115, 506+TXT_SPACING);
    compo_textbox_set(textbox, txt_buf);
    compo_setid(textbox,KM_TXT_VALUE_ID);
    ...
    textbox = compo_textbox_create(frm, strlen(uteModuleSystemtimeGetDistanceMiType() ? i18n[STR_MILE] : i18n[STR_KILOMETRE]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,115+8+txt_leng.wid,510+TXT_SPACING,350-115+8+txt_leng.wid,50);
    compo_textbox_set(textbox, uteModuleSystemtimeGetDistanceMiType() ? i18n[STR_MILE] : i18n[STR_KILOMETRE]);
    compo_setid(textbox,KM_TXT_UNIT_ID);

///////////////////////////////////////////////////////////////////////////////////
    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_ICON_STEP_BIN);
    compo_picturebox_set_pos(pic, 46/2+34, 54/2+486+TXT_SPACING*2);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_SET_STEP_COUNT]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,115,466+TXT_SPACING*2,230,50);
    compo_textbox_set_forecolor(textbox, make_color(0xa3,0xa3,0xa3));
    compo_textbox_set(textbox, i18n[STR_SET_STEP_COUNT]);
    ...
    compo_textbox_set_font(textbox, UI_BUF_0FONT_FONT_NUM_38_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_pos(textbox,115, 506+TXT_SPACING*2);
    compo_textbox_set(textbox, txt_buf);
    compo_setid(textbox,STEP_TXT_VALUE_ID);
    ...
    textbox = compo_textbox_create(frm, strlen(i18n[STR_STEP]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,115+8+txt_leng.wid,510+TXT_SPACING*2,350-115+8+txt_leng.wid,50);
    compo_textbox_set(textbox, i18n[STR_STEP]);
///////////////////////////////////////////////////////////////////////////////
    pic = compo_picturebox_create(frm, UI_BUF_I341001_5_ACTIVITY_DETAILS_STEPS_BG_BIN);
    compo_picturebox_set_pos(pic, 342/2+16, 338/2+850);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_STEP_DETAILS]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,30,866,300,50);
    compo_textbox_set_forecolor(textbox, make_color(0x12,0xa9,0x94));
    compo_textbox_set(textbox, i18n[STR_STEP_DETAILS]);
    ...
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_38_BIN);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,10,924,GUI_SCREEN_CENTER_X-13,50);
    compo_textbox_set_right_align(textbox, true);
    compo_textbox_set(textbox, txt_buf);
    ...
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,926,GUI_SCREEN_CENTER_X-13,50);
    compo_textbox_set_forecolor(textbox, make_color(153,153,153));
    compo_textbox_set(textbox, txt_buf);
    ...
    uteModuleSportLoadTodayEveryHourStepHistoryData(step_date);
    compo_chartbox_t*chart = compo_chartbox_create(frm, CHART_TYPE_BAR_ARC, 24);///图表内的柱形图
    compo_chartbox_set_location(chart, GUI_SCREEN_CENTER_X+3,1070,306,140);
    compo_chartbox_set_pixel(chart, 1);
    ...
    for (int i=0; i<24; i++)
    {
        // printf("step:%ld\n",step_date[i]);
        chart_info.x = i*chart_info.width + i*7;
        chart_info.height = step_date[i]*(140*1000/target_step)/1000;///心率数据转换为柱形条显示数据
        compo_chartbox_set_value(chart, i, chart_info, make_color(0,236,203));
    }
...
//////////////////////////////////////////////////////////////////////////////////
    ...
    textbox = compo_textbox_create(frm, strlen(i18n[STR_WEEK_STEP]));
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set_location(textbox,30,1220,300,widget_text_get_max_height());
    compo_textbox_set_forecolor(textbox, make_color(0x12,0xa9,0x94));
    compo_textbox_set(textbox, i18n[STR_WEEK_STEP]);
    ...
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_38_BIN);
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,1299,230,widget_text_get_max_height());
    compo_textbox_set(textbox, txt_buf);

    pic = compo_picturebox_create(frm,uteModuleSystemtimeReadLanguage() == CHINESE_LANGUAGE_ID ? UI_BUF_I341001_5_ACTIVITY_WEEK_DATE_BG_ZH_BIN : UI_BUF_I341001_5_ACTIVITY_WEEK_DATE_BG_EN_BIN);
    compo_picturebox_set_pos(pic, GUI_SCREEN_CENTER_X, 1448);

    chart = compo_chartbox_create(frm, CHART_TYPE_BAR_ARC, 7);///图表内的柱形图
    compo_chartbox_set_location(chart, GUI_SCREEN_CENTER_X,1433,332,140);
    compo_chartbox_set_pixel(chart, 1);
    ...
    {
        //week_step_date[i] =6000;
        chart_info.x = i*chart_info.width + i*34;
        chart_info.height = week_step_date[i]*(140*1000/target_week_step)/1000;///心率数据转换为柱形条显示数据
        compo_chartbox_set_value(chart, i, chart_info, make_color(0,236,203));
    }
