...
//    compo_form_set_mode(frm, COMPO_FORM_MODE_SHOW_TITLE | COMPO_FORM_MODE_SHOW_TIME);
    ...
    compo_textbox_t *txt;
    txt = compo_textbox_create(frm,strlen(i18n[STR_SLIDE_CALL]));
    compo_textbox_set_location(txt, GUI_SCREEN_CENTER_X*1.1,RECT_Y_3,RECT_WIDTH-85,IMG_WIDTH);
    compo_textbox_set(txt,i18n[STR_SLIDE_CALL]);

    txt = compo_textbox_create(frm,strlen(i18n[STR_SLIDE_OFF]));
    compo_textbox_set_location(txt, GUI_SCREEN_CENTER_X*1.1,RECT_Y_2,RECT_WIDTH-85,IMG_WIDTH);
    compo_textbox_set(txt,i18n[STR_SLIDE_OFF]);

    txt = compo_textbox_create(frm,strlen(i18n[STR_SLIDE_REST]));
    compo_textbox_set_location(txt, GUI_SCREEN_CENTER_X*1.1,RECT_Y_1,RECT_WIDTH-85,IMG_WIDTH);
    compo_textbox_set(txt,i18n[STR_SLIDE_REST]);
...
//图标对应矩形X轴前部坐标
#define IMG_BTN_FIRST_X GUI_SCREEN_CENTER_X - (GUI_SCREEN_WIDTH-GUI_SCREEN_WIDTH/6)/2 + gui_image_get_size(UI_BUF_I335001_SLIDEPOWEROFF_ICON_RESTART_BIN).wid/2+3
#define IMG_BTN_LAST_X  GUI_SCREEN_CENTER_X + (GUI_SCREEN_WIDTH-GUI_SCREEN_WIDTH/6)/2 - gui_image_get_size(UI_BUF_I335001_SLIDEPOWEROFF_ICON_RESTART_BIN).wid/2-3
...
//    compo_form_set_mode(frm, COMPO_FORM_MODE_SHOW_TITLE | COMPO_FORM_MODE_SHOW_TIME);
    ...
    /*创建三个滑动图标*/
    img_btn = compo_button_create_by_image(frm,UI_BUF_I335001_SLIDEPOWEROFF_ICON_RESTART_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_1);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_3);

    img_btn = compo_button_create_by_image(frm,UI_BUF_I335001_SLIDEPOWEROFF_ICON_SHUTDOWN_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_2);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_2);

    img_btn = compo_button_create_by_image(frm,UI_BUF_I335001_SLIDEPOWEROFF_ICON_SOS_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_3);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_1);
...
compo_form_t *func_long_press_form_create(void)
{
    ...
    compo_button_set_location(btn, GUI_SCREEN_CENTER_X/2, GUI_SCREEN_HEIGHT, 100, 100);
    compo_setid(btn, BTN_ID_OFF);

    btn = compo_button_create(frm);
    compo_button_set_location(btn, GUI_SCREEN_WIDTH - GUI_SCREEN_CENTER_X/2, GUI_SCREEN_CENTER_Y, 100, 100);
    compo_setid(btn, BTN_ID_RES);

    rect_cover = compo_shape_create(frm,COMPO_SHAPE_TYPE_RECTANGLE);
    compo_shape_set_color(rect_cover, COLOR_RED);
    compo_shape_set_location(rect_cover, GUI_SCREEN_CENTER_X/2, GUI_SCREEN_CENTER_Y, 120, 120);
    compo_shape_set_radius(rect_cover, 60);

    rect_cover = compo_shape_create(frm,COMPO_SHAPE_TYPE_RECTANGLE);
    compo_shape_set_color(rect_cover, COLOR_GREEN);
    compo_shape_set_location(rect_cover, GUI_SCREEN_WIDTH - GUI_SCREEN_CENTER_X/2, GUI_SCREEN_CENTER_Y, 120, 120);
    compo_shape_set_radius(rect_cover, 60);

    /*创建三个文本*/
    txt = compo_textbox_create(frm, strlen(i18n[STR_SLIDE_OFF]));
    compo_textbox_set_location(txt, GUI_SCREEN_CENTER_X/2, GUI_SCREEN_CENTER_Y, 110, widget_text_get_max_height());
    compo_textbox_set(txt, i18n[STR_SETTING_OFF]);
    compo_textbox_set_forecolor(txt, COLOR_BLACK);

    txt = compo_textbox_create(frm, strlen(i18n[STR_SLIDE_REST]));
    compo_textbox_set_location(txt, GUI_SCREEN_WIDTH - GUI_SCREEN_CENTER_X/2, GUI_SCREEN_CENTER_Y, 110, widget_text_get_max_height());
...
#define RECT_Y_2 GUI_SCREEN_CENTER_Y+GUI_SCREEN_CENTER_Y*0.3
#define RECT_Y_3 GUI_SCREEN_CENTER_Y+GUI_SCREEN_CENTER_Y*0.6
...
//图标对应矩形X轴前部坐标
#define IMG_BTN_FIRST_X GUI_SCREEN_CENTER_X - (GUI_SCREEN_WIDTH-GUI_SCREEN_WIDTH/6)/2 + 88/2+3
#define IMG_BTN_LAST_X  GUI_SCREEN_CENTER_X + (GUI_SCREEN_WIDTH-GUI_SCREEN_WIDTH/6)/2 - 88/2-3

//#define IMG_WIDTH    gui_image_get_size(UI_BUF_I341001_SLIDEPOWEROFF_ICON_RESTART_BIN).wid//图片宽度
#define IMG_WIDTH  88//图片宽度

//进度条前后点
#define RIGHT_TOUCH  IMG_BTN_FIRST_X+IMG_WIDTH/2+5
#define LENGTH_TOUCH IMG_BTN_FIRST_X-IMG_WIDTH/2
...
//    compo_textbox_set(txt,i18n[STR_SLIDE_CALL]);
    ...
    /*创建三个滑动图标*/
    img_btn = compo_button_create_by_image(frm,UI_BUF_I341001_SLIDEPOWEROFF_ICON_RESTART_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_1);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_3);

    img_btn = compo_button_create_by_image(frm,UI_BUF_I341001_SLIDEPOWEROFF_ICON_SHUTDOWN_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_2);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_2);

//    img_btn = compo_button_create_by_image(frm,UI_BUF_I341001_SLIDEPOWEROFF_ICON_SOS_BIN);
//    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_3);
//    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
//    compo_setid(img_btn, IMG_BTN_ID_1);
...
//图标对应矩形X轴前部坐标
#define IMG_BTN_FIRST_X GUI_SCREEN_CENTER_X - (GUI_SCREEN_WIDTH-GUI_SCREEN_WIDTH/6)/2 + gui_image_get_size(UI_BUF_I343001_SLIDEPOWEROFF_ICON_RESTART_BIN).wid/2+3
#define IMG_BTN_LAST_X  GUI_SCREEN_CENTER_X + (GUI_SCREEN_WIDTH-GUI_SCREEN_WIDTH/6)/2 - gui_image_get_size(UI_BUF_I343001_SLIDEPOWEROFF_ICON_RESTART_BIN).wid/2-3

//#define IMG_WIDTH    gui_image_get_size(UI_BUF_I341001_SLIDEPOWEROFF_ICON_RESTART_BIN).wid//图片宽度
#define IMG_WIDTH  66//图片宽度
...
//    compo_form_set_title(frm, i18n[STR_CANCEL]);
    ...
    /*创建三个滑动图标*/
    img_btn = compo_button_create_by_image(frm,UI_BUF_I343001_SLIDEPOWEROFF_ICON_RESTART_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_1);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_3);

    img_btn = compo_button_create_by_image(frm,UI_BUF_I343001_SLIDEPOWEROFF_ICON_SHUTDOWN_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_2);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_2);

    img_btn = compo_button_create_by_image(frm,UI_BUF_I343001_SLIDEPOWEROFF_ICON_SOS_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_3);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_1);
...
//    compo_form_set_mode(frm, COMPO_FORM_MODE_SHOW_TITLE | COMPO_FORM_MODE_SHOW_TIME);
    ...
    /*创建三个滑动图标*/
    img_btn = compo_button_create_by_image(frm,UI_BUF_I340001_POWEROFF_RESTART_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_1);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_3);

    img_btn = compo_button_create_by_image(frm,UI_BUF_I340001_POWEROFF_SHUTDOWN_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_2);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_2);

    img_btn = compo_button_create_by_image(frm,UI_BUF_I340001_POWEROFF_SOS_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_3);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_1);
...
//    compo_form_set_mode(frm, COMPO_FORM_MODE_SHOW_TITLE | COMPO_FORM_MODE_SHOW_TIME);
    ...
    /*创建三个滑动图标*/
    img_btn = compo_button_create_by_image(frm,UI_BUF_I342001_SLIDEPOWEROFF_ICON_RESTART_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_1);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_3);

    img_btn = compo_button_create_by_image(frm,UI_BUF_I342001_SLIDEPOWEROFF_ICON_SHUTDOWN_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_2);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_2);

    img_btn = compo_button_create_by_image(frm,UI_BUF_I342001_SLIDEPOWEROFF_ICON_SOS_BIN);
    compo_button_set_pos(img_btn, IMG_BTN_FIRST_X,RECT_Y_3);
    widget_set_size(img_btn->widget, IMG_WIDTH, IMG_WIDTH);
    compo_setid(img_btn, IMG_BTN_ID_1);
...
static void func_long_press_message(size_msg_t msg)
{
    ...
    || GUI_SCREEN_SIZE_240X284RGB_I335001_SUPPORT ||GUI_SCREEN_SIZE_360X360RGB_I340001_SUPPORT \
