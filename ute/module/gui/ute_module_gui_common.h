...
#define UTE_MOUDLE_SCREENS_FACTORY_TEST_ID FUNC_CALL_SUB_DIAL//FUNC_ONLINE_FACTORY_TEST
#define UTE_MOUDLE_SCREENS_WATCHMAIN_ID FUNC_CLOCK
#define UTE_MOUDLE_SCREENS_CHARGER_ID FUNC_CHARGE
#define UTE_MOUDLE_SCREENS_POWERON_ID FUNC_CALL_SUB_DIAL//FUNC_POWER_ON
#define UTE_MOUDLE_SCREENS_SYNC_WATCH_ONLINE_ID FUNC_CALL_SUB_DIAL//FUNC_UP_WATCH_DIAL
