...
#endif // UTE_MODULE_SCREENS_TOOLBOX_SUPPORT
#if UTE_MODULE_SCREENS_SETTING_SUPPORT
...
compo_form_t* func_menu_sub_grid_form_create(void)
{
    ...
    else
    {
        for (int i=0; i<MENU_GRID_CNT; i++)
        {
            if(tbl_menu_grid[i].func_sta == FUNC_CALCULATOR)
            {
                ...
                tbl_menu_grid[i].res_addr = UI_BUF_I335001_2_HONEYCOMB_PERIOD_BIN;
                break;
            }
        }
    }
    ...
    if(!uteModuleMenstrualCycleIsOpen())
    {
        for (int i=0; i<MENU_GRID_CNT; i++)
        {
            ...
            {
                tbl_menu_grid[i].func_sta = FUNC_CALCULATOR;
                tbl_menu_grid[i].res_addr = UI_BUF_I338001_2_HONEYCOMB_CALCULATOR_BIN;
                break;
            }
        }
    }
    else
    {
        for (int i=0; i<MENU_GRID_CNT; i++)
        {
            ...
            {
                tbl_menu_grid[i].func_sta = FUNC_WOMEN_HEALTH;
                tbl_menu_grid[i].res_addr = UI_BUF_I338001_2_HONEYCOMB_PERIOD_BIN;
                break;
            }
        }
    }
    ...
    for (int i=0; i<MENU_GRID_CNT; i++)
    {
        ...
        {
            if(tbl_menu_grid[i].func_sta == FUNC_REMIND_PRAYER)
            {
                tbl_menu_grid[i].func_sta = FUNC_FLASHLIGHT;
                tbl_menu_grid[i].res_addr = UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_FLASHLIGHT_BIN;
                break;
            }
        }
        else
        {
            if(tbl_menu_grid[i].func_sta == FUNC_FLASHLIGHT)
            {
                tbl_menu_grid[i].func_sta = FUNC_REMIND_PRAYER;
                tbl_menu_grid[i].res_addr = UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_PRAY_BIN;
                break;
            }
        }
    }
