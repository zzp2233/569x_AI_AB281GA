...
//
//    //仓低电，取flash值；仓不低电，flash值非满电，重新查询
//    u8 vbat_box = cm_read8(PARAM_BOX_PERCENT);
//    u8 vbat_read = cm_read8(PARAM_EARPHONE_VBAT_L);
//    earphone.vbat[EARPHONE_LEFT] = vbat_read == 100 ? 100 : (vbat_box <= BOX_LPWR_PERCENT ? vbat_read : 0);
//    vbat_read = cm_read8(PARAM_EARPHONE_VBAT_R);
//    earphone.vbat[EARPHONE_RIGHT] = vbat_read == 100 ? 100 : (vbat_box <= BOX_LPWR_PERCENT ? vbat_read : 0);
//
