...
compo_form_t *func_motor_grade_form_create(void)
{
    ...
    shape = compo_shape_create(frm, COMPO_SHAPE_TYPE_RECTANGLE);
    compo_shape_set_location(shape, GUI_SCREEN_CENTER_X, 225, 320, 1);
    compo_shape_set_color(shape,make_color(47,47,47));
...
compo_form_t *func_motor_grade_form_create(void)
{
    ...
    compo_button_set_pos(btn_ok,GUI_SCREEN_CENTER_X,GUI_SCREEN_HEIGHT-gui_image_get_size(UI_BUF_I343001_28_SET_COMFIRM_BIN).hei/2-10);
    compo_setid(btn_ok,COMPO_ID_BTN_SURE);
