...
compo_form_t *func_oxygen_about_form_create(void)
{
    ...
    compo_form_set_title(frm, i18n[STR_BLOOD_OXYGEN_UINT]);

    ///设置图片
    compo_picturebox_t * picbox = compo_picturebox_create(frm, UI_BUF_I341001_7_SPO2_BLOOD_OXYGEN_SATURATION_BIN);
    compo_picturebox_set_pos(picbox, 4 + 213 / 2, 89 + 142 / 2);
...
compo_form_t *func_oxygen_about_form_create(void)
{
    ...
    compo_picturebox_t *picbox = compo_picturebox_create(frm, UI_BUF_I341001_7_SPO2_ABOUT_BIN);
    compo_picturebox_set_pos(picbox,gui_image_get_size(UI_BUF_I341001_7_SPO2_ABOUT_BIN).wid/2+20, widget_text_get_area(textbox->txt).hei+(gui_image_get_size(UI_BUF_I341001_7_SPO2_ABOUT_BIN).hei)+10);
    page_size+=(gui_image_get_size(UI_BUF_I341001_7_SPO2_ABOUT_BIN).hei+40);
...
#elif GUI_SCREEN_SIZE_240X284RGB_I335001_SUPPORT || GUI_SCREEN_SIZE_368X448RGB_I341001_SUPPORT || GUI_SCREEN_SIZE_320X380RGB_I343001_SUPPORT
    if(f_oxygen_about->ptm)
    {
