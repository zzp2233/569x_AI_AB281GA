...
compo_form_t * func_clock_sub_sidebar_form_create(void)
{
    ...
    compo_cardbox_text_set_location(cardbox, 0, 140-160, 270-296, 120, 40);
    ...
    compo_cardbox_text_set_location(cardbox, 0, 129-160, 440-466, 120, 40);
    ...
    compo_cardbox_text_set_location(cardbox, 0, 0, 675-631, 140, 40);
    //日历
    cardbox = compo_cardbox_create(frm, 0, 2, 1, 146, 146);
    ...
    compo_cardbox_text_set_location(cardbox, 0, 0, 835-791, 140, 40);
    //呼吸
    cardbox = compo_cardbox_create(frm, 0, 2, 1, 146, 146);
