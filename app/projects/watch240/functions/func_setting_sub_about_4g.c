...
static const wrist_disp_pic_item_t tbl_wrist_disp_pic_item[] = {
    {UI_BUF_COMMON_ON_BIN,           COMPO_ID_PIC_4G_ON,         150,    GUI_SCREEN_CENTER_Y,    false},
    {UI_BUF_COMMON_OFF_BIN,          COMPO_ID_PIC_4G_OFF,        150,    GUI_SCREEN_CENTER_Y,    true},
};
...
compo_form_t *func_set_sub_4g_form_create(void)
{
    ...
    compo_textbox_set_pos(txt_shake, 30, GUI_SCREEN_CENTER_Y-10);
    ...
    compo_button_set_location(btn, 150, GUI_SCREEN_CENTER_Y, 80, 40);
