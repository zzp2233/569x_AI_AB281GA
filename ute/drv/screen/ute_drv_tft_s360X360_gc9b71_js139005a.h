#ifndef _UTE_DRV_TFT_S360X360_GC9B71_JS139005A_H_
#define _UTE_DRV_TFT_S360X360_GC9B71_JS139005A_H_

#include "ute_project_config.h"
#include "ute_module_platform.h"
#include "ute_drv_screen_common.h"

#if UTE_DRV_TFT_S360X360_GC9B71_JS139005A_QSPI_SUPPORT

__STATIC_INLINE void drvScreenTft360X360Gc9b71Js139005aPowerOn(void)
{
...
__STATIC_INLINE void drvScreenTft360X360Gc9b71Js139005aPowerOff(void)
{
...
__STATIC_INLINE void drvScreenTft360X360Gc9b71Js139005aSetWindow(uint16_t xStart, uint16_t yStart, uint16_t xEnd, uint16_t yEnd)
{
    yStart += 0;
    yEnd += 0;
...
__STATIC_INLINE void drvScreenTft360X360Gc9b71Js139005aInit(void)
{
    UTE_MODULE_LOG(UTE_LOG_DRV_SCREEN_LVL, "%s", __func__);
    uint8_t tmp[34];
    ...
    memcpy(tmp, "\x07\x01\x1A\x00\x0B\x0B\x09\x09\x13\x13\x11\x11\x19\x1E\x1D\x00\x00\x1D\x1E\x19\x12\x12\x14\x14\x0A\x0A\x0C\x0C\x00\x1A\x02\x08", 32);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x6E, tmp, 32);
...
const ute_drv_screen_common_config_t uteDrvScreenTft360X360Gc9b71Js139005aConfig =
{
    .name = "Tft360X360Gc9b71Js139005aQspi",
    .init = drvScreenTft360X360Gc9b71Js139005aInit,
    .powerOn = drvScreenTft360X360Gc9b71Js139005aPowerOn,
    .powerOff = drvScreenTft360X360Gc9b71Js139005aPowerOff,
    .setWindow = drvScreenTft360X360Gc9b71Js139005aSetWindow,
    .setBackLight = NULL,
};
