...
#define MENU_SUD_CNT                         ((int)((sizeof(tbl_menu_sudoku) / sizeof(tbl_menu_sudoku[0]))))
...
//    {UI_BUF_I330001_THEME_1_SPO2_BIN,              FUNC_PRESSURE},//压力
    ...
    {UI_BUF_I330001_THEME_1_LANUAGE_BIN,                  FUNC_LANGUAGE},//lang 4
...
static menu_hc_item_t tbl_menu_sudoku[] =
{
#if UTE_MODULE_SCREENS_CALL_SUPPORT
...
#endif // UTE_MODULE_SCREENS_HEARTRATE_SUPPORT
// #if UTE_MODULE_SCREENS_HEARTRATE_SUPPORT
    // {.func_sta=FUNC_HEARTRATE,                .res_addr=UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_STRESS_BIN,                },   //压力
// #endif // UTE_MODULE_SCREENS_HEARTRATE_SUPPORT
#if UTE_MODULE_SCREENS_SPORT_SUPPORT
...
compo_form_t *func_menu_sub_sudoku_form_create(void)
{
    ...
    {
        tbl_menu_sudoku[MENU_SUD_CNT-1].func_sta = FUNC_WOMEN_HEALTH;
        tbl_menu_sudoku[MENU_SUD_CNT-1].res_addr = UI_BUF_I335001_2_HONEYCOMB_PERIOD_BIN;
    }
    else
    {
        tbl_menu_sudoku[MENU_SUD_CNT-1].func_sta = 0;
        tbl_menu_sudoku[MENU_SUD_CNT-1].res_addr = 0;
    }
#elif GUI_SCREEN_SIZE_368X448RGB_I341001_SUPPORT
    if(uteModuleMenstrualCycleIsOpen())
    {
        tbl_menu_sudoku[MENU_SUD_CNT-1].func_sta = FUNC_WOMEN_HEALTH;
        tbl_menu_sudoku[MENU_SUD_CNT-1].res_addr = UI_BUF_I341001_2_HONEYCOMB_CIRCLE_ICON_PERIOD_BIN;
    }
    else
    {
        tbl_menu_sudoku[MENU_SUD_CNT-1].func_sta = 0;
...
//    compo_iconlist_set_time_idx(iconlist, 4);
...
//点进图标进入应用
static void func_menu_sub_sudoku_icon_click(void)
{
    point_t pt;
    int icon_idx;
...
//切换到时钟
static void func_menu_sub_sudoku_switch_to_clock(void)
{
    f_menu_sud_t *f_menu = (f_menu_sud_t *)func_cb.f_cb;
    compo_iconlist_t *iconlist = f_menu->iconlist;
...
//入场动画
static void func_menu_sub_sudoku_entering(void)
{
    f_menu_sud_t *f_menu = (f_menu_sud_t *)func_cb.f_cb;
    compo_iconlist_t *iconlist = f_menu->iconlist;
...
//主菜单功能事件处理
static void func_menu_sub_sudoku_process(void)
{
    f_menu_sud_t *f_menu = (f_menu_sud_t *)func_cb.f_cb;
    compo_iconlist_t *iconlist = f_menu->iconlist;
...
//主菜单功能消息处理
static void func_menu_sub_sudoku_message(size_msg_t msg)
{
    f_menu_sud_t *f_menu = (f_menu_sud_t *)func_cb.f_cb;
...
//进入主菜单功能
static void func_menu_sub_sudoku_enter(void)
{
    func_cb.f_cb = func_zalloc(sizeof(f_menu_sud_t));
    func_cb.frm_main = func_menu_sub_sudoku_form_create();
