#ifndef _UTE_DRV_TFT_S360_X360_ST77916_HY138026A_OV_QSPI_H_
#define _UTE_DRV_TFT_S360_X360_ST77916_HY138026A_OV_QSPI_H_

#include "ute_project_config.h"
#include "ute_module_platform.h"
#include "ute_drv_screen_common.h"

#if UTE_DRV_TFT_S360_X360_ST77916_HY138026A_OV_QSPI_SUPPORT

__STATIC_INLINE void drvScreenTft360X360St77916Hy138026APowerOn(void)
{
...
__STATIC_INLINE void drvScreenTft360X360St77916Hy138026APowerOff(void)
{
...
__STATIC_INLINE void drvScreenTft360X360St77916Hy138026ASetWindow(uint16_t xStart, uint16_t yStart, uint16_t xEnd, uint16_t yEnd)
{
    yStart += 0;
    yEnd += 0;
...
__STATIC_INLINE void drvScreenTft360X360St77916Hy138026AInit(void)
{
    UTE_MODULE_LOG(UTE_LOG_DRV_SCREEN_LVL, "%s", __func__);
    uint8_t tmp[34];
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xB0,(uint8_t *)"\x5E",1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xB1,(uint8_t *)"\x55",1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xB2,(uint8_t *)"\x24",1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xB4,(uint8_t *)"\x87",1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xB5,(uint8_t *)"\x44",1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xB6,(uint8_t *)"\x8B",1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xB7,(uint8_t *)"\x40",1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xC1,(uint8_t *)"\x10",1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xC2,(uint8_t *)"\x37",1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xC5,(uint8_t *)"\x37",1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xD0,(uint8_t *)"\x91",1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xD1,(uint8_t *)"\x68",1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xD2,(uint8_t *)"\x68",1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xF5,(uint8_t *)"\x00\xA5",2);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xDD,(uint8_t *)"\x40",1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xDE,(uint8_t *)"\x40",1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xE0,(uint8_t *)"\xF0\x07\x0E\x0B\x0B\x17\x33\x33\x49\x37\x13\x14\x2B\x31",14);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xE1,(uint8_t *)"\xF0\x07\x0D\x0A\x0A\x07\x33\x33\x49\x16\x13\x13\x2B\x30",14);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xE0, (uint8_t *)"\x08", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xE4, (uint8_t *)"\xE0", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xE7, (uint8_t *)"\x03", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xE8, (uint8_t *)"\x05", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xE9, (uint8_t *)"\x02", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xEA, (uint8_t *)"\xE9", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x61, (uint8_t *)"\x05", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x62, (uint8_t *)"\x00", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x63, (uint8_t *)"\x42", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x64, (uint8_t *)"\xDA", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x71, (uint8_t *)"\x04", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x72, (uint8_t *)"\x00", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x73, (uint8_t *)"\x42", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x74, (uint8_t *)"\xD9", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x82, (uint8_t *)"\x07", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x83, (uint8_t *)"\x02", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x84, (uint8_t *)"\xD7", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x8A, (uint8_t *)"\x09", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x8B, (uint8_t *)"\x02", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x8C, (uint8_t *)"\xD9", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x92, (uint8_t *)"\x0B", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x93, (uint8_t *)"\x02", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x94, (uint8_t *)"\xDB", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x9A, (uint8_t *)"\x0D", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x9B, (uint8_t *)"\x02", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x9C, (uint8_t *)"\xDD", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xA2, (uint8_t *)"\x06", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xA3, (uint8_t *)"\x02", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xA4, (uint8_t *)"\xD6", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xAA, (uint8_t *)"\x08", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xAB, (uint8_t *)"\x02", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xAC, (uint8_t *)"\xD8", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xB2, (uint8_t *)"\x0A", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xB3, (uint8_t *)"\x02", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xB4, (uint8_t *)"\xDA", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xBA, (uint8_t *)"\x0C", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xBB, (uint8_t *)"\x02", 1);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0xBC, (uint8_t *)"\xDC", 1);
    ...
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x3a, (uint8_t *)"\x05", 1);

    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x2a, (uint8_t *)"\x00\x00\x01\x68", 4);
    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x2b, (uint8_t *)"\x00\x00\x01\x68", 4);

    uteDrvScreenCommonGc9c01QspiWriteCmdParams(0x21,NULL,0);
}
const ute_drv_screen_common_config_t uteDrvScreenTft360X360St77916Hy138026AConfig =
{
    .name = "Tft360X360St77916Hy138026AQspi",
    .init = drvScreenTft360X360St77916Hy138026AInit,
    .powerOn = drvScreenTft360X360St77916Hy138026APowerOn,
    .powerOff = drvScreenTft360X360St77916Hy138026APowerOff,
    .setWindow = drvScreenTft360X360St77916Hy138026ASetWindow,
    .setBackLight = NULL,
};
