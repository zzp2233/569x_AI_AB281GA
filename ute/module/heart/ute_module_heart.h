...
/*! 最后一次心率测量信息,wang.luo 2025-09-26 */
#define UTE_MODULE_FILESYSTEM_SYSTEMPARM_HEART_LAST_INFO "systemparam/heartLastInfo"

#if APP_SYNC_RECORD_TIME_FLAG_SUPPORT
/*! 心率同步时间 dengli.lu, 2023-03-15  */
#define UTE_MODULE_FILESYSTEM_SYSTEMPARM_HEART_SYNC_TIME_INFO "systemparam/heartSyncTime"
#endif

#if APP_MODULE_HEART_MAX_HEARTRATE_SET_SUPPORT
#define UTE_MODULE_FILESYSTEM_SYSTEMPARM_HEART_MAXVALUE_INFO "systemparam/heartMaxValue"
#endif
...
} ute_module_heart_test_last_info_t;
...
#endif
    ute_module_heart_test_last_info_t lastTestInfo;
