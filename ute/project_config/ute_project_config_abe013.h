...
#define UTE_SW_VERSION "ABE013V000009"
...
#define UTE_CUI_SCREEN_TBL_SORT_CNT_DEFAULT 5
...
#define UTE_CUI_SCREEN_TBL_SORT_ARRAY_DEFAULT {FUNC_CLOCK, FUNC_CHATBOT,FUNC_ECIG_VPAE_SUB,  FUNC_BT,FUNC_COMPO_SELECT}
/*! 默认表盘索引 zn.zeng, 2021-10-25  */
#define DEFAULT_WATCH_INDEX 0
/*! 最大表盘数量，不包括在线表盘 zn.zeng, 2021-10-23  */
#define UTE_MODULE_SCREENS_WATCH_CNT_MAX 1
...
#define UTE_WATCHS_DIALPLATE_CUBE_INDEX 0   // 立方体表盘索引,此处立方体表盘索引要和UTE_MODULE_WATCHS_SORT_ADDRESS_ARRAYS中立方体位置一样
#define UTE_WATCHS_PREVIEW_SUPPORT 0   // 进入表盘预览
...
#define UTE_MODULE_SCREENS_LINK_MAN_SUPPORT           0 //联系人
#define UTE_MODULE_SCREENS_TIMER_SUPPORT              1 //计时器
#define UTE_MODULE_SCREENS_CAMERA_SUPPORT             0 //遥控拍照
#define UTE_MODULE_SCREENS_STOPWATCH_SUPPORT          1 //秒表
#define UTE_MODULE_SCREENS_VOICE_SUPPORT              0 //语音
#define UTE_MODULE_SCREENS_ALARM_SUPPORT              0 //闹钟
...
#define UTE_MODULE_SCREENS_WEATHER_SUPPORT            0 //天气
#define xUTE_MODULE_SCREENS_GAME_SUPPORT              0 //游戏
#define UTE_MODULE_SCREENS_FIND_PHNOE_SUPPORT         0 //找手机
...
#define UTE_MODULE_SCREENS_CALENDAER_SUB_SUPPORT      0 //日历一级界面
#define UTE_MODULE_SCREENS_SCAN_SUPPORT               0 //二维码
#define UTE_MODULE_SCREENS_CHATBOT_SUPPORT            1 //机器人
#define UTE_MODULE_SCREENS_DISTURD_SUPPORT            0 //勿扰
