...
compo_form_t *func_breathe_run_form_create(void)
{
    ...
    compo_picturebox_t *picbox = compo_picturebox_create(frm, UI_BUF_I341001_19_BREATHING_TRAINING_ICON_BREATHING_GIF_BIN);
    compo_picturebox_set_location(picbox,GUI_SCREEN_CENTER_X,47 + 268 / 2,PIC_BG_MIN_SIZE,PIC_BG_MIN_SIZE);
    compo_setid(picbox,COMPO_ID_PIC_BG);

    picbox = compo_picturebox_create(frm, countdown_pic[0]);
    compo_picturebox_set_pos(picbox,GUI_SCREEN_CENTER_X,47 + 268 / 2);
    compo_setid(picbox,COMPO_ID_PIC_NUM);

    compo_textbox_t *textbox = compo_textbox_create(frm, strlen(i18n[STR_BREATHE_EXHALE])+strlen(i18n[STR_BREATHE_INHALE]));
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,332 + 78 / 2,300,widget_text_get_max_height());
    compo_textbox_set(textbox,i18n[STR_BREATHE_INHALE]);
    compo_textbox_set_visible(textbox,false);
    compo_setid(textbox,COMPO_ID_TXT_STATE);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_BREATHE_EXPLAIN]));
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,332 + 78 / 2,300,120);
    compo_textbox_set_multiline(textbox,true);
    compo_textbox_set_multiline_drag(textbox,true);
    compo_textbox_set(textbox,i18n[STR_BREATHE_EXPLAIN]);
    compo_setid(textbox,COMPO_ID_PIC_PROMPT);
    ...
    if(func_cb.sta == FUNC_BREATHE_RUN)
    {
        ...
        f_breathe_run->tick = tick_get();
        f_breathe_run->animation_state = PIC_MIN_STATE;
        f_breathe_run->pic_size = PIC_BG_MIN_SIZE;
        f_breathe_run->rotate_data = 0;
        switch (sys_cb.breathe_mode)
        {
            case BREATHE_MODE_SLOW:          //缓慢
...
compo_form_t *func_breathe_run_form_create(void)
{
    ...
    textbox = compo_textbox_create(frm, strlen(i18n[STR_BREATHE_EXPLAIN]));
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,320+18,340,120);
    compo_textbox_set_multiline(textbox,true);
    compo_textbox_set_multiline_drag(textbox,true);
    compo_textbox_set(textbox,i18n[STR_BREATHE_EXPLAIN]);
    compo_setid(textbox,COMPO_ID_PIC_PROMPT);
...
const uint32_t countdown_pic [3]=
{
    UI_BUF_I343001_19_BREATHING_TRAINING_03_BIN,
    UI_BUF_I343001_19_BREATHING_TRAINING_02_BIN,
    UI_BUF_I343001_19_BREATHING_TRAINING_01_BIN,
};
...
compo_form_t *func_breathe_run_form_create(void)
{
    ...
    compo_picturebox_t *picbox = compo_picturebox_create(frm, UI_BUF_I343001_19_BREATHING_TRAINING_ICON_BREATHING_BIN);
    compo_picturebox_set_pos(picbox,GUI_SCREEN_CENTER_X,66+194/2);
    compo_setid(picbox,COMPO_ID_PIC_BG);

    picbox = compo_picturebox_create(frm, countdown_pic[0]);
    compo_picturebox_set_pos(picbox,GUI_SCREEN_CENTER_X,121+82/2);
    compo_setid(picbox,COMPO_ID_PIC_NUM);

    compo_textbox_t *textbox = compo_textbox_create(frm, strlen(i18n[STR_BREATHE_EXHALE])+strlen(i18n[STR_BREATHE_INHALE]));
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,299+widget_text_get_max_height()/2,252,widget_text_get_max_height());
    compo_textbox_set(textbox,i18n[STR_BREATHE_INHALE]);
    compo_textbox_set_visible(textbox,false);
    compo_setid(textbox,COMPO_ID_TXT_STATE);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_BREATHE_EXPLAIN]));
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,299+widget_text_get_max_height()/2,252,120);
    compo_textbox_set_multiline(textbox,true);
    compo_textbox_set_multiline_drag(textbox,true);
    compo_textbox_set(textbox,i18n[STR_BREATHE_EXPLAIN]);
    compo_setid(textbox,COMPO_ID_PIC_PROMPT);
...
#define PIC_BG_MAX_SIZE   130
#define PIC_BG_MIN_SIZE   90
...
compo_form_t *func_breathe_run_form_create(void)
{
    ...
    compo_picturebox_t *picbox = compo_picturebox_create(frm, UI_BUF_I342001_19_BREATHING_TRAINING_ICON_BREATHING_BIN);
    compo_picturebox_set_pos(picbox,GUI_SCREEN_CENTER_X,GUI_SCREEN_CENTER_Y);
    compo_setid(picbox,COMPO_ID_PIC_BG);
    ...
    compo_textbox_t *textbox = compo_textbox_create(frm, strlen(i18n[STR_BREATHE_EXHALE])+strlen(i18n[STR_BREATHE_INHALE]));
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,28/2+180,230,widget_text_get_max_height());
    compo_textbox_set(textbox,i18n[STR_BREATHE_INHALE]);
    compo_textbox_set_visible(textbox,false);
    compo_setid(textbox,COMPO_ID_TXT_STATE);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_BREATHE_EXHALE]));
    compo_textbox_set_location(textbox,GUI_SCREEN_CENTER_X,28/2+180,230,widget_text_get_max_height()*2);
    compo_textbox_set(textbox,i18n[STR_BREATHE_EXHALE]);
    compo_textbox_set_multiline(textbox,true);
    compo_setid(textbox,COMPO_ID_PIC_PROMPT);
    compo_textbox_set_visible(textbox,false);
...
static void func_breathe_run_message(size_msg_t msg)
{
    switch (msg)
    {
        ...
        case MSG_CTP_SHORT_RIGHT:
            func_switch_to(FUNC_BREATHE, FUNC_SWITCH_LR_ZOOM_RIGHT);
            break;
        default:
            func_message(msg);
            break;
