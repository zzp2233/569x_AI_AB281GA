...
compo_form_t *func_breathe_finish_form_create(void)
{
    ...
    //设置图片
    compo_picturebox_t * picbox = compo_picturebox_create(frm, UI_BUF_I341001_19_BREATHING_TRAINING_HEART_BIN);
    ...
    compo_textbox_set(textbox,i18n[STR_HEART_RATE]);
    compo_textbox_set_forecolor(textbox,make_color(0xf9,0x1d,0x3d));
    ...
    compo_textbox_set_align_center(textbox,false);
    compo_textbox_set_pos(textbox,110,110);
    compo_textbox_set(textbox,txt_buf);
    ...
    //设置图片
    picbox = compo_picturebox_create(frm, UI_BUF_I341001_19_BREATHING_TRAINING_TIME_BIN);
    ...
    compo_textbox_set(textbox,i18n[STR_BREATHE_TIME]);
    compo_textbox_set_forecolor(textbox,make_color(0x14,0xaf,0xff));

    memset(txt_buf,0,sizeof(txt_buf));
    snprintf(txt_buf,sizeof(txt_buf),"%d",sys_cb.breathe_duration / 60000);
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_54_BIN);
    compo_textbox_set_align_center(textbox,false);
    compo_textbox_set_pos(textbox,110,255);
    compo_textbox_set(textbox,txt_buf);
    txt_wid = widget_text_get_area(textbox->txt);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_MINUTE]));
    compo_textbox_set_align_center(textbox,false);
    compo_textbox_set_location(textbox, txt_wid.wid+118, 265+23, 200, 40);
...
compo_form_t *func_breathe_finish_form_create(void)
{
    ...
    //设置图片
    compo_picturebox_t * picbox = compo_picturebox_create(frm, UI_BUF_I343001_19_BREATHING_TRAINING_TRAINING_TIME_BIN);
    compo_picturebox_set_pos(picbox,20+52/2, 88+52/2);

    compo_textbox_t *textbox = compo_textbox_create(frm, strlen(i18n[STR_HEART_RATE]));
    compo_textbox_set_align_center(textbox,false);
    compo_textbox_set_location(textbox, 95, 72, 200, 40);
    compo_textbox_set(textbox,i18n[STR_HEART_RATE]);
    compo_textbox_set_forecolor(textbox,make_color(150,150,150));
    ...
    compo_textbox_set_font(textbox,UI_BUF_0FONT_FONT_NUM_48_BIN);
    compo_textbox_set_align_center(textbox,false);
    compo_textbox_set_pos(textbox,96,108);
    compo_textbox_set(textbox,txt_buf);

    area_t txt_wid = widget_text_get_area(textbox->txt);
    textbox = compo_textbox_create(frm, strlen(i18n[STR_PER_MINUTE]));
    compo_textbox_set_align_center(textbox,false);
    compo_textbox_set_location(textbox, txt_wid.wid+96+10, 124, 200, 40);
    compo_textbox_set(textbox,i18n[STR_PER_MINUTE]);

    //设置图片
    picbox = compo_picturebox_create(frm, UI_BUF_I343001_19_BREATHING_TRAINING_HEART_BIN);
    compo_picturebox_set_pos(picbox,20+52/2,207+52/2);

    textbox = compo_textbox_create(frm, strlen(i18n[STR_BREATHE_TIME]));
    compo_textbox_set_align_center(textbox,false);
    compo_textbox_set_location(textbox, 95, 198, 200, 40);
    compo_textbox_set(textbox,i18n[STR_BREATHE_TIME]);
    compo_textbox_set_forecolor(textbox,make_color(150,150,150));
    ...
    textbox = compo_textbox_create(frm, strlen(txt_buf));
    compo_textbox_set_align_center(textbox,false);
    compo_textbox_set_location(textbox, 96, 231, 200, 40);
    compo_textbox_set(textbox,txt_buf);
    ...
    compo_shape_t *shape = compo_shape_create(frm, COMPO_SHAPE_TYPE_RECTANGLE);
    compo_shape_set_location(shape, GUI_SCREEN_CENTER_X, 173, 278, 1);
    compo_shape_set_color(shape,make_color(47,47,47));
