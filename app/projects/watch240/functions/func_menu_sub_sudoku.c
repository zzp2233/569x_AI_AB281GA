...
#endif // UTE_MODULE_SCREENS_ALARM_SUPPORT
// #if UTE_MODULE_SCREENS_HEARTRATE_SUPPORT
    {.func_sta=FUNC_HEARTRATE,                .res_addr=UI_BUF_I335001_2_HONEYCOMB_MOOD_BIN,                  },  //情绪
// #endif // UTE_MODULE_SCREENS_HEARTRATE_SUPPORT
#if UTE_MODULE_SCREENS_BREATHE_SUPPORT
...
// #endif // UTE_MODULE_SCREENS_HEARTRATE_SUPPORT
#if UTE_MODULE_SCREENS_STOPWATCH_SUPPORT
    // {.func_sta=STR_STOP_WATCH,                .res_addr=UI_BUF_I335001_2_HONEYCOMB_STOPWATCH_BIN,             },    //秒表
#endif // UTE_MODULE_SCREENS_STOPWATCH_SUPPORT
#if UTE_MODULE_SCREENS_TIMER_SUPPORT
    // {.func_sta=STR_TIMER,                     .res_addr=UI_BUF_I335001_2_HONEYCOMB_TIMER_BIN,                 },    //定时器
#endif // UTE_MODULE_SCREENS_TIMER_SUPPORT
    // {.func_sta=STR_FIND_PHONE,                .res_addr=UI_BUF_I335001_2_HONEYCOMB_FIND_PHONE_BIN,            },    //查找手机
    // {.func_sta=STR_FLASHLIGHT,                .res_addr=UI_BUF_I335001_2_HONEYCOMB_FLASHLIGHT_BIN,            },    //手电筒
#if UTE_MODULE_SCREENS_CAMERA_SUPPORT
    // {.func_sta=STR_CAMERA,                    .res_addr=UI_BUF_I335001_2_HONEYCOMB_REMOTE_CAMERA_BIN,         },    //相机
#endif // UTE_MODULE_SCREENS_CAMERA_SUPPORT
#if UTE_MODULE_SCREENS_CALCULATOR_SUPPORT
    // {.func_sta=STR_CALCULATOR,               .res_addr=UI_BUF_I335001_2_HONEYCOMB_CALCULATOR_BIN,             },    //计算器
#endif // UTE_MODULE_SCREENS_CALCULATOR_SUPPORT
};
...
#endif // UTE_MODULE_SCREENS_HEARTRATE_SUPPORT
// #if UTE_MODULE_SCREENS_HEARTRATE_SUPPORT
    {.func_sta=FUNC_HEARTRATE,                .res_addr=UI_BUF_I338001_2_HONEYCOMB_STRESS_BIN,                },   //压力
// #endif // UTE_MODULE_SCREENS_HEARTRATE_SUPPORT
#if UTE_MODULE_SCREENS_SPORT_SUPPORT
...
#endif // UTE_MODULE_SCREENS_ALARM_SUPPORT
// #if UTE_MODULE_SCREENS_HEARTRATE_SUPPORT
    {.func_sta=FUNC_HEARTRATE,                .res_addr=UI_BUF_I338001_2_HONEYCOMB_MOOD_BIN,                  },  //情绪
// #endif // UTE_MODULE_SCREENS_HEARTRATE_SUPPORT
#if UTE_MODULE_SCREENS_BREATHE_SUPPORT
...
#endif // UTE_MODULE_SCREENS_VOICE_SUPPORT
// #if UTE_MODULE_SCREENS_VOICE_SUPPORT
    // {.func_sta=FUNC_VOICE,                    .res_addr=UI_BUF_I338001_2_HONEYCOMB_SOS_BIN,                   },  //SOS
// #endif // UTE_MODULE_SCREENS_VOICE_SUPPORT
#if UTE_MODULE_SCREENS_GAME_SUPPORT
    // {.func_sta=FUNC_GAME,                     .res_addr=UI_BUF_I338001_2_HONEYCOMB_GAME_BIN,                  }, //游戏
#endif // UTE_MODULE_SCREENS_GAME_SUPPORT
// #if UTE_MODULE_SCREENS_VOICE_SUPPORT
...
// #endif // UTE_MODULE_SCREENS_HEARTRATE_SUPPORT
#if UTE_MODULE_SCREENS_STOPWATCH_SUPPORT
    // {.func_sta=STR_STOP_WATCH,                .res_addr=UI_BUF_I338001_2_HONEYCOMB_STOPWATCH_BIN,             },    //秒表
#endif // UTE_MODULE_SCREENS_STOPWATCH_SUPPORT
#if UTE_MODULE_SCREENS_TIMER_SUPPORT
    // {.func_sta=STR_TIMER,                     .res_addr=UI_BUF_I338001_2_HONEYCOMB_TIMER_BIN,                 },    //定时器
#endif // UTE_MODULE_SCREENS_TIMER_SUPPORT
    // {.func_sta=STR_FIND_PHONE,                .res_addr=UI_BUF_I338001_2_HONEYCOMB_FIND_PHONE_BIN,            },    //查找手机
    // {.func_sta=STR_FLASHLIGHT,                .res_addr=UI_BUF_I338001_2_HONEYCOMB_FLASHLIGHT_BIN,            },    //手电筒
#if UTE_MODULE_SCREENS_CAMERA_SUPPORT
    // {.func_sta=STR_CAMERA,                    .res_addr=UI_BUF_I338001_2_HONEYCOMB_REMOTE_CAMERA_BIN,         },    //相机
#endif // UTE_MODULE_SCREENS_CAMERA_SUPPORT
#if UTE_MODULE_SCREENS_CALCULATOR_SUPPORT
    // {.func_sta=STR_CALCULATOR,               .res_addr=UI_BUF_I338001_2_HONEYCOMB_CALCULATOR_BIN,             },    //计算器
#endif // UTE_MODULE_SCREENS_CALCULATOR_SUPPORT
};
#else
//瀑布流图标列表及顺序
