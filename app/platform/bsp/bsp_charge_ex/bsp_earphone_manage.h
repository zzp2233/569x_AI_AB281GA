...
#define bsp_earphone_is_charge(x)       (earphone.inbox[x] && (sys_cb.bat_low == false))                                        //左/右耳机是否在充电
...
#define bsp_earphone_vbat_is_full(x)    (earphone.charge_sta[x] == 2)                                                       //耳机电池满电
#define bsp_earphone_vbat_var_clr(x)    {earphone.charge_sta[x] = 0;}                                                       //耳机电池状态清除
