...
#define UTE_SW_VERSION "AB281EV000045"
...
#define UTE_MODULE_WATCHS_SORT_ADDRESS_ARRAYS { UI_BUF_DIALPLATE_BUTTERFLY_BIN,\
...
#define SCREEN_TITLE_MULTIPLE_ENGLISH_LANGUAGE_SUPPORT              0 //英文 2
