...
static const timer_txt_item_t tbl_timer_txt_item[] =
{
    {"01",      COMPO_ID_BTN_1MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74,       UI_BUF_I335001_27_MORE_3_TIMER_OUTPUT_1_TIMER_ICON_PIC92X92_X16_132_Y60_172_284_396_00_BIN},
    {"02",      COMPO_ID_BTN_2MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74,       UI_BUF_I335001_27_MORE_3_TIMER_OUTPUT_1_TIMER_ICON_PIC92X92_X16_132_Y60_172_284_396_00_BIN},
    {"03",      COMPO_ID_BTN_3MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*2+CONTROL_LENGTH,       UI_BUF_I335001_27_MORE_3_TIMER_OUTPUT_1_TIMER_ICON_PIC92X92_X16_132_Y60_172_284_396_00_BIN},
    {"05",      COMPO_ID_BTN_5MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*2+CONTROL_LENGTH,       UI_BUF_I335001_27_MORE_3_TIMER_OUTPUT_1_TIMER_ICON_PIC92X92_X16_132_Y60_172_284_396_00_BIN},
    {"10",      COMPO_ID_BTN_10MIN, GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*3+CONTROL_LENGTH*2,       UI_BUF_I335001_27_MORE_3_TIMER_OUTPUT_1_TIMER_ICON_PIC92X92_X16_132_Y60_172_284_396_00_BIN},
    {"30",      COMPO_ID_BTN_30MIN, GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*3+CONTROL_LENGTH*2,       UI_BUF_I335001_27_MORE_3_TIMER_OUTPUT_1_TIMER_ICON_PIC92X92_X16_132_Y60_172_284_396_00_BIN},
};
...
static compo_form_t *func_timer_form_create_by_type(u8 page_type)
{
    ...
    switch (page_type)
    {
        case TIMER_PAGE_SELECT:
        {
            ...
            btn = compo_button_create_page_by_image(frm, page, UI_BUF_I335001_27_MORE_3_TIMER_OUTPUT_1_TIMER_ICON_ADD_208X52_X16_Y512_BIN);
            compo_setid(btn, COMPO_ID_BTN_CUSTOM);
            compo_button_set_pos(btn, GUI_SCREEN_CENTER_X, GUI_SCREEN_HEIGHT/2.74*4+CONTROL_LENGTH);
...
#define PAGE_LOCATION_LAST            -403-34
#define PAGE_HEIGHT                   700
#define CONTROL_LENGTH                20
#define TIME_SET_TXT_SPACING          82
#define TIME_SET_TXT_SPACING_SHIFT    20
void timer_100ms_pro(co_timer_t *timer, void *param);
//显示页面
enum
{
    TIMER_PAGE_SELECT,
...
enum
{
    ...
    COMPO_ID_BTN_2MIN   = 2,
    COMPO_ID_BTN_3MIN   = 5,
    COMPO_ID_BTN_5MIN   = 10,
    COMPO_ID_BTN_10MIN  = 15,
    COMPO_ID_BTN_30MIN  = 30,
    COMPO_ID_BTN_60MIN  = 60,
    COMPO_ID_BTN_CUSTOM,
...
static const timer_txt_item_t tbl_timer_txt_item[] =
{
    {"1",       COMPO_ID_BTN_1MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.76,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
    {"2",       COMPO_ID_BTN_2MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.76,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
    {"5",       COMPO_ID_BTN_3MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.76*2+CONTROL_LENGTH,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
    {"10",      COMPO_ID_BTN_5MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.76*2+CONTROL_LENGTH,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
    {"15",      COMPO_ID_BTN_10MIN, GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.76*3+CONTROL_LENGTH*2,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
    {"30",      COMPO_ID_BTN_30MIN, GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.76*3+CONTROL_LENGTH*2,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
    {"60",      COMPO_ID_BTN_60MIN, GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.76*4+CONTROL_LENGTH*3,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
    {" ",       COMPO_ID_BTN_CUSTOM,GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.76*4+CONTROL_LENGTH*3,       UI_BUF_I341001_27_MORE_TIMER_BG1_BIN},
};
...
static const timer_btn_item_t tbl_timer_btn_item[] =
{
    {"58",         COMPO_ID_SEC_1,      294,                         GUI_SCREEN_CENTER_Y-TIME_SET_TXT_SPACING*2},
    {"59",         COMPO_ID_SEC_2,      294,                         GUI_SCREEN_CENTER_Y-TIME_SET_TXT_SPACING},
    {"00",         COMPO_ID_SEC_3,      294,                         GUI_SCREEN_CENTER_Y},
    {"01",         COMPO_ID_SEC_4,      294,                         GUI_SCREEN_CENTER_Y+TIME_SET_TXT_SPACING},
    {"02",         COMPO_ID_SEC_5,      294,                         GUI_SCREEN_CENTER_Y+TIME_SET_TXT_SPACING*2},
    ...
    {"22",         COMPO_ID_HOUR_1,      60,                         GUI_SCREEN_CENTER_Y-TIME_SET_TXT_SPACING*2},
    {"23",         COMPO_ID_HOUR_2,      60,                         GUI_SCREEN_CENTER_Y-TIME_SET_TXT_SPACING},
    {"00",         COMPO_ID_HOUR_3,      60,                         GUI_SCREEN_CENTER_Y},
    {"01",         COMPO_ID_HOUR_4,      60,                         GUI_SCREEN_CENTER_Y+TIME_SET_TXT_SPACING},
    {"02",         COMPO_ID_HOUR_5,      60,                         GUI_SCREEN_CENTER_Y+TIME_SET_TXT_SPACING*2},
};
...
{
    f_timer_t *f_timer = (f_timer_t*)func_cb.f_cb;
    char time_setting[5]= {(f_timer->sec-2+60)%60,(f_timer->sec-1+60)%60,f_timer->sec,(f_timer->sec+1+60)%60,(f_timer->sec+2+60)%60};
    char time_setting_min[5]= {(f_timer->min-2+60)%60,(f_timer->min-1+60)%60,f_timer->min,(f_timer->min+1+60)%60,(f_timer->min+2+60)%60};
    char time_setting_hour[5]= {(f_timer->hour-2+24)%24,(f_timer->hour-1+24)%24,f_timer->hour,(f_timer->hour+1+24)%24,(f_timer->hour+2+24)%24};
//    char time_setting[5]= {58,59,0,01,02};
//    char time_setting_hour[5]= {22,23,0,01,02};
    ...
    {
        f_timer->sec_buf[i]=time_setting[i];
        f_timer->min_buf[i]=time_setting_min[i];
        f_timer->hour_buf[i]=time_setting_hour[i];
    }
}
//创建定时器窗体，文件内调用
co_timer_t timer_timer;
static compo_form_t *func_timer_form_create_by_type(u8 page_type)
{
    u8 hour, min, sec;
    u32 res_addr;
    ...
    switch (page_type)
    {
        case TIMER_PAGE_SELECT:
        {
            ...
            for (u8 idx = 0; idx < TIMER_TXT_ITEM_CNT; idx++)
            {
                ...
                {
                    txt = compo_textbox_create_for_page(frm, page, strlen(i18n[STR_CUSTOM]));
                    compo_textbox_set_location(txt, tbl_timer_txt_item[idx].x, tbl_timer_txt_item[idx].y, 98, 80);
                    compo_textbox_set(txt, i18n[STR_CUSTOM]);
                    break;
                }

                txt = compo_textbox_create_for_page(frm, page, strlen(tbl_timer_txt_item[idx].text));
                compo_textbox_set_pos(txt, tbl_timer_txt_item[idx].x-4, tbl_timer_txt_item[idx].y-20);
                compo_textbox_set_font(txt, UI_BUF_0FONT_FONT_NUM_48_BIN);
                compo_textbox_set(txt, tbl_timer_txt_item[idx].text);

                const char *substr = i18n[STR_MIN_JOINT] + 2;
        ...
        case TIMER_PAGE_CUSTOM:
            ...
            compo_textbox_set(textbox,":");
            compo_textbox_set_pos(textbox,GUI_SCREEN_CENTER_X+60,GUI_SCREEN_CENTER_Y-TIME_SET_TXT_SPACING/2+20 );
            ...
            for(int i=0; i<TIMER_BTN_ITEM_CNT; i++)
            {
                txt = compo_textbox_create(frm, 2);
                compo_textbox_set_font(txt, UI_BUF_0FONT_FONT_NUM_48_BIN);
                if (tbl_timer_btn_item[i].y < GUI_SCREEN_CENTER_Y-TIME_SET_TXT_SPACING_SHIFT || tbl_timer_btn_item[i].y > GUI_SCREEN_CENTER_Y+TIME_SET_TXT_SPACING_SHIFT)
                    compo_textbox_set_forecolor(txt, COLOR_GRAY);
                {
                    memset(str_buff, 0, sizeof(str_buff));
                    if (i < 5)
                    {
                        snprintf(str_buff, sizeof(str_buff), "%02d", f_timer->sec_buf[i]);
                        compo_textbox_set(txt, str_buff);
                    }
                    else if (i < 10)
                    {
                        snprintf(str_buff, sizeof(str_buff), "%02d", f_timer->min_buf[i-5]);
                        compo_textbox_set(txt, str_buff);
                    }
                    else
                    {
                        snprintf(str_buff, sizeof(str_buff), "%02d", f_timer->hour_buf[i-10]);
                        compo_textbox_set(txt, str_buff);
                    }
                }
//              else
//                  compo_textbox_set(txt, tbl_timer_btn_item[i].text);
            ...
            btn = compo_button_create(frm);
            compo_button_set_location(btn,tbl_timer_btn_item[2].x,tbl_timer_btn_item[2].y -TIME_SET_TXT_SPACING_SHIFT,80,232);
            compo_setid(btn,COMPO_ID_SEC_IMG_BTN);

            btn = compo_button_create(frm);
            compo_button_set_location(btn,tbl_timer_btn_item[7].x,tbl_timer_btn_item[7].y -TIME_SET_TXT_SPACING_SHIFT,80,232);
            compo_setid(btn,COMPO_ID_MIN_IMG_BTN);

            btn = compo_button_create(frm);
            compo_button_set_location(btn,tbl_timer_btn_item[12].x,tbl_timer_btn_item[12].y -TIME_SET_TXT_SPACING_SHIFT,80,232);
            compo_setid(btn,COMPO_ID_HOUR_IMG_BTN);

            compo_shape_t *shape = compo_shape_create(frm, COMPO_SHAPE_TYPE_RECTANGLE);
            compo_shape_set_location(shape, GUI_SCREEN_CENTER_X,tbl_timer_btn_item[0].y-TIME_SET_TXT_SPACING_SHIFT,GUI_SCREEN_WIDTH,100);
            compo_shape_set_color(shape, COLOR_BLACK);

            shape = compo_shape_create(frm, COMPO_SHAPE_TYPE_RECTANGLE);
            compo_shape_set_location(shape, GUI_SCREEN_CENTER_X,tbl_timer_btn_item[4].y+32-TIME_SET_TXT_SPACING_SHIFT,GUI_SCREEN_WIDTH,160);
            compo_shape_set_color(shape, COLOR_BLACK);

            btn = compo_button_create_by_image(frm, UI_BUF_I341001_27_MORE_TIMER_START_BIN);
            compo_setid(btn,COMPO_ID_BTN_OK);
            compo_button_set_pos(btn,GUI_SCREEN_CENTER_X,GUI_SCREEN_HEIGHT-gui_image_get_size(UI_BUF_I341001_27_MORE_TIMER_START_BIN).hei/2-20);

            break;

        case TIMER_PAGE_COUNTDOWN:
            if(sys_cb.timer_sta == TIMER_STA_WORKING && mini_comp_timer_start)
            {
                mini_comp_timer_start = false;
                co_timer_set(&timer_timer, 100, TIMER_REPEAT, LEVEL_LOW_PRI, timer_100ms_pro, 0);
            }
            compo_form_set_mode(frm, COMPO_FORM_MODE_SHOW_TITLE | COMPO_FORM_MODE_SHOW_TIME);
            compo_form_set_title(frm, i18n[STR_TIMER]);
            //新建按钮
            res_addr = sys_cb.timer_sta == TIMER_STA_WORKING ? UI_BUF_I341001_27_MORE_TIMER_STOP_BIN : UI_BUF_I341001_27_MORE_TIMER_START2_BIN;
            btn = compo_button_create_by_image(frm, res_addr); //pause //start//again
            compo_setid(btn, COMPO_ID_BTN_START);
            compo_button_set_pos(btn, 188+156/2, 347+80/2);

            btn = compo_button_create_by_image(frm, UI_BUF_I341001_27_MORE_TIMER_CANCEL_BIN);  //close
            compo_setid(btn, COMPO_ID_BTN_NO);
            ...
            compo_setid(txt, COMPO_ID_NUM_COUNTDOWN);
            compo_textbox_set_align_center(txt, false);     //左对齐显示
            compo_textbox_set_pos(txt, GUI_SCREEN_CENTER_X/2, 168 + 20);
        ...
        case TIMER_PAGE_CUSTOM:
            switch (id)
            {
                case COMPO_ID_BTN_OK:
                    ...
                    sys_cb.timer_left_sec = sys_cb.timer_total_sec = sys_cb.timer_custom_sec = f_timer->hour * 3600 + f_timer->min * 60 + f_timer->sec;
                    if (sys_cb.timer_left_sec == 0) break;
                    sys_cb.timer_start_rtc = compo_cb.rtc_cnt;
                    rtccnt_tmp = 0;
                    count_100ms = 0;
                    co_timer_set(&timer_timer, 100, TIMER_REPEAT, LEVEL_LOW_PRI, timer_100ms_pro, &count_100ms);
        ...
        case TIMER_PAGE_COUNTDOWN:
            switch (id)
            {
                case COMPO_ID_BTN_START:
                    ...
                    compo_button_t *btn = compo_getobj_byid(COMPO_ID_BTN_START);
                    u32 res_addr = sys_cb.timer_sta == TIMER_STA_WORKING ? UI_BUF_I341001_27_MORE_TIMER_STOP_BIN : UI_BUF_I341001_27_MORE_TIMER_START2_BIN;
                    compo_button_set_bgimg(btn,res_addr);
                    break;
...
#define PAGE_LOCATION_LAST            -303-34
#define PAGE_HEIGHT                   700
#define CONTROL_LENGTH                20
#define TIME_SET_TXT_SPACING          72
#define TIME_SET_TXT_SPACING_SHIFT    20
//显示页面
enum
{
...
static const timer_txt_item_t tbl_timer_txt_item[] =
{
    {"1",       COMPO_ID_BTN_1MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74,       UI_BUF_I343001_27_MORE_TIMEPIECE_BG1_BIN},
    {"2",       COMPO_ID_BTN_2MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74,       UI_BUF_I343001_27_MORE_TIMEPIECE_BG1_BIN},
    {"3",       COMPO_ID_BTN_3MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*2+CONTROL_LENGTH,       UI_BUF_I343001_27_MORE_TIMEPIECE_BG1_BIN},
    {"5",       COMPO_ID_BTN_5MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*2+CONTROL_LENGTH,       UI_BUF_I343001_27_MORE_TIMEPIECE_BG1_BIN},
    {"10",      COMPO_ID_BTN_10MIN, GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*3+CONTROL_LENGTH*2,       UI_BUF_I343001_27_MORE_TIMEPIECE_BG1_BIN},
    {"30",      COMPO_ID_BTN_30MIN, GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*3+CONTROL_LENGTH*2,       UI_BUF_I343001_27_MORE_TIMEPIECE_BG1_BIN},
};
...
static const timer_btn_item_t tbl_timer_btn_item[] =
{
    {"58",         COMPO_ID_SEC_1,      274,                         GUI_SCREEN_CENTER_Y-TIME_SET_TXT_SPACING*2},
    {"59",         COMPO_ID_SEC_2,      274,                         GUI_SCREEN_CENTER_Y-TIME_SET_TXT_SPACING},
    {"00",         COMPO_ID_SEC_3,      274,                         GUI_SCREEN_CENTER_Y},
    {"01",         COMPO_ID_SEC_4,      274,                         GUI_SCREEN_CENTER_Y+TIME_SET_TXT_SPACING},
    {"02",         COMPO_ID_SEC_5,      274,                         GUI_SCREEN_CENTER_Y+TIME_SET_TXT_SPACING*2},
    ...
    {"22",         COMPO_ID_HOUR_1,      40,                         GUI_SCREEN_CENTER_Y-TIME_SET_TXT_SPACING*2},
    {"23",         COMPO_ID_HOUR_2,      40,                         GUI_SCREEN_CENTER_Y-TIME_SET_TXT_SPACING},
    {"00",         COMPO_ID_HOUR_3,      40,                         GUI_SCREEN_CENTER_Y},
    {"01",         COMPO_ID_HOUR_4,      40,                         GUI_SCREEN_CENTER_Y+TIME_SET_TXT_SPACING},
    {"02",         COMPO_ID_HOUR_5,      40,                         GUI_SCREEN_CENTER_Y+TIME_SET_TXT_SPACING*2},
};
...
static compo_form_t *func_timer_form_create_by_type(u8 page_type)
{
    ...
    switch (page_type)
    {
        case TIMER_PAGE_SELECT:
        {
            ...
            btn = compo_button_create_page_by_image(frm, page, UI_BUF_I343001_27_MORE_TIMEPIECE_ADD_BIN);
            compo_setid(btn, COMPO_ID_BTN_CUSTOM);
            compo_button_set_pos(btn, GUI_SCREEN_CENTER_X, GUI_SCREEN_HEIGHT/2.74*4+CONTROL_LENGTH);
        ...
        case TIMER_PAGE_CUSTOM:
            ...
            btn = compo_button_create_by_image(frm, UI_BUF_I343001_27_MORE_TIMEPIECE_START_BIN);
            compo_setid(btn,COMPO_ID_BTN_OK);
            compo_button_set_pos(btn,GUI_SCREEN_CENTER_X,GUI_SCREEN_HEIGHT-gui_image_get_size(UI_BUF_I343001_27_MORE_TIMEPIECE_START_BIN).hei/2-20);
        ...
        case TIMER_PAGE_COUNTDOWN:
            ...
            compo_form_set_title(frm, i18n[STR_TIMER]);
            //新建按钮
            res_addr = sys_cb.timer_sta == TIMER_STA_WORKING ? UI_BUF_I343001_27_MORE_TIMEPIECE_STOP_BIN : UI_BUF_I343001_27_MORE_TIMEPIECE_START2_BIN;
            btn = compo_button_create_by_image(frm, res_addr); //pause //start//again
            compo_setid(btn, COMPO_ID_BTN_START);
            compo_button_set_pos(btn, GUI_SCREEN_WIDTH*3/4-5, GUI_SCREEN_HEIGHT - 40 - 20);

            btn = compo_button_create_by_image(frm, UI_BUF_I343001_COMM_CANCEL_BIN);  //close
            compo_setid(btn, COMPO_ID_BTN_NO);
            compo_button_set_pos(btn, GUI_SCREEN_WIDTH/4+5, GUI_SCREEN_HEIGHT - 40 - 20);
            //新建数字
            hour = SEC_TO_HOUR(sys_cb.timer_left_sec);
            min = SEC_TO_MIN(sys_cb.timer_left_sec);
            sec = SEC_TO_SEC(sys_cb.timer_left_sec);
            txt = compo_textbox_create(frm, 12);
            compo_setid(txt, COMPO_ID_NUM_COUNTDOWN);
            compo_textbox_set_align_center(txt, true);     //左对齐显示
            compo_textbox_set_pos(txt, GUI_SCREEN_CENTER_X, 168);
        ...
        case TIMER_PAGE_COUNTDOWN:
            switch (id)
            {
                case COMPO_ID_BTN_START:
                    ...
                    compo_button_t *btn = compo_getobj_byid(COMPO_ID_BTN_START);
                    u32 res_addr = sys_cb.timer_sta == TIMER_STA_WORKING ? UI_BUF_I343001_27_MORE_TIMEPIECE_STOP_BIN : UI_BUF_I343001_27_MORE_TIMEPIECE_START2_BIN;
                    compo_button_set_bgimg(btn,res_addr);
                    break;
...
enum
{
    ...
    COMPO_ID_BTN_5MIN   = 5,
    COMPO_ID_BTN_10MIN  = 10,
    COMPO_ID_BTN_15MIN  = 15,
    COMPO_ID_BTN_20MIN  = 20,
    COMPO_ID_BTN_30MIN  = 30,
    COMPO_ID_BTN_60MIN  = 60,
    COMPO_ID_BTN_CUSTOM,
...
static const timer_txt_item_t tbl_timer_txt_item[] =
{
    {"1",       COMPO_ID_BTN_1MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   160,       UI_BUF_I338001_TIMEPIECE_BG1_BIN},
    {"2",       COMPO_ID_BTN_2MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   160,       UI_BUF_I338001_TIMEPIECE_BG1_BIN},
    {"5",       COMPO_ID_BTN_5MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   160+140*1+CONTROL_LENGTH,       UI_BUF_I338001_TIMEPIECE_BG1_BIN},
    {"10",      COMPO_ID_BTN_10MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   160+140*1+CONTROL_LENGTH,       UI_BUF_I338001_TIMEPIECE_BG1_BIN},
    {"15",      COMPO_ID_BTN_15MIN, GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   160+140*2+CONTROL_LENGTH*2,       UI_BUF_I338001_TIMEPIECE_BG1_BIN},
    {"20",      COMPO_ID_BTN_20MIN, GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   160+140*2+CONTROL_LENGTH*2,       UI_BUF_I338001_TIMEPIECE_BG1_BIN},
    {"30",      COMPO_ID_BTN_30MIN, GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   160+140*3+CONTROL_LENGTH*3,       UI_BUF_I338001_TIMEPIECE_BG1_BIN},
    {"60",      COMPO_ID_BTN_60MIN, GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   160+140*3+CONTROL_LENGTH*3,       UI_BUF_I338001_TIMEPIECE_BG1_BIN},
};
...
//            widget_page_t* page = frm->page_body;//frm_main->page_body;
            ...
            for (u8 idx = 0; idx < TIMER_TXT_ITEM_CNT; idx++)
            {
                ...
                txt = compo_textbox_create_for_page(frm, page, strlen(i18n[STR_MIN]));
                compo_textbox_set_location(txt,tbl_timer_txt_item[idx].x,tbl_timer_txt_item[idx].y-TIME_SET_TXT_SPACING_SHIFT+35,60,35);
                compo_textbox_set(txt,i18n[STR_MIN]);

            }
            btn = compo_button_create_page_by_image(frm, page, UI_BUF_I338001_TIMEPIECE_ADD_172X64_BIN);
            compo_setid(btn, COMPO_ID_BTN_CUSTOM);
            compo_button_set_pos(btn, GUI_SCREEN_CENTER_X, 582+64/2+160);
        ...
        case TIMER_PAGE_CUSTOM:
            ...
            compo_textbox_set_pos(txt, 125,tbl_timer_btn_item[2].y-TIME_SET_TXT_SPACING_SHIFT);
            compo_textbox_set(txt,":");

            txt = compo_textbox_create(frm, 1);
            compo_textbox_set_pos(txt, 235,tbl_timer_btn_item[2].y-TIME_SET_TXT_SPACING_SHIFT);
            compo_textbox_set(txt,":");
            ...
            compo_button_set_location(btn,tbl_timer_btn_item[2].x,tbl_timer_btn_item[2].y -TIME_SET_TXT_SPACING_SHIFT,70,158);
            compo_setid(btn,COMPO_ID_SEC_IMG_BTN);

            btn = compo_button_create_by_image(frm, 0);
            compo_button_set_location(btn,tbl_timer_btn_item[7].x,tbl_timer_btn_item[7].y -TIME_SET_TXT_SPACING_SHIFT,70,158);
            compo_setid(btn,COMPO_ID_MIN_IMG_BTN);

            btn = compo_button_create_by_image(frm, 0);
            compo_button_set_location(btn,tbl_timer_btn_item[12].x,tbl_timer_btn_item[12].y -TIME_SET_TXT_SPACING_SHIFT,70,158);
            compo_setid(btn,COMPO_ID_HOUR_IMG_BTN);

            compo_shape_t *shape = compo_shape_create(frm, COMPO_SHAPE_TYPE_RECTANGLE);
            compo_shape_set_location(shape, GUI_SCREEN_CENTER_X,tbl_timer_btn_item[0].y-TIME_SET_TXT_SPACING_SHIFT-14,GUI_SCREEN_WIDTH,62);
            compo_shape_set_color(shape, COLOR_BLACK);

            shape = compo_shape_create(frm, COMPO_SHAPE_TYPE_RECTANGLE);
            compo_shape_set_location(shape, GUI_SCREEN_CENTER_X,tbl_timer_btn_item[4].y+21-TIME_SET_TXT_SPACING_SHIFT+14,GUI_SCREEN_WIDTH,104);
            compo_shape_set_color(shape, COLOR_BLACK);

            btn = compo_button_create_by_image(frm, UI_BUF_I338001_TIMEPIECE_START_BIN);
            compo_setid(btn,COMPO_ID_BTN_OK);
            compo_button_set_pos(btn, GUI_SCREEN_CENTER_X, 266+64/2);
        ...
        case TIMER_PAGE_COUNTDOWN:
            //新建按钮
            res_addr = sys_cb.timer_sta == TIMER_STA_WORKING ? UI_BUF_I338001_TIMEPIECE_STOP_BIN : UI_BUF_I338001_TIMEPIECE_START_BIN;
            btn = compo_button_create_by_image(frm, res_addr); //start/pause/again
            compo_setid(btn, COMPO_ID_BTN_START);
            compo_button_set_pos(btn, 212+80/2, 234+80/2);
            btn = compo_button_create_by_image(frm, UI_BUF_I338001_20_ALARM_CLOCK_CANCEL_BIN);  //close
            compo_setid(btn, COMPO_ID_BTN_NO);
            compo_button_set_pos(btn, 68+80/2, 234+80/2);
            //新建数字
            hour = SEC_TO_HOUR(sys_cb.timer_left_sec);
    ...
    switch (f_timer->page_disp)
    {
        case TIMER_PAGE_SELECT:
            switch (id)
            {
                ...
                case COMPO_ID_BTN_5MIN :
                case COMPO_ID_BTN_10MIN:
                case COMPO_ID_BTN_15MIN:
                case COMPO_ID_BTN_20MIN:
                case COMPO_ID_BTN_30MIN:
                case COMPO_ID_BTN_60MIN:
                    sys_cb.timer_custom_sec = sys_cb.timer_left_sec = sys_cb.timer_total_sec = id * 60;
                    sys_cb.timer_sta = TIMER_STA_RESET;
...
static const timer_txt_item_t tbl_timer_txt_item[] =
{
    {"01:00",      COMPO_ID_BTN_1MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   160,       UI_BUF_I340001_TIMER_BG_BIN},
    {"02:00",      COMPO_ID_BTN_2MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   160,       UI_BUF_I340001_TIMER_BG_BIN},
    {"03:00",      COMPO_ID_BTN_3MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   160+140*1+CONTROL_LENGTH,       UI_BUF_I340001_TIMER_BG_BIN},
    {"05:00",      COMPO_ID_BTN_5MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   160+140*1+CONTROL_LENGTH,       UI_BUF_I340001_TIMER_BG_BIN},
    {"10:00",      COMPO_ID_BTN_10MIN, GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   160+140*2+CONTROL_LENGTH*2,       UI_BUF_I340001_TIMER_BG_BIN},
    {"30:00",      COMPO_ID_BTN_30MIN, GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   160+140*2+CONTROL_LENGTH*2,       UI_BUF_I340001_TIMER_BG_BIN},
};
...
//            widget_page_t* page = frm->page_body;//frm_main->page_body;
            ...
            btn = compo_button_create_page_by_image(frm, page, UI_BUF_I340001_PUBLIC_RECTANGLE02_BIN);
            compo_setid(btn, COMPO_ID_BTN_CUSTOM);
            compo_button_set_pos(btn, GUI_SCREEN_CENTER_X, 582+64/2);
        ...
        case TIMER_PAGE_CUSTOM:
            compo_form_set_mode(frm, COMPO_FORM_MODE_SHOW_TITLE | COMPO_FORM_MODE_SHOW_TIME);
            compo_form_set_title(frm, i18n[STR_CUSTOM]);
            compo_picturebox_t *picbox = compo_picturebox_create(frm, UI_BUF_I340001_PUBLIC_KUANG_COLON_BIN);
            compo_picturebox_set_pos(picbox, 125,tbl_timer_btn_item[2].y-TIME_SET_TXT_SPACING_SHIFT );
            picbox = compo_picturebox_create(frm, UI_BUF_I340001_PUBLIC_KUANG_COLON_BIN);
            compo_picturebox_set_pos(picbox, 235,tbl_timer_btn_item[2].y-TIME_SET_TXT_SPACING_SHIFT);
            ...
            btn = compo_button_create_by_image(frm, UI_BUF_I340001_PUBLIC_KUANG_GREY_SMALL_BIN);
            compo_button_set_pos(btn,tbl_timer_btn_item[2].x,tbl_timer_btn_item[2].y -TIME_SET_TXT_SPACING_SHIFT);
            compo_setid(btn,COMPO_ID_SEC_IMG_BTN);
            ...
            btn = compo_button_create_by_image(frm, UI_BUF_I340001_PUBLIC_RECTANGLE02_BIN);
            compo_setid(btn,COMPO_ID_BTN_OK);
            compo_button_set_pos(btn, GUI_SCREEN_CENTER_X, 266+64/2);
        ...
        case TIMER_PAGE_COUNTDOWN:
            //新建按钮
            res_addr = sys_cb.timer_sta == TIMER_STA_WORKING ? UI_BUF_I340001_PUBLIC_PAUSED_SMALL_BIN : (sys_cb.timer_sta == TIMER_STA_DONE ? UI_BUF_I340001_PUBLIC_RETRY_BIN : UI_BUF_I340001_PUBLIC_PLAY_SMALL_BIN);
            btn = compo_button_create_by_image(frm, res_addr); //start/pause/again
            compo_setid(btn, COMPO_ID_BTN_START);
            compo_button_set_pos(btn, 212+80/2, 234+80/2);
...
static void func_timer_button_touch_handle(void)
{
    ...
    switch (id)
    {
        case COMPO_ID_BTN_START:
            ...
            if (sys_cb.timer_sta == TIMER_STA_WORKING)
            {
                //    compo_button_set_bgimg(btn, UI_BUF_I340001_PUBLIC_PAUSED_BIN);
            }
            else if (sys_cb.timer_sta == TIMER_STA_DONE)
            {
                ;
...
static const timer_txt_item_t tbl_timer_txt_item[] =
{
    {"01",      COMPO_ID_BTN_1MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74,       UI_BUF_I342001_27_MORE_TIMEPIECE_BG_BIN},
    {"02",      COMPO_ID_BTN_2MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74,       UI_BUF_I342001_27_MORE_TIMEPIECE_BG_BIN},
    {"03",      COMPO_ID_BTN_3MIN,  GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*2+CONTROL_LENGTH,       UI_BUF_I342001_27_MORE_TIMEPIECE_BG_BIN},
    {"05",      COMPO_ID_BTN_5MIN,  GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*2+CONTROL_LENGTH,       UI_BUF_I342001_27_MORE_TIMEPIECE_BG_BIN},
    {"10",      COMPO_ID_BTN_10MIN, GUI_SCREEN_CENTER_X-GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*3+CONTROL_LENGTH*2,       UI_BUF_I342001_27_MORE_TIMEPIECE_BG_BIN},
    {"30",      COMPO_ID_BTN_30MIN, GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2,   GUI_SCREEN_HEIGHT/2.74*3+CONTROL_LENGTH*2,       UI_BUF_I342001_27_MORE_TIMEPIECE_BG_BIN},
};
...
static compo_form_t *func_timer_form_create_by_type(u8 page_type)
{
    ...
    switch (page_type)
    {
        case TIMER_PAGE_SELECT:
        {
            ...
            btn = compo_button_create_page_by_image(frm, page, UI_BUF_I342001_27_MORE_TIMEPIECE_ADD_BIN);
            compo_setid(btn, COMPO_ID_BTN_CUSTOM);
            compo_button_set_pos(btn, GUI_SCREEN_CENTER_X, GUI_SCREEN_HEIGHT/2.74*4+CONTROL_LENGTH);
        ...
        case TIMER_PAGE_CUSTOM:
            ...
            btn = compo_button_create_by_image(frm, UI_BUF_I342001_27_MORE_TIMEPIECE_START_BIN);
            compo_setid(btn,COMPO_ID_BTN_OK);
            compo_button_set_pos(btn,GUI_SCREEN_CENTER_X,GUI_SCREEN_HEIGHT-gui_image_get_size(UI_BUF_I342001_27_MORE_TIMEPIECE_START_BIN).hei/2-10);
        ...
        case TIMER_PAGE_COUNTDOWN:
            ...
            compo_form_set_title(frm, i18n[STR_TIMER]);
            //新建按钮
            res_addr = sys_cb.timer_sta == TIMER_STA_WORKING ? UI_BUF_I342001_27_MORE_TIMEPIECE_STOP_BIN : UI_BUF_I342001_27_MORE_TIMEPIECE_START_BIN;
            btn = compo_button_create_by_image(frm, res_addr); //pause //start//again
            compo_setid(btn, COMPO_ID_BTN_START);
            compo_button_set_pos(btn, 175, 163+54/2);

            btn = compo_button_create_by_image(frm, UI_BUF_I342001_27_MORE_TIMEPIECE_CANCEL_BIN);  //close
            compo_setid(btn, COMPO_ID_BTN_NO);
            compo_button_set_pos(btn, 63, 163+54/2);
            //新建数字
            hour = SEC_TO_HOUR(sys_cb.timer_left_sec);
            min = SEC_TO_MIN(sys_cb.timer_left_sec);
            sec = SEC_TO_SEC(sys_cb.timer_left_sec);
        ...
        case TIMER_PAGE_COUNTDOWN:
            switch (id)
            {
                case COMPO_ID_BTN_START:
                    ...
                    compo_button_t *btn = compo_getobj_byid(COMPO_ID_BTN_START);
                    u32 res_addr = sys_cb.timer_sta == TIMER_STA_WORKING ? UI_BUF_I342001_27_MORE_TIMEPIECE_STOP_BIN : UI_BUF_I342001_27_MORE_TIMEPIECE_START_BIN;
                    compo_button_set_bgimg(btn,res_addr);
                    break;
...
static void func_timer_process(void)
{
    ...
    switch (f_timer->page_disp)
    {
        ...
        case TIMER_PAGE_COUNTDOWN:
            ...
            if (sys_cb.timer_sta == TIMER_STA_DONE)
            {
                ...
                btn = compo_getobj_byid(COMPO_ID_BTN_START);
                compo_button_set_bgimg(btn, UI_BUF_I342001_27_MORE_TIMEPIECE_START_BIN);
    ...
    switch (f_timer->page_disp)
    {
        ...
        case TIMER_PAGE_COUNTDOWN:
            ...
            if (sys_cb.timer_sta == TIMER_STA_DONE)
            {
                ...
                btn = compo_getobj_byid(COMPO_ID_BTN_START);
                compo_button_set_bgimg(btn, UI_BUF_I341001_27_MORE_TIMER_START2_BIN);
            ...
            {
                btn = compo_getobj_byid(COMPO_ID_BTN_START);
                compo_button_set_bgimg(btn, UI_BUF_I341001_27_MORE_TIMER_STOP_BIN);
            }
            break;
        case TIMER_PAGE_SELECT:
            if(f_timer->touch_flag  == true)
    ...
    switch (f_timer->page_disp)
    {
        ...
        case TIMER_PAGE_COUNTDOWN:
            ...
            if (sys_cb.timer_sta == TIMER_STA_DONE)
            {
                ...
                btn = compo_getobj_byid(COMPO_ID_BTN_START);
                compo_button_set_bgimg(btn, UI_BUF_I343001_27_MORE_TIMEPIECE_START2_BIN);
    ...
    switch (f_timer->page_disp)
    {
        ...
        case TIMER_PAGE_COUNTDOWN:
            ...
            btn = compo_getobj_byid(COMPO_ID_BTN_START);
            compo_button_set_bgimg(btn, sys_cb.timer_sta == TIMER_STA_WORKING ? UI_BUF_I338001_TIMEPIECE_STOP_BIN : UI_BUF_I338001_TIMEPIECE_START_BIN);
            if (sys_cb.timer_sta == TIMER_STA_DONE)
            {
                sys_cb.timer_left_sec = sys_cb.timer_total_sec;
                hour = SEC_TO_HOUR(sys_cb.timer_left_sec);
                ...
                compo_button_set_bgimg(btn,UI_BUF_I338001_TIMEPIECE_AGAIN_BIN);
                txt_num = compo_getobj_byid(COMPO_ID_NUM_COUNTDOWN);
                snprintf(str_buff, sizeof(str_buff), "%02d:%02d:%02d", f_timer->hour, f_timer->min, f_timer->sec);
                compo_textbox_set(txt_num, str_buff);
            }
    ...
    switch (f_timer->page_disp)
    {
        ...
        case TIMER_PAGE_COUNTDOWN:
            ...
            if (sys_cb.timer_sta == TIMER_STA_DONE)
            {
                ...
                btn = compo_getobj_byid(COMPO_ID_BTN_START);
                compo_button_set_bgimg(btn, UI_BUF_I340001_PUBLIC_RETRY_BIN);
...
static void func_timer_message(size_msg_t msg)
{
                ...
                if(f_timer->touch_flag == false)
                {
                    switch(id)
                    {
                        case COMPO_ID_HOUR_IMG_BTN:
                            ...
                            compo_button_set_bgimg(btn_hour,UI_BUF_I340001_PUBLIC_KUANG_YELLOW_SMALL_BIN );
                            compo_button_set_bgimg(btn_min,UI_BUF_I340001_PUBLIC_KUANG_GREY_SMALL_BIN );
                            compo_button_set_bgimg(btn_sec, UI_BUF_I340001_PUBLIC_KUANG_GREY_SMALL_BIN);
                            f_timer->set_time_flag = 1;
                            break;
                        case COMPO_ID_MIN_IMG_BTN:
                            for(int i=0; i<5; i++)
                            ...
                            compo_button_set_bgimg(btn_min,UI_BUF_I340001_PUBLIC_KUANG_YELLOW_SMALL_BIN );
                            compo_button_set_bgimg(btn_sec,UI_BUF_I340001_PUBLIC_KUANG_GREY_SMALL_BIN );
                            f_timer->set_time_flag = 2;
                            break;
                        case COMPO_ID_SEC_IMG_BTN:
                            ...
                            compo_button_set_bgimg(btn_hour,UI_BUF_I340001_PUBLIC_KUANG_GREY_SMALL_BIN );
                            compo_button_set_bgimg(btn_min,UI_BUF_I340001_PUBLIC_KUANG_GREY_SMALL_BIN );
                            compo_button_set_bgimg(btn_sec,UI_BUF_I340001_PUBLIC_KUANG_YELLOW_SMALL_BIN );
                            f_timer->set_time_flag = 3;
                            break;
                    }
                }
    ...
    switch (msg)
    {
        ...
        case KU_BACK:
        case KU_DELAY_BACK:
            if (f_timer->page_disp == TIMER_PAGE_CUSTOM)
            {
                f_timer->touch_flag = false;
                func_timer_setting_date_init();
                f_timer->old_y = 0;
