...
enum
{
    ...
    FUNC_ALARM_CLOCK_SUB_LABEL,         //闹钟--标签
    ...
    FUNC_SPORT_SUB_SET,                 //运动设置
    FUNC_SPORT_SUB_SET_LIST,                 //运动设置列表
    FUNC_SPORT_HISTORY,                 //运动历史记录
...
//    FUNC_TIME_SUB_CUSTOM,               //调整日期
    ...
    FUNC_DISPLAY_TIME_PERIOD,
    FUNC_DISPLAY_SUB_SET,
#endif
    ...
    FUNC_CLOCK_SAVER,                   //息屏表盘
    FUNC_CLOCK_SAVER_PREVIEW,           //息屏表盘预览

    FUNC_CARD_SETTING,                  //卡片设置界面
    FUNC_SWITCH_MODE_ROTARY,            //一级卡片旋转切换

    FUNC_QUICK_CARD_SETTING,            //快捷卡片
    FUNC_MINI_COMPO_CARD,               //小组件卡片

    FUNC_TBL_SORT_CUBE,                 //快捷卡片魔方
...
typedef struct
{
    ...
    u8 mini_sort_cnt;                               //小组件任务个数
    u8 mini_tbl_sort[MAX_FUNC_MINI_SORT_CNT];       //小组件任务表
