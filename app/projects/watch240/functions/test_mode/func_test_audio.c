...
compo_form_t * func_audio_create(void)
{
    ...
    if(!bt_get_scan())
    {
        compo_textbox_set(textbox, "Bluetooth not connected");
        compo_textbox_set_forecolor(textbox, COLOR_RED);
    }
    else
    {
        compo_textbox_set(textbox, "Bluetooth connected");
    ...
    if(!bt_get_scan())
    {
        compo_textbox_set(textbox, "Bluetooth Close");
        compo_textbox_set_forecolor(textbox, TXT_COLOR);
    }
    else
    {
        compo_textbox_set(textbox, "Bluetooth Open");
        compo_textbox_set_forecolor(textbox, COLOR_GREEN);
    }
    ...
    compo_textbox_set(textbox, "Upstream close");
    compo_textbox_set_forecolor(textbox, TXT_COLOR);
    ...
    textbox = compo_textbox_create(frm, 4 );
    compo_textbox_set(textbox, "Downward close");
    compo_textbox_set_forecolor(textbox, TXT_COLOR);
    compo_textbox_set_pos(textbox, GUI_SCREEN_CENTER_X+GUI_SCREEN_CENTER_X/2, TXT_SPACING_Y*4);
    ...
    textbox = compo_textbox_create(frm, 4 );
    compo_textbox_set(textbox, "Exit test");
...
//    compo_textbox_t * textbox1 = compo_getobj_byid(BLUETOOTH_STATE_TXT_ID);
    ...
    switch(id)
    {
        case BLUETOOTH_SWITCH_BTN_ID:
            ...
            {
                compo_textbox_set(textbox2, "Bluetooth Open");
                compo_textbox_set_forecolor(textbox2, COLOR_GREEN);
            }
            else
            {
                compo_textbox_set(textbox2, "Bluetooth Close");
        ...
        case UP_SWITCH_BTN_ID:
            ...
            {
                compo_textbox_set(textbox3, "Upstream Open");
                compo_textbox_set_forecolor(textbox3, COLOR_GREEN);
            }
            else
            {
                compo_textbox_set(textbox3, "Upstream close");
        ...
        case DOWN_SWITCH_BTN_ID:
            ...
            {
                compo_textbox_set(textbox4, "Downward Oepn");
                compo_textbox_set_forecolor(textbox4, COLOR_GREEN);
            }
            else
            {
                compo_textbox_set(textbox4, "Downward close");
...
static void func_audio_process(void)
{
    ...
    if(!bt_is_connected())
    {
        compo_textbox_set(textbox1, "Bluetooth not connected");
        compo_textbox_set_forecolor(textbox1, COLOR_RED);
    }
    else
    {
        compo_textbox_set(textbox1, "Bluetooth connected");
        compo_textbox_set_forecolor(textbox1, COLOR_RED);
    }
