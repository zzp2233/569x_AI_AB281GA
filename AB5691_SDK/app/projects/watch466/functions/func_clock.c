...
#define BTF_Y_POS                   70                      //主体相对于屏幕中心Y的偏移
...
//#define DIALPLATE_BTF_IDX           ((sys_cb.dialplate_index == 2 || sys_cb.dialplate_index == 5 || sys_cb.dialplate_index == 8))
//#define DIALPLATE_CUBE_IDX          ((sys_cb.dialplate_index == 1 || sys_cb.dialplate_index == 4 || sys_cb.dialplate_index == 7))

const u32 dialplate_info[] =
{
    UI_BUF_DIALPLATE_1_BIN,     //0
    UI_BUF_DIALPLATE_CUBE_BIN,  //1
    UI_BUF_DIALPLATE_BTF_BIN,   //2
    UI_BUF_DIALPLATE_1_BIN,     //3
    UI_BUF_DIALPLATE_CUBE_BIN,  //4
    UI_BUF_DIALPLATE_BTF_BIN,   //5
    UI_BUF_DIALPLATE_1_BIN,     //6
    UI_BUF_DIALPLATE_CUBE_BIN,  //7
    UI_BUF_DIALPLATE_BTF_BIN,   //8
};
...
{
    if ((sys_cb.dialplate_index != 1 && sys_cb.dialplate_index != 4 && sys_cb.dialplate_index != 7))
    {
        return;
    }
...
{
    if (((sys_cb.dialplate_index != 2 && sys_cb.dialplate_index != 5 && sys_cb.dialplate_index != 8)) || sys_cb.dialplate_btf_ready == false)
    {
        return;
    }
...
compo_form_t *func_clock_cube_form_create(void)
{
    ...
    compo_textbox_set_location(txt, GUI_SCREEN_CENTER_X - 50, GUI_SCREEN_CENTER_Y - 170, 300, 70);
    ...
    compo_textbox_set_location(txt, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y + 220, 300, 70);
    compo_bonddata(txt, COMPO_BOND_DATE);

    txt = compo_textbox_create(frm, 1);
    compo_textbox_set_font(txt, UI_BUF_0FONT_FONT_NUM_46_BIN);
    compo_textbox_set_location(txt, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y - 170, 300, 70);
...
compo_form_t *func_clock_butterfly_form_create(void)
{
    ...
    compo_butterfly_set_pos(btfly, GUI_SCREEN_CENTER_X, GUI_SCREEN_CENTER_Y + 30);
...
{
    compo_form_t *frm;
//  printf("dialplate_index:%d, %d, %d\n", sys_cb.dialplate_index, DIALPLATE_BTF_IDX, DIALPLATE_CUBE_IDX);
    if ((sys_cb.dialplate_index == 2 || sys_cb.dialplate_index == 5 || sys_cb.dialplate_index == 8))
    {
        frm = func_clock_butterfly_form_create();
    }
    else if ((sys_cb.dialplate_index == 1 || sys_cb.dialplate_index == 4 || sys_cb.dialplate_index == 7))
    {
...
static void func_clock_message(size_msg_t msg)
{
    ...
    if ((sys_cb.dialplate_index == 1 || sys_cb.dialplate_index == 4 || sys_cb.dialplate_index == 7) && flag_cube_touch_x && flag_cube_touch_y)
    {
...
//        func_clock_sub_side();                  //右拉边菜单
        ...
        case MSG_SYS_500MS:
            ...
            if ((sys_cb.dialplate_index != 0 && sys_cb.dialplate_index != 3 && sys_cb.dialplate_index != 6))
            {
