...
enum
{
    ...
    REMIND_COVER_BLE_OFF,       //BLE断开连接

    // REMIND_SPORT_TARGET,           //运动目标达成
    REMIND_SPORT_LAST_SPEED,          //上一公里配速
    REMIND_SPORT_LAST_KCAL,            //上一小时消耗
    REMIND_SPORT_TIME_TARGET,    //时间目标达成
    REMIND_SPORT_KCAL_TARGET,    //卡路里目标达成
    REMIND_SPORT_DANST_TARGET,   //里程目标达成
    REMIND_HEART_WARING,         //心率预警
};
