...
enum
{
    ...
    COMPO_ID_CARD_SET_LABEL,
    COMPO_ID_CARD_SET_CONFIRE,
    CARD_ID_END,
...
void set_alarm_label(u8 index,  ALARM_LABEL label)
{
    //预留
}
...
compo_form_t *func_alarm_clock_sub_edit_form_create(void)
{
    ...
    compo_cardbox_t *cardbox = compo_cardbox_create(frm,0,1,2,320,116);
    compo_cardbox_set_pos(cardbox,GUI_SCREEN_CENTER_X,84+58);
    compo_setid(cardbox, COMPO_ID_CARD_SET_TIME);
    ...
    compo_cardbox_icon_set_pos(cardbox,0,150,-16);
    compo_cardbox_icon_set(cardbox, 0,UI_BUF_I341001_20_ALARM_CLOCK_MORE_BIN);

    compo_shape_t *shape = compo_shape_create(frm, COMPO_SHAPE_TYPE_RECTANGLE);
    compo_shape_set_location(shape,GUI_SCREEN_CENTER_X,203,320,2);
    compo_shape_set_color(shape,make_color(50,50,50));

    cardbox = compo_cardbox_create(frm,0,1,1,320,116);
    compo_cardbox_set_pos(cardbox,GUI_SCREEN_CENTER_X,84+58+116);
    compo_setid(cardbox, COMPO_ID_CARD_SET_DAY);

    compo_cardbox_icon_set_pos(cardbox,0,150,-16);
    compo_cardbox_icon_set(cardbox, 0,UI_BUF_I341001_20_ALARM_CLOCK_MORE_BIN);

    compo_cardbox_text_set_location(cardbox,0,WEEK_LOCATION_X-10,-30,180,34);
    compo_cardbox_text_set_align_center(cardbox,0, false);
    compo_cardbox_text_set(cardbox,0,i18n[STR_ALARM_CLOCK_REPEAT]);
    ...
    else
    {
        if(uteModuleSystemtimeReadLanguage() == CHINESE_LANGUAGE_ID || uteModuleSystemtimeReadLanguage() == TRADITIONAL_CHINESE_ID)
        {
            for (u8 j = 0; j < 7; j++)
            {
                ...
                compo_picturebox_t *picbox = compo_picturebox_create_for_page(frm,cardbox->page,0);
                compo_picturebox_set_pos(picbox, WEEK_LOCATION_X+(WEEK_SPACING_X*j), WEEK_LOCATION_Y);
                compo_picturebox_set(picbox,(ALARM_GET_CYCLE(sys_cb.alarm_edit_idx) & BIT(temp)) ? clock_on_day[j] : clock_off_day[j]);
        ...
        else
        {
            for (u8 j = 7; j < 14; j++)
            {
                u8 temp = (j + 1) % 7;
                compo_picturebox_t *picbox = compo_picturebox_create_for_page(frm,cardbox->page,0);
                compo_picturebox_set_pos(picbox, WEEK_LOCATION_X+(WEEK_SPACING_X*(j - 7)), WEEK_LOCATION_Y);
                compo_picturebox_set(picbox,(ALARM_GET_CYCLE(sys_cb.alarm_edit_idx) & BIT(temp)) ? clock_on_day[j] : clock_off_day[j]);
...
#define MOVE_Y 130
    ...
    compo_shape_set_location(shape,GUI_SCREEN_CENTER_X,203 + MOVE_Y,320,2);
    compo_shape_set_color(shape,make_color(50,50,50));

    cardbox = compo_cardbox_create(frm,0,1,1,320,116);
    compo_cardbox_set_pos(cardbox,GUI_SCREEN_CENTER_X,84+58+116 + MOVE_Y);
    compo_setid(cardbox, COMPO_ID_CARD_SET_LABEL);

    compo_cardbox_icon_set_pos(cardbox,0,150,-16);
    compo_cardbox_icon_set(cardbox, 0,UI_BUF_I341001_20_ALARM_CLOCK_MORE_BIN);

    compo_textbox_t* textbox = compo_textbox_create_for_page(frm,cardbox->page,strlen(i18n[STR_TAG]));
    compo_textbox_set_pos(textbox, WEEK_LOCATION_X-8, -30);
    compo_textbox_set_align_center(textbox, false);
    compo_textbox_set(textbox,i18n[STR_TAG]);

    compo_cardbox_text_set_location(cardbox,0,WEEK_LOCATION_X-10,20,180,34);
    compo_cardbox_text_set_align_center(cardbox,0, false);
    u8 index = ute_moduleSystemtimeAlarmGetLabel(sys_cb.alarm_edit_idx);//标签接口
    compo_cardbox_text_set(cardbox,0,i18n[label[index]]);

    cardbox = compo_cardbox_create(frm,0,1,1,320,116);
    compo_cardbox_set_pos(cardbox,GUI_SCREEN_CENTER_X,84+58+116 + MOVE_Y * 2);
    compo_setid(cardbox, COMPO_ID_CARD_SET_CONFIRE);


    memset(str_buff,0,sizeof(str_buff));
    u8 data_len = 150;
    char data[151] = {0};//ab_zalloc(sizeof(char) * data_len);
    uteModuleSystemtimeGetAlarmLableData(data,&data_len,sys_cb.alarm_edit_idx);
    ...
    if(data_len && data != NULL)
    {
        ...
        shape = compo_shape_create(frm, COMPO_SHAPE_TYPE_RECTANGLE);
        compo_shape_set_location(shape,GUI_SCREEN_CENTER_X,203 + MOVE_Y * 2,320,2);
        compo_shape_set_color(shape,make_color(50,50,50));

        compo_cardbox_icon_set_pos(cardbox,0,150,-16);
        compo_cardbox_icon_set(cardbox, 0,UI_BUF_I341001_20_ALARM_CLOCK_MORE_BIN);

        textbox = compo_textbox_create_for_page(frm,cardbox->page,strlen(i18n[STR_DECLARE]));
        compo_textbox_set_pos(textbox, WEEK_LOCATION_X-8, -30);
        compo_textbox_set_align_center(textbox, false);
        compo_textbox_set(textbox,i18n[STR_DECLARE]);

        snprintf(str_buff, sizeof(str_buff), "%s\0",data);
        compo_cardbox_text_set_location(cardbox,0,WEEK_LOCATION_X-10,20,300,45);
        compo_cardbox_text_set_align_center(cardbox,0, false);
        compo_cardbox_text_set(cardbox,0,str_buff);

        compo_button_t * btn_ok = compo_button_create_by_image(frm,UI_BUF_I341001_20_ALARM_CLOCK_DETELE_BIN);///删除按钮
        compo_button_set_pos(btn_ok,GUI_SCREEN_CENTER_X,GUI_SCREEN_HEIGHT-gui_image_get_size(UI_BUF_I341001_20_ALARM_CLOCK_DETELE_BIN).hei/2-20 + MOVE_Y * 2);
        compo_setid(btn_ok,COMPO_ID_BTN_DEL);
    ...
    else
    {
        ...
        compo_button_t * btn_ok = compo_button_create_by_image(frm,UI_BUF_I341001_20_ALARM_CLOCK_DETELE_BIN);///删除按钮
        compo_button_set_pos(btn_ok,GUI_SCREEN_CENTER_X,GUI_SCREEN_HEIGHT-gui_image_get_size(UI_BUF_I341001_20_ALARM_CLOCK_DETELE_BIN).hei/2-20 + MOVE_Y);
        compo_setid(btn_ok,COMPO_ID_BTN_DEL);
    }
    //ab_free(data);
    ...
    switch (id)
    {
        ...
        default:
        {
            ...
            if (compo_cardbox_get_visible(cardbox))
            {
                ...
                else if(compo_id == COMPO_ID_CARD_SET_LABEL)
                {
                    func_cb.sta = FUNC_ALARM_CLOCK_SUB_LABEL;
                }
                else if(compo_id == COMPO_ID_CARD_SET_CONFIRE)
                {
                    char str_buff[151];
                    memset(str_buff,0,sizeof(str_buff));
                    u8 data_len = 150 ;//uteModuleSystemtimeGetAlarmLableDataLen(sys_cb.alarm_edit_idx);
                    char* data = ab_zalloc(sizeof(char) * data_len);
                    uteModuleSystemtimeGetAlarmLableData(data,&data_len,sys_cb.alarm_edit_idx);
                    if(data_len && data != NULL)
                    {
                        snprintf(str_buff, sizeof(str_buff), "%s",data);
                    }
                    else
                    {
                    ...
                    ab_free(data);
                    msgbox(str_buff, NULL, NULL, MSGBOX_MODE_BTN_NONE, MSGBOX_MSG_TYPE_NONE);
                }
            }
        }
        break;
...
compo_form_t *func_alarm_clock_sub_edit_form_create(void)
{
    ...
    compo_cardbox_icon_set_pos(cardbox,0,150,-25);
    compo_cardbox_icon_set(cardbox, 0,UI_BUF_I341001_20_ALARM_CLOCK_MORE_BIN);
    ...
    compo_button_t * btn_ok = compo_button_create_by_image(frm,UI_BUF_I341001_14_INFORMATION_DELETE_BIN);///删除按钮
    compo_button_set_pos(btn_ok,GUI_SCREEN_CENTER_X,GUI_SCREEN_HEIGHT-gui_image_get_size(UI_BUF_I341001_14_INFORMATION_DELETE_BIN).hei/2-20);
    compo_setid(btn_ok,COMPO_ID_BTN_DEL);
...
#define WEEK_LOCATION_X  (20-300/2+28/2)
#define WEEK_LOCATION_Y  (63-104/2+28/2)
...
compo_form_t *func_alarm_clock_sub_edit_form_create(void)
{
    ...
    const uint32_t clock_off_day[7]=
    {
        UI_BUF_I343001_20_ALARM_CLOCK_DEFAULT_01_BIN,
        UI_BUF_I343001_20_ALARM_CLOCK_DEFAULT_02_BIN,
        UI_BUF_I343001_20_ALARM_CLOCK_DEFAULT_03_BIN,
        UI_BUF_I343001_20_ALARM_CLOCK_DEFAULT_04_BIN,
        UI_BUF_I343001_20_ALARM_CLOCK_DEFAULT_05_BIN,
        UI_BUF_I343001_20_ALARM_CLOCK_DEFAULT_06_BIN,
        UI_BUF_I343001_20_ALARM_CLOCK_DEFAULT_07_BIN,
    };
    const uint32_t clock_on_day[7]=
    {
        UI_BUF_I343001_20_ALARM_CLOCK_STATE_01_BIN,
        UI_BUF_I343001_20_ALARM_CLOCK_STATE_02_BIN,
        UI_BUF_I343001_20_ALARM_CLOCK_STATE_03_BIN,
        UI_BUF_I343001_20_ALARM_CLOCK_STATE_04_BIN,
        UI_BUF_I343001_20_ALARM_CLOCK_STATE_05_BIN,
        UI_BUF_I343001_20_ALARM_CLOCK_STATE_06_BIN,
        UI_BUF_I343001_20_ALARM_CLOCK_STATE_07_BIN,
    };
    ...
    compo_cardbox_t *cardbox = compo_cardbox_create(frm,0,1,2,300,104);
    compo_cardbox_set_pos(cardbox,GUI_SCREEN_CENTER_X,60+104/2);
    compo_setid(cardbox, COMPO_ID_CARD_SET_TIME);
    ...
    compo_shape_t *shape = compo_shape_create(frm, COMPO_SHAPE_TYPE_RECTANGLE);
    compo_shape_set_location(shape,GUI_SCREEN_CENTER_X,176,278,2);
    compo_shape_set_color(shape,make_color(50,50,50));

    cardbox = compo_cardbox_create(frm,0,1,1,300,104);
    compo_cardbox_set_pos(cardbox,GUI_SCREEN_CENTER_X,60+104/2+116);
    compo_setid(cardbox, COMPO_ID_CARD_SET_DAY);
    ...
    compo_button_t * btn_ok = compo_button_create_by_image(frm,UI_BUF_I343001_14_INFORMATION_DELETE_BIN);///删除按钮
    compo_button_set_pos(btn_ok,GUI_SCREEN_CENTER_X,GUI_SCREEN_HEIGHT-gui_image_get_size(UI_BUF_I343001_14_INFORMATION_DELETE_BIN).hei/2-20);
    compo_setid(btn_ok,COMPO_ID_BTN_DEL);
...
compo_form_t *func_alarm_clock_sub_edit_form_create(void)
{
    ...
    compo_cardbox_t *cardbox = compo_cardbox_create(frm,0,1,2,260,78);
    compo_cardbox_set_pos(cardbox,GUI_SCREEN_CENTER_X,84);
    compo_setid(cardbox, COMPO_ID_CARD_SET_TIME);
    ...
    func_alarm_sub_edithour_format_t clock_time = func_alarm_sub_edit_convert_to_12hour(ALARM_GET_HOUR(sys_cb.alarm_edit_idx));
    snprintf(str_buff, sizeof(str_buff), "%02d:%02d %s", clock_time.hour, ALARM_GET_MIN(sys_cb.alarm_edit_idx),clock_time.am_pm ? (clock_time.am_pm ==1 ? i18n[STR_AM] : i18n[STR_PM]) : " ");
    compo_cardbox_text_set_location(cardbox,0,WEEK_LOCATION_X-14, WEEK_LOCATION_Y-14,110,25);
    compo_cardbox_text_set_forecolor(cardbox, 0, MAKE_GRAY(128));
    compo_cardbox_text_set_align_center(cardbox,0, false);
    compo_cardbox_text_set(cardbox,0,str_buff);
    ...
    compo_cardbox_icon_set_pos(cardbox,0,115,-20);
    compo_cardbox_icon_set(cardbox, 0,UI_BUF_I338001_20_ALARM_CLOCK_MORE_BIN);

    // compo_shape_t *shape = compo_shape_create(frm, COMPO_SHAPE_TYPE_RECTANGLE);
    // compo_shape_set_location(shape,GUI_SCREEN_CENTER_X,166,278,1);
    // compo_shape_set_color(shape,make_color(50,50,50));

    cardbox = compo_cardbox_create(frm,0,1,2,260,78);
    compo_cardbox_set_pos(cardbox,GUI_SCREEN_CENTER_X,84+105);
    compo_setid(cardbox, COMPO_ID_CARD_SET_DAY);
    ...
    compo_button_t * btn_ok = compo_button_create_by_image(frm,UI_BUF_I338001_20_ALARM_CLOCK_DELETE_BIN);///确定按钮
    compo_button_set_pos(btn_ok,GUI_SCREEN_CENTER_X,GUI_SCREEN_HEIGHT-gui_image_get_size(UI_BUF_I338001_20_ALARM_CLOCK_DELETE_BIN).hei/2-20);
    compo_setid(btn_ok,COMPO_ID_BTN_DEL);
...
static const ui_handle_t ui_handle =
{
    ...
    .del_btn = {
        ...
        .w      = 0,
        .h      = 0,
        .res    = UI_BUF_I340001_PUBLIC_RECTANGLE00_BIN,
        .res_click = 0,
    },
...
compo_form_t *func_alarm_clock_sub_edit_form_create(void)
{
    ...
    compo_cardbox_icon_set_pos(cardbox,0,80,-15);
    compo_cardbox_icon_set(cardbox, 0,UI_BUF_I342001_20_ALARM_CLOCK_MORE_BIN);

    compo_shape_t *shape = compo_shape_create(frm, COMPO_SHAPE_TYPE_RECTANGLE);
    compo_shape_set_location(shape,GUI_SCREEN_CENTER_X,125-10,228,1);
    compo_shape_set_color(shape,make_color(50,50,50));

    cardbox = compo_cardbox_create(frm,0,1,1,228,80);
    compo_cardbox_set_pos(cardbox,GUI_SCREEN_CENTER_X,84+86-20);
    compo_setid(cardbox, COMPO_ID_CARD_SET_DAY);

    compo_cardbox_icon_set_pos(cardbox,1,80,-15);
    compo_cardbox_icon_set(cardbox, 1,UI_BUF_I342001_20_ALARM_CLOCK_MORE_BIN);
    ...
    compo_button_t * btn_ok = compo_button_create_by_image(frm,UI_BUF_I342001_20_ALARM_CLOCK_DELETE_BIN);///确定按钮
    compo_button_set_pos(btn_ok,GUI_SCREEN_CENTER_X,GUI_SCREEN_HEIGHT-gui_image_get_size(UI_BUF_I342001_20_ALARM_CLOCK_DELETE_BIN).hei/2-5);
    compo_setid(btn_ok,COMPO_ID_BTN_DEL);
...
{
#if GUI_SCREEN_SIZE_240RGB_I332001_SUPPORT || GUI_SCREEN_SIZE_360X360RGB_I340001_SUPPORT || GUI_SCREEN_SIZE_368X448RGB_I345001_SUPPORT
...
#if GUI_SCREEN_SIZE_360X360RGB_I332001_SUPPORT || GUI_SCREEN_SIZE_360X360RGB_I340001_SUPPORT || GUI_SCREEN_SIZE_368X448RGB_I345001_SUPPORT
...
static void func_alarm_clock_sub_edit_message(size_msg_t msg)
{
    ...
    {
        case MSG_CTP_TOUCH:
#if (GUI_SCREEN_SIZE_240RGB_I332001_SUPPORT || GUI_SCREEN_SIZE_360X360RGB_I332001_SUPPORT || GUI_SCREEN_SIZE_360X360RGB_I340001_SUPPORT)
