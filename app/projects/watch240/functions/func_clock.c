...
// #endif
    ...
    {UI_BUF_I330001_3D_MENU_MUSIC_BIN,             FUNC_CHATBOT},
    {UI_BUF_I330001_3D_MENU_POWER_BIN,             FUNC_CHATBOT},
    {UI_BUF_I330001_3D_MENU_SETING_BIN,             FUNC_CHATBOT},

    {UI_BUF_I330001_3D_MENU_WEATHER_BIN,             FUNC_CHATBOT},
...
//            func_switch_to(FUNC_SIDEBAR, FUNC_SWITCH_LR_ZOOM_RIGHT);  //右滑界面
            ...
            func_cb.left_sta = FUNC_ECIG_SETPOWER;
            func_switch_to(FUNC_ECIG_SETPOWER, FUNC_SWITCH_LR_ZOOM_RIGHT);
#if UTE_MODULE_SCREENS_MESSAGE_SUPPORT
